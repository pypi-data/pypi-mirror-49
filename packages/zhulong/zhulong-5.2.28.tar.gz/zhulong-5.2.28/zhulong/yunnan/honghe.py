...
data=[
    ...
    ["gcjs_zhaobiao_gg","https://www.hhzy.net/jyxx/jsgcZbgg",[ "name", "href", "ggstart_time", "info"],f1,f2],
    ["zfcg_zhaobiao_gg","https://www.hhzy.net/jyxx/zfcg/cggg",[ "name", "href", "ggstart_time", "info"],f1,f2],

    ["gcjs_gqita_da_bian_gg","https://www.hhzy.net/jyxx/jsgcBgtz",[ "name", "href", "ggstart_time","info"],f1,f2],

    ["gcjs_zhongbiaohx_gg","https://www.hhzy.net/jyxx/jsgcpbjggs",[ "name", "href", "ggstart_time","info"],f1,f2],

    ["gcjs_zhongbiao_gg","https://www.hhzy.net/jyxx/jsgcZbjggs",[ "name", "href", "ggstart_time","info"],f1,f2],

    ["gcjs_liubiao_gg","https://www.hhzy.net/jyxx/jsgcZbyc",[ "name", "href", "ggstart_time","info"],f1,f2],
    ["zfcg_liubiao_gg","https://www.hhzy.net/jyxx/zfcg/zfcgYcgg",[ "name", "href", "ggstart_time","info"],f1,f2],

    ["zfcg_gqita_da_bian_gg","https://www.hhzy.net/jyxx/zfcg/gzsx",[ "name", "href", "ggstart_time","info"],f1,f2],
    ["zfcg_zhongbiaohx_gg","https://www.hhzy.net/jyxx/zfcg/zbjggs",[ "name", "href", "ggstart_time","info"],f1,f2],

]

def work(conp,**args):
    est_meta(conp,data=data,diqu="云南省红河市",**args)
    est_html(conp,f=f3,**args)


if __name__=='__main__':

    conp=["postgres","since2015","192.168.3.171","yunnan_new","honghe"]
