...
The GET (collection), GET (instance) and PATCH APIs are available for all port types. The POST and DELETE APIs are available for "lag" (ifgrp) and "vlan" port types.<br/>
...
---
## Deleting ports
The network ports DELETE API is used to delete VLAN and LAG ports in the cluster. Note that physical ports cannot be deleted.
...
class PortSchema(ResourceSchema):
 ...
 """
    broadcast_domain = fields.Nested("BroadcastDomainSchema", unknown=EXCLUDE)
    r""" The broadcast_domain field of the port.
 """
    enabled = fields.Boolean()
    r""" The enabled field of the port.
 """
    lag = fields.Nested("PortLagSchema", unknown=EXCLUDE)
...
Example: 01:02:03:04:05:06 """
    mtu = fields.Integer(validate=integer_validation(minimum=68))
...
Example: 1000 """
    state = fields.Str(validate=enum_validation(['up', 'down']))
...
* up
* down """
    type = fields.Str(validate=enum_validation(['vlan', 'physical', 'lag']))
...
Example: 1cd8a442-86d1-11e0-ae1c-123478563412 """
    vlan = fields.Nested("PortVlanSchema", unknown=EXCLUDE)
...
class Port(Resource):
    ...
    get_collection.__func__.__doc__ = r"""Retrieves a collection of ports (physical, VLAN and LAG) for an entire cluster.
...
* [`DOC /network/ethernet/ports`](#docs-networking-network_ethernet_ports)"""
    ...
    patch_collection.__func__.__doc__ = r"""Updates a port.
### Related ONTAP commands
...
* [`DOC /network/ethernet/ports`](#docs-networking-network_ethernet_ports)"""
    ...
    delete_collection.__func__.__doc__ = r"""Deletes a VLAN or LAG (ifgrp).
### Related ONTAP commands
...
* [`DOC /network/ethernet/ports`](#docs-networking-network_ethernet_ports)"""
    ...
    find.__func__.__doc__ = r"""Retrieves a collection of ports (physical, VLAN and LAG) for an entire cluster.
### Related ONTAP commands
* `network port show`
* `network port ifgrp show`
* `network port vlan show`
...
* [`DOC /network/ethernet/ports`](#docs-networking-network_ethernet_ports)"""
    ...
    get.__doc__ = r"""Retrieves the details of a physical port, VLAN, or LAG.
### Related ONTAP commands
* `network port show`
* `network port ifgrp show`
* `network port vlan show`
...
* [`DOC /network/ethernet/ports`](#docs-networking-network_ethernet_ports)"""
    ...
    post.__doc__ = r"""Creates a new VLAN (such as node1:e0a-100) or LAG (ifgrp, such as node2:a0a).
### Required properties
...
* [`DOC /network/ethernet/ports`](#docs-networking-network_ethernet_ports)"""
    ...
    patch.__doc__ = r"""Updates a port.
### Related ONTAP commands
* `network port broadcast-domain add-ports`
* `network port broadcast-domain remove-ports`
* `network port ifgrp modify`
...
* [`DOC /network/ethernet/ports`](#docs-networking-network_ethernet_ports)"""
    ...
    delete.__doc__ = r"""Deletes a VLAN or LAG (ifgrp).
### Related ONTAP commands
* `network port ifgrp delete`
* `network port vlan delete`
