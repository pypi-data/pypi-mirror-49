"""Clase base para la implementación de heurísticas.
    ...
    -bandera_busqueda se utiliza como indicador para determinar si la heurística está en un proceso de búsqueda
    -bandera_parada se utiliza como indicador para detener la búsqueda de la heurística
"""
...
class Heuristica:
    def __init__(self, problema, lista_nombres_parametros):
        ...
        self.crea_pdf_graficas = None
        self.crea_resultados_estadisticos = None
    ...
    def iniciar_busqueda(self, parametros):
        ...
        diccionario_resultados['tiempo_ejecucion'] = tiempo_final
        return resultado
