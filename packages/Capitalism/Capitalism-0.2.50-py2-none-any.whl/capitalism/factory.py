...
class Factory:
    def __init__(self, target, task_queue=None, size=1,
        result_queue=None, delay=1, debug=False, name=None,
        exit_on_done=False, timeout=2, split_array=True,
        int_handler=None, traceback=False, stop_flag=None):
        '''
    ...
    def pipe(self, next_factory):
        ...
        if not next_factory:
            ...
            return self
        # # If next factory doesn't have any worker
