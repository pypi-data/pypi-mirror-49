...
class IgroupInitiatorSchema(ResourceSchema):
 ...
 """
    igroup = fields.Nested("IgroupInitiatorIgroupSchema", unknown=EXCLUDE)
...
Example: iqn.1998-01.com.corp.iscsi:name1 """
    records = fields.List(fields.Nested("IgroupInitiatorNoRecordsSchema", unknown=EXCLUDE))
...
class IgroupInitiator(Resource):
    ...
    get_collection.__func__.__doc__ = r"""Retrieves initiators of an initiator group.
...
"""
    ...
    delete_collection.__func__.__doc__ = r"""Deletes an initiator from an initiator group.
### Related ONTAP commands
* `lun igroup remove`
### Learn more
* [`DOC /protocols/san/igroups`](#docs-SAN-protocols_san_igroups)
"""
    ...
    find.__func__.__doc__ = r"""Retrieves initiators of an initiator group.
### Related ONTAP commands
* `lun igroup show`
### Learn more
* [`DOC /protocols/san/igroups`](#docs-SAN-protocols_san_igroups)
"""
    ...
    get.__doc__ = r"""Retrieves an initiator of an initiator group.
### Related ONTAP commands
* `lun igroup show`
### Learn more
* [`DOC /protocols/san/igroups`](#docs-SAN-protocols_san_igroups)
"""
    ...
    post.__doc__ = r"""Adds one or more initiators to an initiator group.
### Required properties
...
"""
    ...
    delete.__doc__ = r"""Deletes an initiator from an initiator group.
### Related ONTAP commands
* `lun igroup remove`
### Learn more
* [`DOC /protocols/san/igroups`](#docs-SAN-protocols_san_igroups)
