...
#
# Last Modified : Thu 11 Jul 2019 04:20:01 PM CEST
#
#####################################
...
import tempfile
nwkDir = tempfile.TemporaryDirectory()
if not os.path.isdir(nwkDir.name):
    print("downloading networkit header files...")
    networkit_get_include(nwkDir.name)
    pass

includeDir = nwkDir.name + "/networkit/cpp/"
