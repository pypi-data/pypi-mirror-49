...
htmlhelp_basename = "RPMRebuildHelperdoc"
...
latex_documents = [
    (
        master_doc,
        "RPMRebuildHelper.tex",
        "RPM Rebuild Helper Documentation",
        "Jan Staněk",
        "manual",
    )
]
...
man_pages = [("man/rpmrh", "rpmrh", "RPM Rebuild Helper", [author], 1)]
