...
def itkTransformParametersAdaptorBaseD2_cast(obj):
...
def itkTransformParametersAdaptorBaseD3_cast(obj):
...
def itkTransformParametersAdaptorBaseF2_cast(obj):
...
def itkTransformParametersAdaptorBaseF3_cast(obj):
