...
Example: 2147483648 """
    only_execute_access = fields.Boolean()
    r""" Scan only files opened with execute-access.
 """
    scan_readonly_volumes = fields.Boolean()
    r""" Specifies whether or not read-only volume can be scanned.
 """
    scan_without_extension = fields.Boolean()
