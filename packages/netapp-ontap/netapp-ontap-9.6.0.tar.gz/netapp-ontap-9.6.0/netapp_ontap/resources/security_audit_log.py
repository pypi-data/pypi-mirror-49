...
class SecurityAuditLogSchema(ResourceSchema):
 ...
 """
    application = fields.Str(validate=enum_validation(['internal', 'console', 'rsh', 'telnet', 'ssh', 'ontapi', 'http']))
...
Each http/ontapi/snmp request is assigned a unique session ID. """
    state = fields.Str(validate=enum_validation(['pending', 'success', 'error']))
...
* success
* error """
    svm = fields.Nested("SecurityAuditLogSvmSchema", unknown=EXCLUDE)
...
class SecurityAuditLog(Resource):
    ...
    get_collection.__func__.__doc__ = r"""Retrieves the administrative audit log viewer.
### Learn more
* [`DOC /security/audit/messages`](#docs-security-security_audit_messages)"""
    ...
    find.__func__.__doc__ = r"""Retrieves the administrative audit log viewer.
### Learn more
* [`DOC /security/audit/messages`](#docs-security-security_audit_messages)"""
