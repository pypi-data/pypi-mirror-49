...
class HDPowerModule (PowerModule):
    ...
    def clear_calibration(self):
        ...
        sendAndVerifyCommand(self.dut,"write " + HDPowerModule.V12_OUTPUT_OFFSET_ADDR + " 0x0000")
        sendAndVerifyCommand(self.dut,"write " + HDPowerModule.V12_VOLT_OFFSET_ADDR + " 0x0000")
        sendAndVerifyCommand(self.dut,"write " + HDPowerModule.V12_VOLT_MULTIPLIER_ADDR + " 0x0000")
        sendAndVerifyCommand(self.dut,"write " + HDPowerModule.V12_LOW_OFFSET_ADDR + " 0x0000")
        sendAndVerifyCommand(self.dut,"write " + HDPowerModule.V12_LOW_MULTIPLIER_ADDR + " 0x0000")
        sendAndVerifyCommand(self.dut,"write " + HDPowerModule.V12_HIGH_OFFSET_ADDR + " 0x0000")
        sendAndVerifyCommand(self.dut,"write " + HDPowerModule.V12_HIGH_MULTIPLIER_ADDR + " 0x0000")
        sendAndVerifyCommand(self.dut,"write " + HDPowerModule.V12_LEAKAGE_MULTIPLIER_ADDR + " 0x0000")
        sendAndVerifyCommand(self.dut,"write " + HDPowerModule.V5_OUTPUT_OFFSET_ADDR + " 0x0000")
        sendAndVerifyCommand(self.dut,"write " + HDPowerModule.V5_VOLT_OFFSET_ADDR + " 0x0000")
        sendAndVerifyCommand(self.dut,"write " + HDPowerModule.V5_VOLT_MULTIPLIER_ADDR + " 0x0000")
        sendAndVerifyCommand(self.dut,"write " + HDPowerModule.V5_LOW_OFFSET_ADDR + " 0x0000")
        sendAndVerifyCommand(self.dut,"write " + HDPowerModule.V5_LOW_MULTIPLIER_ADDR + " 0x0000")
        sendAndVerifyCommand(self.dut,"write " + HDPowerModule.V5_HIGH_OFFSET_ADDR + " 0x0000")
        sendAndVerifyCommand(self.dut,"write " + HDPowerModule.V5_HIGH_MULTIPLIER_ADDR + " 0x0000")
        sendAndVerifyCommand(self.dut,"write " + HDPowerModule.V5_LEAKAGE_MULTIPLIER_ADDR + " 0x0000")
