...
$ caws User1 --withcreds # """+Bcolors.ORANGE+"""not recommended."""+Bcolors.ENDC+""" edit the contents of ~/.aws/credentials and set the [default] profile.""",
        prog='caws',
