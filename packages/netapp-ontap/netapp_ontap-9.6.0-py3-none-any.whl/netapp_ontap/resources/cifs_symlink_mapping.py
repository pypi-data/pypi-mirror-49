...
class CifsSymlinkMappingSchema(ResourceSchema):
 ...
 """
    target = fields.Nested("CifsTargetSchema", unknown=EXCLUDE)
    r""" The target field of the cifs_symlink_mapping.
 """
    unix_path = fields.Str(validate=len_validation(minimum=0, maximum=256))
...
class CifsSymlinkMapping(Resource):
 ...
 """
    ...
    get_collection.__func__.__doc__ = r"""Retrieves UNIX symbolic link mappings for CIFS clients.
...
"""
    ...
    patch_collection.__func__.__doc__ = r"""Updates the UNIX symbolic link mapping for CIFS clients.
### Related ONTAP commands
...
"""
    ...
    delete_collection.__func__.__doc__ = r"""Deletes the UNIX symbolic link mapping for CIFS clients.
### Related ONTAP commands
...
"""
    ...
    find.__func__.__doc__ = r"""Retrieves UNIX symbolic link mappings for CIFS clients.
### Related ONTAP commands
* `vserver cifs symlink show`
### Learn more
* [`DOC /protocols/cifs/unix-symlink-mapping`](#docs-NAS-protocols_cifs_unix-symlink-mapping)
"""
    ...
    get.__doc__ = r"""Retrieves a UNIX symbolic link mapping for CIFS clients.
### Related ONTAP commands
* `vserver cifs symlink show`
### Learn more
* [`DOC /protocols/cifs/unix-symlink-mapping`](#docs-NAS-protocols_cifs_unix-symlink-mapping)
"""
    ...
    post.__doc__ = r"""Creates a UNIX symbolic link mapping for a CIFS client.
### Required properties
...
"""
    ...
    patch.__doc__ = r"""Updates the UNIX symbolic link mapping for CIFS clients.
### Related ONTAP commands
* `vserver cifs symlink modify`
### Learn more
* [`DOC /protocols/cifs/unix-symlink-mapping`](#docs-NAS-protocols_cifs_unix-symlink-mapping)
"""
    ...
    delete.__doc__ = r"""Deletes the UNIX symbolic link mapping for CIFS clients.
### Related ONTAP commands
* `vserver cifs symlink delete`
### Learn more
* [`DOC /protocols/cifs/unix-symlink-mapping`](#docs-NAS-protocols_cifs_unix-symlink-mapping)
