...
def f1(driver, num):
    ...
    for content in content_list:
        ...
        url = "http://www.czjyzx.gov.cn" + content.xpath("./td[2]/a/@href")[0]
...
data = [
    ...
    ["gcjs_biangeng_gg",
     ...
     ["name", "ggstart_time", "href", "info"], f1, f2],
    ["gcjs_kongzhijia_gg",
     "http://www.czjyzx.gov.cn/gxczzbw/jyxx/001001/001001004/MoreInfo.aspx?CategoryNum=001001004",
     ["name", "ggstart_time", "href", "info"], f1, f2],
    ["gcjs_gqita_zhong_zhonghx_gg",
     "http://www.czjyzx.gov.cn/gxczzbw/jyxx/001001/001001005/MoreInfo.aspx?CategoryNum=001001005",
     ["name", "ggstart_time", "href", "info"], f1, f2],
    ...
    ["gcjs_jiaotong_kongzhijia_gg",
     "http://www.czjyzx.gov.cn/gxczzbw/jyxx/001010/001010003/MoreInfo.aspx?CategoryNum=001010003",
     ["name", "ggstart_time", "href", "info"], f1, f2],
    ["gcjs_gqita_jiaotong_zhong_zhonghx_gg",
     "http://www.czjyzx.gov.cn/gxczzbw/jyxx/001010/001010004/MoreInfo.aspx?CategoryNum=001010004",
     ["name", "ggstart_time", "href", "info"], f1, f2],
    ...
    ["zfcg_biangeng_gg",
     ...
     ["name", "ggstart_time", "href", "info"], f1, f2],
    ["zfcg_zhongbiaohx_gg",
     "http://www.czjyzx.gov.cn/gxczzbw/jyxx/001004/001004004/MoreInfo.aspx?CategoryNum=001004004",
     ["name", "ggstart_time", "href", "info"], f1, f2],
    ["zfcg_kongzhijia_gg",
     "http://www.czjyzx.gov.cn/gxczzbw/jyxx/001004/001004005/MoreInfo.aspx?CategoryNum=001004005",
     ["name", "ggstart_time", "href", "info"], f1, f2],
    ...
    ["gcjs_shuili_kongzhijia_gg",
     "http://www.czjyzx.gov.cn/gxczzbw/jyxx/001011/001011003/MoreInfo.aspx?CategoryNum=001011003",
     ["name", "ggstart_time", "href", "info"], f1, f2],
    ["gcjs_gqita_shuili_zhong_zhonghx_gg",
     "http://www.czjyzx.gov.cn/gxczzbw/jyxx/001011/001011002/MoreInfo.aspx?CategoryNum=001011002",
     ["name", "ggstart_time", "href", "info"], f1, f2],
...
def work(conp, **arg):
    est_meta(conp, data=data, diqu="广西省崇左市", **arg)
    est_html(conp, f=f3, **arg)


if __name__ == "__main__":
    conp=["postgres", "since2015", "192.168.3.171", "guangxi", "chongzuo"]
    import sys
    arg=sys.argv
    if len(arg) >3:
