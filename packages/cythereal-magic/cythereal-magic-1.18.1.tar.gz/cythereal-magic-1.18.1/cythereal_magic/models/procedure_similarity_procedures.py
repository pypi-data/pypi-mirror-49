...
class ProcedureSimilarityProcedures(object):
    ...
    def __init__(self, sha1=None, rva=None):  # noqa: E501
        """ProcedureSimilarityProcedures - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def sha1(self):
        """Gets the sha1 of this ProcedureSimilarityProcedures.  # noqa: E501

        A SHA1 cryptographic hash  # noqa: E501

        :return: The sha1 of this ProcedureSimilarityProcedures.  # noqa: E501
        :rtype: str
        """
        return self._sha1
    ...
    @sha1.setter
    def sha1(self, sha1):
        """Sets the sha1 of this ProcedureSimilarityProcedures.

        A SHA1 cryptographic hash  # noqa: E501

        :param sha1: The sha1 of this ProcedureSimilarityProcedures.  # noqa: E501
        :type: str
        """
        if sha1 is None:
    ...
    @property
    def rva(self):
        """Gets the rva of this ProcedureSimilarityProcedures.  # noqa: E501

        A memory address (usually an RVA).  # noqa: E501

        :return: The rva of this ProcedureSimilarityProcedures.  # noqa: E501
        :rtype: str
        """
        return self._rva
    ...
    @rva.setter
    def rva(self, rva):
        """Sets the rva of this ProcedureSimilarityProcedures.

        A memory address (usually an RVA).  # noqa: E501

        :param rva: The rva of this ProcedureSimilarityProcedures.  # noqa: E501
        :type: str
        """
        if rva is None:
            raise ValueError("Invalid value for `rva`, must not be `None`")  # noqa: E501
        if rva is not None and not re.search('0x[a-fA-F0-9]+', rva):  # noqa: E501
            raise ValueError("Invalid value for `rva`, must be a follow pattern or equal to `/0x[a-fA-F0-9]+/`")  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ProcedureSimilarityProcedures):
            return False
