...
import time
from zlest.util.etl import est_tbs, est_meta, est_html, gg_existed, add_info,est_meta_large


_name_ = 'gcjs_shanghai_shanghai'
...
if __name__ == '__main__':
    work(conp=["postgres", "since2015", "192.168.3.171", "zlest", "gcjs_shanghai_shanghai"], total=2, headless=True, num=1)
