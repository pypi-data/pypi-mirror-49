...
__version__   = "1.0.0"
__developer__ = 'Ganesh Kumar T K'
...
def main():
    ...
    if args.github:
        webbrowser.open("https://github.com/coderganesh/pykural")
        sys.exit()

    if args.pypi:
        webbrowser.open("https://pypi.org/project/pykural/")
        sys.exit()

    if args.pepy:
        webbrowser.open("https://pepy.tech/project/pykural")
        sys.exit()

    if args.dev:
        webbrowser.open("https://coderganesh.github.io/")
        sys.exit()
