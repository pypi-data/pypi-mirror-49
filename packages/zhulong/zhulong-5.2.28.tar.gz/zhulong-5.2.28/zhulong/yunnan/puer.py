...
data=[
    #
    ["gcjs_zhaobiao_gg","http://www.pesggzyjyxxw.com/jyxx/jsgcZbgg",[ "name", "href", "ggstart_time", "info"],f1,f2],
    ["zfcg_zhaobiao_gg","http://www.pesggzyjyxxw.com/jyxx/zfcg/cggg",[ "name", "href", "ggstart_time","info"],f1,f2],

    ["gcjs_gqita_da_bian_gg","http://www.pesggzyjyxxw.com/jyxx/jsgcBgtz",[ "name", "href", "ggstart_time","info"],f1,f2],

    ["gcjs_zhongbiaohx_gg","http://www.pesggzyjyxxw.com/jyxx/jsgcpbjggs",[ "name", "href", "ggstart_time","info"],f1,f2],

    ["gcjs_zhongbiao_gg","http://www.pesggzyjyxxw.com/jyxx/jsgcZbjggs",[ "name", "href", "ggstart_time","info"],f1,f2],

    ["gcjs_liubiao_gg","http://www.pesggzyjyxxw.com/jyxx/jsgcZbyc",[ "name", "href", "ggstart_time","info"],f1,f2],

    ["zfcg_liubiao_gg","http://www.pesggzyjyxxw.com/jyxx/zfcg/zfcgYcgg",[ "name", "href", "ggstart_time","info"],f1,f2],

    ["zfcg_gqita_da_bian_gg","http://www.pesggzyjyxxw.com/jyxx/zfcg/gzsx",[ "name", "href", "ggstart_time","info"],f1,f2],
    ["zfcg_zhongbiaohx_gg","http://www.pesggzyjyxxw.com/jyxx/zfcg/zbjggs",[ "name", "href", "ggstart_time","info"],f1,f2],
...
if __name__=='__main__':
    ...
    conp=["postgres","since2015","192.168.3.171","yunnan_new","puer"]
