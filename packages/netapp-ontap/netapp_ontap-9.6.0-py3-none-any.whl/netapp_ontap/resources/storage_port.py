...
Example: SAS Host Adapter 2a (PMC-Sierra PM8072 rev. C) """
    error = fields.Nested("StoragePortErrorSchema", unknown=EXCLUDE)
...
Example: 6.0 """
    state = fields.Str(validate=enum_validation(['online', 'offline', 'error']))
...
class StoragePort(Resource):
    ...
    get_collection.__func__.__doc__ = r"""Retrieves a collection of storage ports.
...
"""
    ...
    find.__func__.__doc__ = r"""Retrieves a collection of storage ports.
### Related ONTAP commands
* `storage port show`
### Learn more
* [`DOC /storage/ports`](#docs-storage-storage_ports)
"""
    ...
    get.__doc__ = r"""Retrieves a specific storage port.
### Related ONTAP commands
* `storage port show`
### Learn more
* [`DOC /storage/ports`](#docs-storage-storage_ports)
