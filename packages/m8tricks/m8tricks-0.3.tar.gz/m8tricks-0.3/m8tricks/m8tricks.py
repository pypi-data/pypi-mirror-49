...
button_go_start = PushButton(box_top, command=go_start,grid=[0,0,2,1], text = "<<", image="images/endl.png")
button_left = PushButton(box_top, command=left,grid=[2,0,2,1], text = "<",image="images/left.png")
button_play = PushButton(box_top, command=play,grid=[4,0,2,1], text = "PLAY", image="images/play.png")
button_stop = PushButton(box_top, command=stop,grid=[6,0,2,1], text = "STOP",enabled=False, image="images/stop.png")
button_right = PushButton(box_top, command=right,grid=[8,0,2,1], text = ">",image="images/right.png")
button_go_end = PushButton(box_top, command=go_end,grid=[10,0,2,1], text = ">>",image="images/endr.png")
