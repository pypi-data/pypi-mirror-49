...
def set_credentials(notebook_path='/content/gdrive/My Drive/Colab Notebooks/temp/credentials.json'):
    os.environ['GOOGLE_APPLICATION_CREDENTIALS'] = notebook_path
