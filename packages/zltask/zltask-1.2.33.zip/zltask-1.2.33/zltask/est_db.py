...
def dbdata(host_dict):
    ...
    for k in all_quyus.keys():
        ...
        for quyu in quyus:
            ...
            tmp=['zlsrc',quyu,'postgres','since2015',host_dict[k],db,schema,None,None,5,None,False,'normal',40,5,5,10,False,5,1,1,None,None]
            data.append(tmp)
...
def todb(conp=None):
    ...
    conp1,hosts_dict=get_hosts(conp)
...
def append_db(conp=None):
    ...
    :return:
    """
    conp1,host_dict=get_hosts(conp)
    df=dbdata(host_dict)
