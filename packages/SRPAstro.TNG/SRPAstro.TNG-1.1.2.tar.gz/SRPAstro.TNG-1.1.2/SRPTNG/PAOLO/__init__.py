...
History : (26/02/2012) First version.
        ...
        : (08/02/2017) Updatec costants.
        : (10/05/2017) TNG beam splitter.
"""


__all__ = ['AverHourAngle', 'AverParallacticAngle', 'MuellerOffsetMatrix', 'StokesOffsetVector', 
           'TNGMuellerMatrix', 'TNGMuellerMatrixNoDerot', 'TNGMuellerTransmissionMatrix']
...
framecuto   = '85 850 330 650'
framecut    = '50 700 50 700'
#
XCORR       = 'XCORR'
