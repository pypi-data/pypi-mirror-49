...
def itkLevelSetFunctionIF2_SetMaximumCurvatureTimeStep(n):
...
def itkLevelSetFunctionIF2_SetMaximumPropagationTimeStep(n):
...
def itkLevelSetFunctionIF2_cast(obj):
...
def itkLevelSetFunctionIF3_SetMaximumCurvatureTimeStep(n):
...
def itkLevelSetFunctionIF3_SetMaximumPropagationTimeStep(n):
...
def itkLevelSetFunctionIF3_cast(obj):
