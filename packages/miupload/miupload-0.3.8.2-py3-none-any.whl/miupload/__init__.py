...
def submit_notebook(assignment = None):
    ...
    <b>Upload successful!</b> You can view your submitted notebook on """ +'<a href="https://nbviewer.jupyter.org/urls/'+base_url.replace("https://","").replace("http://","")+"/uploads/"+str(r.content, 'utf-8', 'ignore')[1:]+ """ class="alert-link"> nbviewer.</a>
    </div>"""))
            display(Javascript("""
                    $(function() {
            ...
            display(HTML("""<div class="alert alert-block alert-danger">
                                <b>Upload failed!</b> Error:"""+ str(r.content, 'utf-8', 'ignore')+ """  <br>Please email your notebook to your peer tutor manualy.
                                </div>"""))
            display(Javascript("""
                              $("#dynamic")
                              .css("width", current_progress + "%")
        ...
        display(HTML("""<div class="alert alert-block alert-danger">
                                        <b>Upload failed!</b> Error: Cannot connect with the server. <br>Please check your internet connection. If the problem persist, email your notebook to your peer tutor manualy.
                                        </div>"""))
        display(Javascript("""
                                      $("#dynamic")
                                      .css("width", current_progress + "%")
        ...
        display(HTML("""<div class="alert alert-block alert-danger">
                                                <b>Upload failed!</b> Error: Unknown error. <br>Please check your internet connection. If the problem persist, email your notebook to your peer tutor manualy.
                                                </div>"""))
        display(Javascript("""
                                              $("#dynamic")
                                              .css("width", current_progress + "%")
