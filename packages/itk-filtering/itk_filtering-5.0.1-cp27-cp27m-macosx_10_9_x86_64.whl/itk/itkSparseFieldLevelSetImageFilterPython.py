...
def itkSparseFieldLayerSFLSNI2_cast(obj):
...
def itkSparseFieldLayerSFLSNI3_cast(obj):
...
def itkSparseFieldLevelSetImageFilterIF2IF2_cast(obj):
...
def itkSparseFieldLevelSetImageFilterIF3IF3_cast(obj):
