...
.. note::
    ...
    conventions. However, our dataset only contains recordings from OmniPlex® equipment, so we implicitly assume that
...
class Header(Record):
    ...
    def ad_frequency(self):
        return self["ADFrequency"] * config.units.hertz
    ...
    def slow_max_magnitude(self):
        return self["SlowMaxMagnitudeMV"] * config.units.millivolt

    @property
    def spike_max_magnitude(self):
        return self["SpikeMaxMagnitudeMV"] * config.units.millivolt
    ...
    def waveform_freq(self):
        return self["WaveformFreq"] * config.units.hertz
...
class SlowHeader(Record):
    ...
    @property
    def ad_frequency(self):
        return self["ADFreq"] * config.units.hertz
...
class SpikeHeader(Record):
    ...
    @property
    def wf_rate(self):
        return self["WFRate"] * config.units.hertz
