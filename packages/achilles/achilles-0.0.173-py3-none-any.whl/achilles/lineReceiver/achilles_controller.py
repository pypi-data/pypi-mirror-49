...
class AchillesController(LineReceiver):
    ...
    def lineReceived(self, data):
        ...
        if "GREETING" in data:
            ...
            # TODO: Implement self.args_countdown -= 1 to terminate stream after last result is received.
            if self.achilles_function is None and self.achilles_args is None:
                print(data)
            else:
                print(data)
...
def map(
    achilles_function, achilles_args, achilles_callback=None, response_mode="OBJECT"
):
