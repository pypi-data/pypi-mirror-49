...
vspec = importlib.util.spec_from_file_location(
  "version",
  str(Path(__file__).resolve().parent / 'phrasebook' / "version.py")
)
...
setup(
    name='phrasebook',
    description="Store phrases (SQL, messages, what-have-you) alongside your modules.",
    ...
    url='https://github.com/patdaburu/phrasebook',
    download_url=(
        f'https://github.com/patdaburu/'
        f'phrasebook/archive/{version}.tar.gz'
    ),
    keywords=[
