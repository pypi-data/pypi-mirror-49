...
```bash
TAG=2.18.0b4 REGISTRY=us.gcr.io/onepanelio make publish-pip-package
```
...
```bash
TAG=2.18.0b3 REGISTRY=us.gcr.io/onepanelio make build-docker-image push-docker-image
```
