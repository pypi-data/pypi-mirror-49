...
## Overview
A Snapshot copy is the view of the filesystem as it exits at the point in time when the Snapshot copy is created. <br/>
...
Example: 2019-02-04T19:00:00.000+0000 """
    state = fields.Str(validate=enum_validation(['valid', 'invalid', 'partial']))
...
class Snapshot(Resource):
 ...
 """
    ...
    get_collection.__func__.__doc__ = r"""Retrieves a collection of volume Snapshot copies.
...
"""
    ...
    patch_collection.__func__.__doc__ = r"""Updates a Volume Snapshot copy.
### Related ONTAP commands
* `snapshot modify`
* `snapshot rename`
### Learn more
...
"""
    ...
    delete_collection.__func__.__doc__ = r"""Deletes a Volume Snapshot copy.
### Related ONTAP commands
* `snapshot delete`
### Learn more
* [`DOC /storage/volumes/{volume.uuid}/snapshots`](#docs-storage-storage_volumes_{volume.uuid}_snapshots)
"""
    ...
    find.__func__.__doc__ = r"""Retrieves a collection of volume Snapshot copies.
### Related ONTAP commands
* `snapshot show`
### Learn more
* [`DOC /storage/volumes/{volume.uuid}/snapshots`](#docs-storage-storage_volumes_{volume.uuid}_snapshots)
"""
    ...
    get.__doc__ = r"""Retrieves details of a specific volume Snapshot copy.
### Related ONTAP commands
* `snapshot show`
### Learn more
* [`DOC /storage/volumes/{volume.uuid}/snapshots`](#docs-storage-storage_volumes_{volume.uuid}_snapshots)
"""
    ...
    post.__doc__ = r"""Creates a volume Snapshot copy.
### Required properties
...
"""
    ...
    patch.__doc__ = r"""Updates a Volume Snapshot copy.
### Related ONTAP commands
* `snapshot modify`
* `snapshot rename`
### Learn more
...
"""
    ...
    delete.__doc__ = r"""Deletes a Volume Snapshot copy.
### Related ONTAP commands
* `snapshot delete`
### Learn more
* [`DOC /storage/volumes/{volume.uuid}/snapshots`](#docs-storage-storage_volumes_{volume.uuid}_snapshots)
