...
def itkRecursiveSeparableImageFilterIF2IF2_cast(obj):
...
def itkRecursiveSeparableImageFilterIF3IF3_cast(obj):
...
def itkRecursiveSeparableImageFilterISS2ISS2_cast(obj):
...
def itkRecursiveSeparableImageFilterISS3ISS3_cast(obj):
...
def itkRecursiveSeparableImageFilterIUC2IUC2_cast(obj):
...
def itkRecursiveSeparableImageFilterIUC3IUC3_cast(obj):
...
def itkRecursiveSeparableImageFilterIUS2IUS2_cast(obj):
...
def itkRecursiveSeparableImageFilterIUS3IUS3_cast(obj):
