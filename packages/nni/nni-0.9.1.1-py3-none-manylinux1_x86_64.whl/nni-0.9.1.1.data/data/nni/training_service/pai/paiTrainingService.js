...
/jobs/${trialJobDetail.paiJobName}/executionType`,
        ...
        switch (key) {
            ...
            case trialConfigMetadataKey_1.TrialConfigMetadataKey.TRIAL_CONFIG:
                ...
                if (this.paiTrialConfig.outputDir === undefined || this.paiTrialConfig.outputDir === null) {
                    this.paiTrialConfig.outputDir = typescript_string_operations_1.String.Format(paiData_1.PAI_OUTPUT_DIR_FORMAT, this.paiClusterConfig.host)
                        .replace(/\r\n|\n|\r/gm, '');
                }
                try {
    ...
    async submitTrialJobToPAI(trialJobId) {
        ...
        const hdfsOutputDir = utils_1.unixPathJoin(this.hdfsBaseDir, this.experimentId, trialJobId);
        ...
        const nniPaiTrialCommand = typescript_string_operations_1.String.Format(paiData_1.PAI_TRIAL_COMMAND_FORMAT, `$PWD/${trialJobId}`, `$PWD/${trialJobId}/nnioutput`, trialJobId, this.experimentId, trialJobDetail.sequenceId, this.isMultiPhase, this.paiTrialConfig.command, nniManagerIp, this.paiRestServerPort, hdfsOutputDir, this.hdfsOutputHost, this.paiClusterConfig.userName, hdfsClientUtility_1.HDFSClientUtility.getHdfsExpCodeDir(this.paiClusterConfig.userName), version, this.logCollection)
            .replace(/\r\n|\n|\r/gm, '');
