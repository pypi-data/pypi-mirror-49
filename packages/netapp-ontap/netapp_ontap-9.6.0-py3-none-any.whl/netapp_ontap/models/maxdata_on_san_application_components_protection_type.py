...
class MaxdataOnSanApplicationComponentsProtectionTypeSchema(ResourceSchema):
    ...
    local_rpo = fields.Str()
    r""" The local rpo of the application component. Optional in the POST or PATCH body
...
* hourly
* none """
    remote_rpo = fields.Str()
    r""" The remote rpo of the application component. Optional in the POST or PATCH body
