...
def deserialise_body(f_obs):
  ...
  return [
           ...
           ], [Range(decimal_granularity=10) for _ in range(6)]
...
def deserialise_quadruple(f_obs) -> Tuple[Any, Any]:
  ...
  return data, [Range(decimal_granularity=10) for _ in range(4)]
...
def deserialise_quaternion_transform(f_obs) -> Tuple[Any, Any]:
  ...
  return data, [Range(decimal_granularity=10) for _ in range(7)]
...
def deserialise_array(f_obs)-> Tuple[Any, Any]:
  ...
  return data, [Range(decimal_granularity=10) for _ in range(array.ArrayLength())]
