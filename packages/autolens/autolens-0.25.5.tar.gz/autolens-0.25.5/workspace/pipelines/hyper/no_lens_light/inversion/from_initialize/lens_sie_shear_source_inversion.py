...
# light-profile source fit of a previous pipeline. This ensures that the hyper-image used by the pipeline_pixelization and
# pipeline_regularization is fitted using a pixelized source-plane, which ensures that irregular structure in the lensed
...
# Lens Mass: EllipitcalIsothermal + ExternalShear
# Source Light: pipeline_pixelization + pipeline_regularization
