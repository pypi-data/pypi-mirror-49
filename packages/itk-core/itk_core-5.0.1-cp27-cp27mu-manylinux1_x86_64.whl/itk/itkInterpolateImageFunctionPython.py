...
def itkInterpolateImageFunctionICVF22D_cast(obj):
...
def itkInterpolateImageFunctionICVF33D_cast(obj):
...
def itkInterpolateImageFunctionIF2D_cast(obj):
...
def itkInterpolateImageFunctionIF2F_cast(obj):
...
def itkInterpolateImageFunctionIF3D_cast(obj):
...
def itkInterpolateImageFunctionIF3F_cast(obj):
...
def itkInterpolateImageFunctionIRGBAUC2D_cast(obj):
...
def itkInterpolateImageFunctionIRGBAUC3D_cast(obj):
...
def itkInterpolateImageFunctionIRGBUC2D_cast(obj):
...
def itkInterpolateImageFunctionIRGBUC3D_cast(obj):
...
def itkInterpolateImageFunctionISS2D_cast(obj):
...
def itkInterpolateImageFunctionISS2F_cast(obj):
...
def itkInterpolateImageFunctionISS3D_cast(obj):
...
def itkInterpolateImageFunctionISS3F_cast(obj):
...
def itkInterpolateImageFunctionIUC2D_cast(obj):
...
def itkInterpolateImageFunctionIUC2F_cast(obj):
...
def itkInterpolateImageFunctionIUC3D_cast(obj):
...
def itkInterpolateImageFunctionIUC3F_cast(obj):
...
def itkInterpolateImageFunctionIUS2D_cast(obj):
...
def itkInterpolateImageFunctionIUS2F_cast(obj):
...
def itkInterpolateImageFunctionIUS3D_cast(obj):
...
def itkInterpolateImageFunctionIUS3F_cast(obj):
...
def itkInterpolateImageFunctionIVF22D_cast(obj):
...
def itkInterpolateImageFunctionIVF33D_cast(obj):
