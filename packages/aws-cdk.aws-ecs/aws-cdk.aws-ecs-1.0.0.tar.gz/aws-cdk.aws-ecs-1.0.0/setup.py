...
kwargs = json.loads("""
{
    ...
    "install_requires": [
        "jsii~=0.14.0",
        "publication>=0.0.3",
        "aws-cdk.aws-applicationautoscaling~=1.0,>=1.0.0",
        "aws-cdk.aws-autoscaling~=1.0,>=1.0.0",
        "aws-cdk.aws-autoscaling-hooktargets~=1.0,>=1.0.0",
        "aws-cdk.aws-certificatemanager~=1.0,>=1.0.0",
        "aws-cdk.aws-cloudformation~=1.0,>=1.0.0",
        "aws-cdk.aws-cloudwatch~=1.0,>=1.0.0",
        "aws-cdk.aws-ec2~=1.0,>=1.0.0",
        "aws-cdk.aws-ecr~=1.0,>=1.0.0",
        "aws-cdk.aws-ecr-assets~=1.0,>=1.0.0",
        ...
        "aws-cdk.aws-logs~=1.0,>=1.0.0",
        "aws-cdk.aws-route53~=1.0,>=1.0.0",
        "aws-cdk.aws-route53-targets~=1.0,>=1.0.0",
        "aws-cdk.aws-secretsmanager~=1.0,>=1.0.0",
        "aws-cdk.aws-servicediscovery~=1.0,>=1.0.0",
        "aws-cdk.aws-sns~=1.0,>=1.0.0",
        "aws-cdk.aws-sqs~=1.0,>=1.0.0",
        "aws-cdk.aws-ssm~=1.0,>=1.0.0",
        "aws-cdk.core~=1.0,>=1.0.0",
        "aws-cdk.cx-api~=1.0,>=1.0.0"
    ]
}
""")
