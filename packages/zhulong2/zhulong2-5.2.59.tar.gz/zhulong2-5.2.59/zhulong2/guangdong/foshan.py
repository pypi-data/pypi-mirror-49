...
def get_data():
    data = []
    sitewebName = OrderedDict([("佛山市", "佛山市,顺德区,南海区,三水区,高明区,禅城区"),])

    sitewebId = OrderedDict([("佛山市", "4028889705bebb510105bec1f8670004,297e6a6a49176e84014917f9fad20e48,297e6a6a49176e84014917f91c370e45,297e6a6a49176e84014917f7f0670e42,297e6a6a49176e84014917f6ef9c0e3f,297e6a6a49176e84014917f4ce960e3c")])

    regionIds = OrderedDict([("佛山市", "0105")])
    ...
    sx_sitewebId = OrderedDict([("佛山市", "4028889705bebb510105bec1f8670004")])
...
def work(conp, **args):
    est_meta_large(conp, data=data, diqu="广东省佛山市", **args)
...
if __name__ == '__main__':
    work(conp=["postgres", "since2015", "192.168.3.171", "guoziqiang", "foshan"],pageloadtimeout=120,interval_page=100)
