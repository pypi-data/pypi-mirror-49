...
class IscsiSessionSchema(ResourceSchema):
 ...
 """
    connections = fields.List(fields.Nested("IscsiConnectionSchema", unknown=EXCLUDE))
 ...
 """
    initiator = fields.Nested("IscsiSessionInitiatorSchema", unknown=EXCLUDE)
...
class IscsiSession(Resource):
 ...
 """
    ...
    get_collection.__func__.__doc__ = r"""Retrieves iSCSI sessions.
...
"""
    ...
    find.__func__.__doc__ = r"""Retrieves iSCSI sessions.
### Related ONTAP commands
* `vserver iscsi connection show`
* `vserver iscsi session parameter show`
* `vserver iscsi session show`
...
"""
    ...
    get.__doc__ = r"""Retrieves an iSCSI session.
### Related ONTAP commands
* `vserver iscsi connection show`
* `vserver iscsi session parameter show`
* `vserver iscsi session show`
