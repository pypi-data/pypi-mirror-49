...
class AdminConnection(object):
    ...
    def get_authorized_session(self, start_id, service='Admin', timeout=5.0):
    ...
    def stream_system_dependencies(self, start_id):
        return self.stream_async_request(start_id, "GetSysDepends")

    # pylint: disable=E1101
    def stream_async_request(self, start_id, request_type):
        session = self.get_authorized_session(start_id, timeout=30.0)
        try:
