...
def itkHalfHermitianToRealInverseFFTImageFilterICF2IF2___New_orig__():
...
def itkHalfHermitianToRealInverseFFTImageFilterICF2IF2_cast(obj):
...
def itkHalfHermitianToRealInverseFFTImageFilterICF3IF3___New_orig__():
...
def itkHalfHermitianToRealInverseFFTImageFilterICF3IF3_cast(obj):
