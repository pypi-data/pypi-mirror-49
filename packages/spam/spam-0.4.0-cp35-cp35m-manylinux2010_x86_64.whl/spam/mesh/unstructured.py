...
def _delaunayFromVoronoi(COM, radii=None, radius=None, edges=None):
    ...
    for grain in pbar(range(numGrains)):
        ...
        for jj in range(numberOfNeighbours):
            ...
            if (grain not in neighbourList1):  # should be grain not in neighbourList1 (ER)
                continue
            ...
            for kk in range(neighbourNumber1):
                ...
                if (grain not in neighbourList2):  # should be grain not in neighbourList2 (ER)
                    continue
                ...
                for ll in range(neighbourNumber2):
                    ...
                    if ((grain not in neighbourList3) or (not neighbourListZero[jj] in neighbourList3)):  # should be grain not in neighbourList3 (ER)
                        continue
