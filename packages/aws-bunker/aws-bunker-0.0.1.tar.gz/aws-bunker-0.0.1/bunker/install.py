...
def mntandinstall(instance_id=None):
    parser = argparse.ArgumentParser(description='mount ebs block and install essentials.', prog='mntandinstall', formatter_class=RawTextHelpFormatter)

    #parser.print_help()
    parser.add_argument('-s', action='store_true', help='start up ec2 before running this program.')
