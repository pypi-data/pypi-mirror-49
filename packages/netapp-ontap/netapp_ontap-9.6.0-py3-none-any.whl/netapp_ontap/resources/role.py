...
Example: admin """
 ...
 """
    privileges = fields.List(fields.Nested("RolePrivilegeSchema", unknown=EXCLUDE))
...
class Role(Resource):
 ...
 """
    ...
    get_collection.__func__.__doc__ = r"""Retrieves a list of roles configured in the cluster.
...
"""
    ...
    delete_collection.__func__.__doc__ = r"""Delete the specified role
### Required parameters
...
"""
    ...
    find.__func__.__doc__ = r"""Retrieves a list of roles configured in the cluster.
### Related ONTAP commands
* `security login rest-role show`
### Learn more
* [`DOC /security/roles`](#docs-security-security_roles)
"""
    ...
    get.__doc__ = r"""Retrieves the details of the specified role.
### Related ONTAP commands
* `security login rest-role show`
### Learn more
* [`DOC /security/roles/{owner.uuid}/{name}`](#docs-security-security_roles_{owner.uuid}_{name})
...
"""
    ...
    delete.__doc__ = r"""Delete the specified role
### Required parameters
* `name` - Name of the role to be deleted.
* `owner.uuid` - UUID of the SVM housing the role.
### Related ONTAP commands
