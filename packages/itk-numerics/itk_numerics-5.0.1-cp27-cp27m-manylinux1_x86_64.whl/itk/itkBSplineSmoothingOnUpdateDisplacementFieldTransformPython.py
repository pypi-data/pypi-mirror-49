...
def itkBSplineSmoothingOnUpdateDisplacementFieldTransformD2___New_orig__():
...
def itkBSplineSmoothingOnUpdateDisplacementFieldTransformD2_cast(obj):
...
def itkBSplineSmoothingOnUpdateDisplacementFieldTransformD3___New_orig__():
...
def itkBSplineSmoothingOnUpdateDisplacementFieldTransformD3_cast(obj):
