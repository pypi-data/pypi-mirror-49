...
- GET /api/svm/peer-permissions/{cluster.uuid}/{svm.uuid}
- PATCH /api/svm/peer-permissions/{cluster.uuid}/{svm.uuid}
- DELETE /api/svm/peer-permissions/{cluster.uuid}/{svm.uuid}
"""
...
Example: ["snapmirror","flexcache"] """
    cluster_peer = fields.Nested("ClusterPeerSchema", unknown=EXCLUDE)
...
class SvmPeerPermission(Resource):
 ...
 """
    ...
    get_collection.__func__.__doc__ = r"""Retrieves the list of SVM peer permissions.
...
"""
    ...
    patch_collection.__func__.__doc__ = r"""Updates the SVM peer permissions.
### Related ONTAP commands
...
"""
    ...
    delete_collection.__func__.__doc__ = r"""Deletes the SVM peer permissions.
### Related ONTAP commands
...
"""
    ...
    find.__func__.__doc__ = r"""Retrieves the list of SVM peer permissions.
### Related ONTAP commands
* `vserver peer permission show`
### Examples
The following examples show how to retrieve a collection of SVM peer permissions based on a query.
...
"""
    ...
    get.__doc__ = r"""Retrieves the SVM peer permission instance.
### Related ONTAP commands
* `vserver peer permission show`
### Example
...
"""
    ...
    post.__doc__ = r"""Creates an SVM peer permission.
### Required properties
...
"""
    ...
    patch.__doc__ = r"""Updates the SVM peer permissions.
### Related ONTAP commands
* `vserver peer permission modify`
### Example
Updates an SVM peer permission.
...
"""
    ...
    delete.__doc__ = r"""Deletes the SVM peer permissions.
### Related ONTAP commands
* `verver peer permission delete`
### Example
Deletes an SVM peer permission.
