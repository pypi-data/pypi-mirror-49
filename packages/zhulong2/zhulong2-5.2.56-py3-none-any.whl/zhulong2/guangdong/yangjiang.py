...
def get_data():
    data = []
    sitewebName = OrderedDict([ ("阳江市", "阳江市,海陵区,阳江高新区,阳东区,阳西县,阳春市,江城区"),])

    sitewebId = OrderedDict([
        ("阳江市",
         "4028889705bedd7e0105bef239d20006,40288ba95544e898015547e0570b209b,40288ba95544e898015547de877c2073,297e6a6a49176e8401491835b3cb0e8b,297e6a6a49176e8401491834fd1a0e8a,297e6a6a49176e840149183451520e89,297e6a6a49176e8401491833a4af0e88"),
    ])

    regionIds = OrderedDict([("阳江市", "0114")])
    ...
    sx_sitewebId = OrderedDict([("阳江市", "4028889705bedd7e0105bef239d20006"),])
...
def work(conp, **args):
    est_meta_large(conp, data=data, diqu="广东省阳江市", **args)
...
if __name__ == '__main__':
    work(conp=["postgres", "since2015", "192.168.3.171", "guoziqiang", "yangjiang"],pageloadtimeout=120,interval_page=10)
