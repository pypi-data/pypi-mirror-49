...
class mainClass:
    ...
    def buildGUI(self, root):  # Called in the __init__ to build the GUI window
        ...
        rowCount = rowCount+1
        self.platformPos = Label(self.paramFrame, text="Goal Position (x,y):", bg="white")  # add different items (Position)
        ...
        self.platformPos.bind("<Enter>", partial(self.on_enter, "Goal position. Example: 2.5,-3.72 or Auto"))
        ...
        rowCount = rowCount+1
        self.platformDiam = Label(self.paramFrame, text="Goal Diameter (cm):", bg="white")
        ...
        self.platformDiam.bind("<Enter>", partial(self.on_enter, "Goal diameter. Use the same unit as the data"))
        self.platformDiam.bind("<Leave>", self.on_leave)
        rowCount = rowCount+1
        self.poolDiam = Label(self.paramFrame, text="Maze Diameter (cm):", bg="white")
        ...
        self.poolDiam.bind("<Enter>", partial(self.on_enter, "The diameter of the maze. Use the same unit as the data"))
        self.poolDiam.bind("<Leave>", self.on_leave)
        rowCount = rowCount+1
        self.poolCentre = Label(self.paramFrame, text="Maze Centre (x,y):", bg="white")
        ...
        self.poolCentre.bind("<Enter>", partial(self.on_enter, "Maze Centre. Example: 0.0,0.0 or Auto"))
    ...
    def saveROI(self):
        ...
        patternROI = re.compile("^[0-9]{1,9}[,][0-9]{1,9}$")
        patternSize = re.compile("^[0-9]{1,9}$")
