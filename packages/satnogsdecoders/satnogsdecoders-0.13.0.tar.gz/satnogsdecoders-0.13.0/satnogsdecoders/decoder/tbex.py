...
class Tbex(KaitaiStruct):
    ...
    class TbexHeaderT(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.padding_1 = self._io.read_bytes(3)
            self.spacecraft_identifier = self._io.read_u1()
            self.padding_2 = self._io.read_bytes(5)
    ...
    class TbexPacketT(KaitaiStruct):
        ...
        def _read(self):
            ...
            _on = self.header.spacecraft_identifier
            if _on == 82:
