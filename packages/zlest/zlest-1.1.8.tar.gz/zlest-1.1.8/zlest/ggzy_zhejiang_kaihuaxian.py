...
_name_ = 'ggzy_zhejiang_kaihuaxian'
...
def f3(driver, url):
    ...
    locator = (By.XPATH, '//td[@class="bt_content"][string-length()>100]')
    WebDriverWait(driver, 10).until(EC.presence_of_element_located(locator))
...
data = [
    ...
    ["zfcg_zhaobiao_danyilaiyuan_gg", "http://www.kaihua.gov.cn/col/col1384142/index.html?uid=4839715&pageNum=1",["name", "ggstart_time", "href", "info"], add_info(f1,{"zbfs":"单一来源"}), f2],
