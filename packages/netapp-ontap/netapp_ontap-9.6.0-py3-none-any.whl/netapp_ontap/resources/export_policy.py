...
class ExportPolicySchema(ResourceSchema):
 ...
 """
    rules = fields.List(fields.Nested("ExportRuleSchema", unknown=EXCLUDE))
...
class ExportPolicy(Resource):
    ...
    get_collection.__func__.__doc__ = r"""Retrieves export policies.
...
"""
    ...
    patch_collection.__func__.__doc__ = r"""Updates the properties of an export policy to change an export policy name or replace all export policy rules.
### Related ONTAP commands
...
"""
    ...
    delete_collection.__func__.__doc__ = r"""Deletes an export policy.
### Related ONTAP commands
...
"""
    ...
    find.__func__.__doc__ = r"""Retrieves export policies.
### Related ONTAP commands
* `vserver export-policy show`
* `vserver export-policy rule show`
### Learn more
...
"""
    ...
    get.__doc__ = r"""Retrieves an export policy.
### Related ONTAP commands
* `vserver export-policy show`
* `vserver export-policy rule show`
### Learn more
...
"""
    ...
    post.__doc__ = r"""Creates an export policy. An SVM can have any number of export policies to define rules for which clients can access data exported by the SVM. A policy with no rules prohibits access.
### Required properties
...
"""
    ...
    patch.__doc__ = r"""Updates the properties of an export policy to change an export policy name or replace all export policy rules.
### Related ONTAP commands
* `vserver export-policy rename`
* `vserver export-policy rule delete`
* `vserver export-policy rule create`
...
"""
    ...
    delete.__doc__ = r"""Deletes an export policy.
### Related ONTAP commands
* `vserver export-policy delete`
### Learn more
* [`DOC /protocols/nfs/export-policies`](#docs-NAS-protocols_nfs_export-policies)
