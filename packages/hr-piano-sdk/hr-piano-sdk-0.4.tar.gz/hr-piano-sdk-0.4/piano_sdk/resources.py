...
class Access(UserMixin, ListableAPIResource):
    ...
    def check(cls, **params):
        return cls._make_request('get', 'check', **params)

    @classmethod
    def grant(cls, **params):
        return cls._make_request('post', 'grant', **params)

    @classmethod
    def update(cls, **params):
        return cls._make_request('post', 'update', **params)
...
class User(PublisherMixin, ListableAPIResource):
    ...
    def save(self):
        ...
        data = {}
        for custom_field in self._original_values['custom_fields']:
            data[custom_field['fieldName']] = custom_field['value']
    ...
    def set_custom_field(self, name, value):
        try:
            ...
            raise ValueError('Custom field "{}" does not exist'.format(name))
