...
class NfsServiceSchema(ResourceSchema):
 ...
 """
    protocol = fields.Nested("NfsServiceProtocolSchema", unknown=EXCLUDE)
    r""" The protocol field of the nfs_service.
 """
    state = fields.Str(validate=enum_validation(['online', 'offline']))
...
* offline """
 ...
 """
    transport = fields.Nested("NfsServiceTransportSchema", unknown=EXCLUDE)
...
class NfsService(Resource):
    ...
    get_collection.__func__.__doc__ = r"""Retrieves the NFS configuration of SVMs.
...
"""
    ...
    patch_collection.__func__.__doc__ = r"""Updates the NFS configuration of an SVM.
### Related ONTAP commands
* `vserver nfs modify`
* `vserver nfs on`
* `vserver nfs off`
...
"""
    ...
    delete_collection.__func__.__doc__ = r"""Deletes the NFS configuration of an SVM.
### Related ONTAP commands
* `vserver nfs delete`
### Learn more
* [`DOC /protocols/nfs/services`](#docs-NAS-protocols_nfs_services)
"""
    ...
    find.__func__.__doc__ = r"""Retrieves the NFS configuration of SVMs.
### Related ONTAP commands
* `vserver nfs show`
* `vserver nfs status`
### Learn more
...
"""
    ...
    get.__doc__ = r"""Retrieves the NFS configuration of an SVM.
### Related ONTAP commands
* `vserver nfs show`
* `vserver nfs status`
### Learn more
...
"""
    ...
    post.__doc__ = r"""Creates an NFS configuration for an SVM.
### Required properties
...
"""
    ...
    patch.__doc__ = r"""Updates the NFS configuration of an SVM.
### Related ONTAP commands
* `vserver nfs modify`
* `vserver nfs on`
* `vserver nfs off`
...
"""
    ...
    delete.__doc__ = r"""Deletes the NFS configuration of an SVM.
### Related ONTAP commands
* `vserver nfs delete`
### Learn more
* [`DOC /protocols/nfs/services`](#docs-NAS-protocols_nfs_services)
