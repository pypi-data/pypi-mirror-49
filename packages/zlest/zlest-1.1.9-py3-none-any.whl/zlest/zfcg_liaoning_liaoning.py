...
data = [
    ...
    ["zfcg_zhaobiao_diqu2_gg", "http://zfcg.nen.com.cn/ZhongBiaoList_DSnew.jsp?page=1",["name", "ggstart_time", "href", "info"], add_info(f1,{'diqu':"区县"}), f2],
