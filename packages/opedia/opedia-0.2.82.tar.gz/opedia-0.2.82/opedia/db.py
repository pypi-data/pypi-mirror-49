...
def dbConnect(usr='ArmLab', psw='ArmLab2018', ip='128.208.239.16', port='1445', db='Opedia', TDS_Version='7.3'):
    try:
        server = ip + ',' + port
...
#     json_list = [orjson.loads(line) for line in response.text.splitlines()]
