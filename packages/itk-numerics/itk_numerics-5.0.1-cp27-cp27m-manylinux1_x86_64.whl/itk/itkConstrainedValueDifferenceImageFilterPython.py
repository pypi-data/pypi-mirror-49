...
def itkConstrainedValueDifferenceImageFilterIF2IF2IF2_cast(obj):
...
def itkConstrainedValueDifferenceImageFilterIF3IF3IF3_cast(obj):
...
def itkConstrainedValueDifferenceImageFilterISS2ISS2ISS2___New_orig__():
...
def itkConstrainedValueDifferenceImageFilterISS2ISS2ISS2_cast(obj):
...
def itkConstrainedValueDifferenceImageFilterISS3ISS3ISS3___New_orig__():
...
def itkConstrainedValueDifferenceImageFilterISS3ISS3ISS3_cast(obj):
...
def itkConstrainedValueDifferenceImageFilterIUC2IUC2IUC2_cast(obj):
...
def itkConstrainedValueDifferenceImageFilterIUC3IUC3IUC3_cast(obj):
...
def itkConstrainedValueDifferenceImageFilterIUS2IUS2IUS2_cast(obj):
...
def itkConstrainedValueDifferenceImageFilterIUS3IUS3IUS3_cast(obj):
