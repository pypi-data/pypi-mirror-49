...
def _open_file_with_exp(full_path_to_data):
    ...
    try:
        return open_file_handle_too_many(full_path_to_data)
...
def _handle_file_object(full_path_to_data, callback_with_file_obj):
    if hasattr(full_path_to_data, 'read'):
        ...
        return callback_with_file_obj(full_path_to_data)

    with contextlib.closing(_open_file_with_exp(full_path_to_data)) as f:
        return callback_with_file_obj(f)
