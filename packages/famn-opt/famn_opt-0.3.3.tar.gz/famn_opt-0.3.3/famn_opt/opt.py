...
class FAMN_main:
    ...
    def __init__(self): 
        ...
        self.param = { # ---------------------------------- 
                ...
                'etaQ' : float(0), # Asymmetry parameter EtaQ 
...
#                simpson_file.write('-x\n')
    ...
    def initialise(self):
        ...
        if (not self.param['SIMPSON_installed']
            ...
            self.param['no_gamma'] = int(self.param['no_gamma'])
    ...
    def initialise_step(self,stepcnt):
        ...
        self.FAMNsteps[stepcnt].data['head_1'] =\
            ...
            'quadrupole  1 2 ' + str(self.param['CQ']) + ' ' + str(self.param['etaQ']) +\
            ' 0 0 0  ' + '\n'
            '}' + '\n'
            'par {' + '\n'
            ...
            'gamma_angles ' + str(self.param['no_gamma']) + '\n'
...
#            report.write(str(self.output['list_detect_density']) + '\n')
        ...
        report.write(self.param['tab'] + 'Number of γ: ' + str(self.param['no_gamma']) + '\n')
