...
def itkFastMarchingReachedTargetNodesStoppingCriterionIF2IF2___New_orig__():
...
def itkFastMarchingReachedTargetNodesStoppingCriterionIF2IF2_cast(obj):
...
def itkFastMarchingReachedTargetNodesStoppingCriterionIF3IF3___New_orig__():
...
def itkFastMarchingReachedTargetNodesStoppingCriterionIF3IF3_cast(obj):
