...
class RayStreamingExecutor:
    ...
    def execute(self, env=None):
        try:
            ...
            stream = self.build_stream(args_parser=self.args_parser, env=env)
    ...
    def execute_forever(self, env, stream, loop_idle_seconds=1):
        while(True):
            try:
                ...
                logger.info("a round of ray streaming is finished!!!")
            except Exception as e:
    ...
    def build_stream(self, args_parser, env)->DataStream:
        """
