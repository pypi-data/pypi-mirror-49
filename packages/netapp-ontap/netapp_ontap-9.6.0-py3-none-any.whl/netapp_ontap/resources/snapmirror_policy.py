...
class SnapmirrorPolicySchema(ResourceSchema):
 ...
 """
    identity_preservation = fields.Str(validate=enum_validation(['full', 'exclude_network_config', 'exclude_network_and_protocol_config']))
    r""" Specifies which configuration of the source SVM is replicated to destination. This field is applicable only for SVM data protection and async policies.
...
Example: MirrorAndVault """
 ...
 """
    retention = fields.List(fields.Nested("SnapmirrorPolicyRuleSchema", unknown=EXCLUDE))
    r""" Policy on Snapshot copy retention. This is applicable only to async policies.
 """
    scope = fields.Str(validate=enum_validation(['svm', 'cluster']))
...
* cluster """
 ...
 """
    sync_common_snapshot_schedule = fields.Nested("ScheduleSchema", unknown=EXCLUDE)
    r""" The sync_common_snapshot_schedule field of the snapmirror_policy.
 """
    sync_type = fields.Str(validate=enum_validation(['sync', 'strict_sync']))
...
* strict_sync """
 ...
 """
    transfer_schedule = fields.Nested("ScheduleSchema", unknown=EXCLUDE)
    r""" The transfer_schedule field of the snapmirror_policy.
 """
    type = fields.Str(validate=enum_validation(['async', 'sync']))
...
class SnapmirrorPolicy(Resource):
 ...
 """
    ...
    get_collection.__func__.__doc__ = r"""Retrieves SnapMirror policies of type "mirror-vault", "sync-mirror" and "strict-sync-mirror".
...
"""
    ...
    patch_collection.__func__.__doc__ = r"""Updates the SnapMirror policy.
### Important notes
...
"""
    ...
    delete_collection.__func__.__doc__ = r"""Deletes a SnapMirror policy.
### Related ONTAP commands
...
"""
    ...
    find.__func__.__doc__ = r"""Retrieves SnapMirror policies of type "mirror-vault", "sync-mirror" and "strict-sync-mirror".
### Related ONTAP commands
* `snapmirror policy show`
### Example
The following example shows how to retrieve a collection of SnapMirror policies.
...
"""
    ...
    get.__doc__ = r"""Retrieves a specific SnapMirror policy.
### Example
<br/>
```
...
"""
    ...
    post.__doc__ = r"""Creates a SnapMirror policy. The parameter "identity_preservation" is applicable to only SnapMirror relationships with SVM endpoints and it indicates which configuration of the source SVM is replicated to the destination SVM.</br>
...
"""
    ...
    patch.__doc__ = r"""Updates the SnapMirror policy.
### Important notes
* The properties "transfer_schedule" and "throttle" can be modified only if all the SnapMirror relationships associated with the specified SnapMirror policy have the same values.
* The properties "retention.label" and "retention.count" are mandatory if "retention" is provided in the input. The provided "retention.label" is the final list and is replaced with the existing values.
* The value of the "identity_preservation" property cannot be changed if the SnapMirror relationships associated with the policy have different identity_preservation configurations.
...
"""
    ...
    delete.__doc__ = r"""Deletes a SnapMirror policy.
### Related ONTAP commands
* `snapmirror policy delete`
### Example
<br/>
