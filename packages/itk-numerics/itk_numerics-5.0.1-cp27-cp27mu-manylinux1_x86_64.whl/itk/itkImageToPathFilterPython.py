...
def itkImageToPathFilterIF2PLPP2_cast(obj):
...
def itkImageToPathFilterIF3PLPP3_cast(obj):
...
def itkImageToPathFilterISS2PLPP2_cast(obj):
...
def itkImageToPathFilterISS3PLPP3_cast(obj):
...
def itkImageToPathFilterIUC2PLPP2_cast(obj):
...
def itkImageToPathFilterIUC3PLPP3_cast(obj):
...
def itkImageToPathFilterIUS2PLPP2_cast(obj):
...
def itkImageToPathFilterIUS3PLPP3_cast(obj):
