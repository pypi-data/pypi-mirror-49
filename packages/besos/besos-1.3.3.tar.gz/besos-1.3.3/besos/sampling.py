...
class adaptive_sampler_lv():
    ...
    def __init__(self, P, P_out, n_new, problem, evaluator, reg, test_in, test_out, scaler=None, scaler_out=None, verbose = False):
...
def MC_Voronoi_estimate(P, problem):
    ...
    S = dist_sampler(lhs, problem, 500) # for now 100 random samples per point to estimate Voronoi cell
