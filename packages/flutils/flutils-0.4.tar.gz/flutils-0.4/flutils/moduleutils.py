...
def cherry_pick(
    ...
    This means the module load and execute will be postponed until an
    ...
    Example:
        ...
        result of converting the root package (above)::
        ...
        As you can see, the imports were each converted to a
