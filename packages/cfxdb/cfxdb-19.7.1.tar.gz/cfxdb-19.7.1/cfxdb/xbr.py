...
from zlmdb import table, MapBytes20FlatBuffers, MapBytes32FlatBuffers, MapUuidUuid, MapUuidFlatBuffers, MapBytes20Bytes20, MapBytes16FlatBuffers, MapBytes20Bytes16
...
class PayingChannelRequest(object):
    ...
    def build(self, builder):
        ...
        if self.state:
            PayingChannelRequestGen.PayingChannelRequestAddState(builder, self.state)
...
class PaymentChannel(object):
    ...
    def type(self):
        if self._state is None and self._from_fbs:
            self._state = self._from_fbs.Type()
        return self._state
    ...
    def build(self, builder):
        ...
        PaymentChannelGen.PaymentChannelAddType(builder, self.type)
