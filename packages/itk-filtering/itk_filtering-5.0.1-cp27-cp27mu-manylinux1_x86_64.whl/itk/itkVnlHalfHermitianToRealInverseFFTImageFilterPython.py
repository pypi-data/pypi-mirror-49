...
def itkVnlHalfHermitianToRealInverseFFTImageFilterICF2IF2___New_orig__():
...
def itkVnlHalfHermitianToRealInverseFFTImageFilterICF2IF2_cast(obj):
...
def itkVnlHalfHermitianToRealInverseFFTImageFilterICF3IF3___New_orig__():
...
def itkVnlHalfHermitianToRealInverseFFTImageFilterICF3IF3_cast(obj):
