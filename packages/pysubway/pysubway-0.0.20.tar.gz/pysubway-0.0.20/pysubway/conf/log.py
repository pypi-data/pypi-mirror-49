...
class Log(object):
    ...
    def __init__(self, app, app_name: str, error_path: str = None, info_path: str = None,
        ...
        os.path.exists(self._log_path_error) or os.makedirs(self._log_path_error)
        os.path.exists(self._log_path_info) or os.makedirs(self._log_path_info)
