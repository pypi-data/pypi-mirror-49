...
def get_data():
    ...
    sitewebId = OrderedDict([
        ("珠海市",
         "4028889705bebb510105bec522060005,40288ba855aef0750155b493435363b4,297e6a6a49176e84014917e83ff30021,297e6a6a49176e84014917e74fbc001e,297e6a6a49176e84014917e65c2b001d"),
    ])

    regionIds = OrderedDict([("珠海市", "0103")])
...
def work(conp, **args):
    est_meta_large(conp, data=data, diqu="广东省珠海市", **args)
...
if __name__ == '__main__':
    work(conp=["postgres", "since2015", "192.168.3.171", "guoziqiang", "zhuhai"],pageloadtimeout=120,interval_page=10)
