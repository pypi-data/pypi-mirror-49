...
import time
from zlest.util.etl import add_info,est_meta,est_html,est_tbs,est_meta_large
...
def work(conp,**args):
    est_meta_large(conp,data=data,diqu="深圳市",**args)
    est_html(conp,f=f3,**args)


if __name__=='__main__':
    work(conp=["postgres","since2015","192.168.3.171","zlest","shenzhenshi"])
    #
    # for d in data[5:]:
