...
class IpServicePolicy(Resource):
    ...
    get_collection.__func__.__doc__ = r"""Retrieves a collection of service policies.
...
* [`DOC /network/ip/service-policies`](#docs-networking-network_ip_service-policies)"""
    ...
    find.__func__.__doc__ = r"""Retrieves a collection of service policies.
### Related ONTAP commands
* `network interface service-policy show`
...
* [`DOC /network/ip/service-policies`](#docs-networking-network_ip_service-policies)"""
    ...
    get.__doc__ = r"""Retrieves a specific service policy.
### Related ONTAP commands
* `network interface service-policy show`
