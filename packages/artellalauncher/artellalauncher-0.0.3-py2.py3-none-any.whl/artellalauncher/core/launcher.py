...
class DccData(object):
    def __init__(self, name, enabled, default_version, supported_versions, installation_paths, departments, plugins, launch_fn=None):
...
class ArtellaLauncher(QObject, object):
    ...
    def _on_dcc_selected(self, selected_dcc, selected_version):
        ...
        folders_to_register = self.project.get_folders_to_register()
        ...
        setup_path = cfg.value(self._updater.envvar_name)
