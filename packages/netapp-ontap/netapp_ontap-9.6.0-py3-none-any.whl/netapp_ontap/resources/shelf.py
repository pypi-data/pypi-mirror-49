...
class ShelfSchema(ResourceSchema):
    ...
    bays = fields.List(fields.Nested("ShelfBaysSchema", unknown=EXCLUDE))
    r""" The bays field of the shelf.
 """
    connection_type = fields.Str(validate=enum_validation(['unknown', 'fc', 'sas', 'nvme']))
...
Example: 12 """
    drawers = fields.List(fields.Nested("ShelfDrawersSchema", unknown=EXCLUDE))
    r""" The drawers field of the shelf.
 """
    frus = fields.List(fields.Nested("ShelfFrusSchema", unknown=EXCLUDE))
...
Example: DS2246 """
    module_type = fields.Str(validate=enum_validation(['unknown', 'iom6', 'iom6e', 'iom12', 'iom12e', 'iom12f', 'nsm100', 'psm3e']))
...
Example: 1.1 """
    paths = fields.List(fields.Nested("StoragePortSchema", unknown=EXCLUDE))
    r""" The paths field of the shelf.
 """
    ports = fields.List(fields.Nested("ShelfPortsSchema", unknown=EXCLUDE))
...
Example: SHFMS1514000895 """
    state = fields.Str(validate=enum_validation(['unknown', 'ok', 'error']))
...
class Shelf(Resource):
    ...
    get_collection.__func__.__doc__ = r"""Retrieves a collection of shelves.
...
"""
    ...
    find.__func__.__doc__ = r"""Retrieves a collection of shelves.
### Related ONTAP commands
* `storage shelf show`
* `storage shelf port show`
* `storage shelf drawer show`
...
"""
    ...
    get.__doc__ = r"""Retrieves a specific shelf.
### Related ONTAP commands
* `storage shelf show`
* `storage shelf port show`
* `storage shelf drawer show`
