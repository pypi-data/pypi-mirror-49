...
enum:
 ...
 """
    type = fields.Str(validate=enum_validation(['primary', 'backup']))
...
class VscanServerStatus(Resource):
 ...
 """
    ...
    get_collection.__func__.__doc__ = r"""Retrieves a Vscan server status.
...
"""
    ...
    find.__func__.__doc__ = r"""Retrieves a Vscan server status.
### Related ONTAP commands
* `vserver vscan connection-status show-all`
### Learn more
* [`DOC /protocols/vscan/server-status`](#docs-NAS-protocols_vscan_server-status)
