...
from zlhawq.txt_gg.api import add_quyus_sheng
...
"""%(start_date,cron)
    ...
    for sheng in shengs:
        part2="""
t%d=PythonOperator(task_id="txt_gg_add_quyus_%s"
    ...
    with open(os.path.join(dirname,'txt_gg_update.py') ,'w',encoding='utf8') as f:
        f.write(page)
