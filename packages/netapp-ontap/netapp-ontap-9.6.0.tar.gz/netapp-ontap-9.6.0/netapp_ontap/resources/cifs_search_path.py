...
class CifsSearchPath(Resource):
 ...
 """
    ...
    get_collection.__func__.__doc__ = r"""Retrieves CIFS home directory search paths.
...
"""
    ...
    patch_collection.__func__.__doc__ = r"""Reorders a CIFS home directory search path.
### Related ONTAP commands
...
"""
    ...
    delete_collection.__func__.__doc__ = r"""Deletes a CIFS home directory search path.
### Related ONTAP commands
...
"""
    ...
    find.__func__.__doc__ = r"""Retrieves CIFS home directory search paths.
### Related ONTAP commands
* `cifs server home-directory search-path show`
### Learn more
* [`DOC /protocols/cifs/home-directory/search-paths`](#docs-NAS-protocols_cifs_home-directory_search-paths)
"""
    ...
    get.__doc__ = r"""Retrieves a CIFS home directory search path of an SVM.
### Related ONTAP commands
* `cifs server home-directory search-path show`
### Learn more
* [`DOC /protocols/cifs/home-directory/search-paths`](#docs-NAS-protocols_cifs_home-directory_search-paths)
"""
    ...
    post.__doc__ = r"""Creates a home directory search path.
### Required properties
...
"""
    ...
    patch.__doc__ = r"""Reorders a CIFS home directory search path.
### Related ONTAP commands
* `cifs server home-directory search-path reorder`
### Learn more
* [`DOC /protocols/cifs/home-directory/search-paths`](#docs-NAS-protocols_cifs_home-directory_search-paths)
"""
    ...
    delete.__doc__ = r"""Deletes a CIFS home directory search path.
### Related ONTAP commands
* `cifs server home-directory search-path remove`
### Learn more
* [`DOC /protocols/cifs/home-directory/search-paths`](#docs-NAS-protocols_cifs_home-directory_search-paths)
