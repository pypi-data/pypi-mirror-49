...
def remove_lines_from_file(file_path, lines_to_remove=None, remove_from=None, remove_until=None):
    """
    Will remove lines from a file if the lines contains certain strings
    Args:
        param file_path: the path to your file
        param lines_to_remove: (optional) the lines to search for (this function calls contains() and not == )
