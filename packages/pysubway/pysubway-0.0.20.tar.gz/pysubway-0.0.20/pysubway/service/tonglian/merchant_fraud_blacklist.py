...
try:
    from service.tonglian.base import TonglianBase
except (ImportError, ModuleNotFoundError) as e:
    from pysubway.service.tonglian.base import TonglianBase


class MerchantFraudBlacklist(TonglianBase):

    def gen_biz_data(self, licenseno: str, name: str) -> Dict[str, str]:
        return {
            'licenseno': licenseno,
            'name': name,
        }
...
if __name__ == '__main__':
    ...
    biz_data = s.gen_biz_data('2dew342dfda', 'sssd')
