...
_lr_productions = [
  ...
  ('expr -> entity','expr',1,'p_expr','parse.py',150),
  ('expr -> root','expr',1,'p_expr','parse.py',151),
  ('root -> feature','root',1,'p_root','parse.py',156),
  ('root -> root COMMA feature','root',3,'p_root','parse.py',157),
  ('entityAny -> LBRACE RBRACE','entityAny',2,'p_entity_any','parse.py',166),
  ('entity -> LBRACE NUMBER RBRACE','entity',3,'p_entity_number','parse.py',170),
  ('entity -> LBRACE COINDEX RBRACE','entity',3,'p_entity_coindex','parse.py',174),
  ('entity -> LBRACE QUOTE TEXT QUOTE RBRACE','entity',5,'p_entity_name','parse.py',178),
  ('entity -> LBRACE TILDE RBRACE','entity',3,'p_entity_tilde','parse.py',182),
  ('entityOpen -> LBRACE TEXT','entityOpen',2,'p_entity_normal_open','parse.py',186),
  ('entityOpen -> LBRACE function','entityOpen',2,'p_entity_function_open','parse.py',190),
  ('entityAnchor -> entityOpen anchor','entityAnchor',2,'p_entity_anchor','parse.py',194),
  ('entityFeature -> entityOpen COLON feature','entityFeature',3,'p_entity_feature0','parse.py',199),
  ('entityFeature -> entityAnchor COLON feature','entityFeature',3,'p_entity_feature0','parse.py',200),
  ('entityFeature -> entityFeature COMMA feature','entityFeature',3,'p_entity_feature','parse.py',205),
  ('entity -> entityOpen RBRACE','entity',2,'p_entity_close','parse.py',210),
  ('entity -> entityAnchor RBRACE','entity',2,'p_entity_close','parse.py',211),
  ('entity -> entityFeature RBRACE','entity',2,'p_entity_close','parse.py',212),
  ('feature -> TEXT EQUAL entity','feature',3,'p_feature','parse.py',217),
  ('feature -> TEXT EQUAL entityAny','feature',3,'p_feature','parse.py',218),
  ('feature -> TEXT EQUAL restriction','feature',3,'p_feature','parse.py',219),
  ('feature -> function EQUAL entity','feature',3,'p_function_feature','parse.py',223),
  ('feature -> function EQUAL entityAny','feature',3,'p_function_feature','parse.py',224),
  ('feature -> function EQUAL restriction','feature',3,'p_function_feature','parse.py',225),
  ('function -> TEXT LPAREN RPAREN','function',3,'p_function_any','parse.py',230),
  ('function -> TEXT LPAREN restriction RPAREN','function',4,'p_function_restriction','parse.py',234),
  ('functionOpen -> TEXT LPAREN entity','functionOpen',3,'p_function_open','parse.py',238),
  ('functionArgument -> functionOpen COMMA entity','functionArgument',3,'p_function_argument','parse.py',242),
  ('functionArgument -> functionArgument COMMA entity','functionArgument',3,'p_function_argument','parse.py',243),
  ('function -> functionOpen RPAREN','function',2,'p_function_close','parse.py',248),
  ('function -> functionArgument RPAREN','function',2,'p_function_close','parse.py',249),
  ('restriction -> SLASH entity','restriction',2,'p_restriction','parse.py',254),
  ('restriction -> SLASH entity anchor','restriction',3,'p_restriction_anchor','parse.py',258),
  ('anchor -> ULINE COINDEX','anchor',2,'p_anchor','parse.py',263),
]
