"""Contains a hand-coded EBNF parser based on tests/fixtures/ebnf.ebnf."""

from enum import Enum

from . import parser_base as PB
from .primitive import alternation, concatenation, exclusion
from .primitive import one_or_more, option, terminal, zero_or_more
...
class Parser(PB.ParserBase):
  ...
  def comment(self, text):
    ...
    return concatenation([
      ...
      "*)"
    ], ignore_whitespace=True)(text).compressed(TokenType.comment)
  ...
  def number(self, text):
    ...
    self._attempting(text)
    return concatenation([
      exclusion(self.digit, "0"),
      zero_or_more(self.digit)
