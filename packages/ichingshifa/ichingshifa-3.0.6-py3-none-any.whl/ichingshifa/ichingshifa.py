...
sixtyfourgua_pickle = PurePath('data', 'sixtyfourgua.pkl')
sixtyfourgua_description_pickle = PurePath('data', 'sixtyfourgua_description.pkl')
sixtyfourgua = pickle.load(open(sixtyfourgua_pickle, "rb"))
sixtyfourgua_description = pickle.load(open(sixtyfourgua_description_pickle, "rb"))
