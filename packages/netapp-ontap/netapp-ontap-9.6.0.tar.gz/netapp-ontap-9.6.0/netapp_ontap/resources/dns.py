...
class Dns(Resource):
    ...
    get_collection.__func__.__doc__ = r"""Retrieves the DNS configurations of all data SVMs.
...
"""
    ...
    patch_collection.__func__.__doc__ = r"""Updates DNS domain and server configurations of an SVM.
### Important notes
...
* [`DOC /name-services/dns`](#docs-name-services-name-services_dns)"""
    ...
    delete_collection.__func__.__doc__ = r"""Deletes DNS domain configuration of the specified SVM.
### Related ONTAP commands
...
"""
    ...
    find.__func__.__doc__ = r"""Retrieves the DNS configurations of all data SVMs.
DNS configuration for the cluster is retrieved and managed via [`/api/cluster`](#docs-cluster-cluster).
### Related ONTAP commands
* `vserver services name-service dns show`
* `vserver services name-service dns check`
...
"""
    ...
    get.__doc__ = r"""Retrieves DNS domain and server configuration of an SVM. By default, both DNS domains and servers are displayed.
DNS configuration for the cluster is retrieved and managed via [`/api/cluster`](#docs-cluster-cluster).
### Related ONTAP commands
* `vserver services name-service dns show`
* `vserver services name-service dns check`
...
"""
    ...
    post.__doc__ = r"""Creates DNS domain and server configurations for an SVM.<br/>
### Important notes
...
* [`DOC /name-services/dns`](#docs-name-services-name-services_dns)"""
    ...
    patch.__doc__ = r"""Updates DNS domain and server configurations of an SVM.
### Important notes
- Both DNS domains and servers can be modified.
- The domains and servers fields cannot be empty.
- IPv6 must be enabled if IPv6 family addresses are specified for the `servers` field.
...
* [`DOC /name-services/dns`](#docs-name-services-name-services_dns)"""
    ...
    delete.__doc__ = r"""Deletes DNS domain configuration of the specified SVM.
### Related ONTAP commands
* `vserver services name-service dns delete`
### Learn more
* [`DOC /name-services/dns`](#docs-name-services-name-services_dns)
