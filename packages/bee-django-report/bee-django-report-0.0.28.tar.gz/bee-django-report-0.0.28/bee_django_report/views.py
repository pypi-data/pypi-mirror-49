...
from .forms import MentorScoreWeekForm, UserServerForm, UserSectionForm
...
class UserSectionList(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["search_form"] = UserSectionForm(data={"status":status,"class":class_id,"assistant":assistant_id,"expire_date_start":expire_date_start,"expire_date_end":expire_date_end})
        return context

    def get_user_list(self, status, class_id, assistant_id, expire_date_start, expire_date_end):
    ...
    def get_queryset(self):
        ...
        expire_date_start = self.request.GET.get("expire_date_start")
        expire_date_end = self.request.GET.get("expire_date_end")
        queryset = self.get_user_list(status, class_id, assistant_id, expire_date_start, expire_date_end)
        return queryset
