...
class mercurio:
    ...
    def send(self,
        ...
        for recipient in recipients:
            ...
            message = self.make_message(
                fromaddress, recipient, reply_to_address, text, sbj, attachments, cid_attachments
            )
    ...
    def attach_file_to_multipart_message(self, message, filename, content_id=None):
        ...
        logger.debug("Attaching {filename}, as {main_type}, {sub_type}".format(
            filename=filename,
            main_type=main_type,
            sub_type=sub_type
        ))
    ...
    def make_message(self, fromaddress, recipients, reply_to_address, text, sbj, attachments=[],
                     cid_attachments={}):
        ...
        for code in cid_attachments:
            self.attach_file_to_multipart_message(
                msg, cid_attachments[code], code
            )
