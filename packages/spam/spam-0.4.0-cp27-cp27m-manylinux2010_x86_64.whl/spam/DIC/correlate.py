...
def globalCorrelation(im1, im2, mesh, convergenceCriterion=0.01, debugFiles=True, maxIterations=20, initialDisplacements=None, boundaryConditions=None, prefix="./"):
    import spam.helpers
