...
class RunRequest:
    ...
    tensorboard_parent_run_id -- indicates the run id to resume tensorboard from
    ...
    def __init__(self, machine_type="CPU", command=None, workspace_id=None, commit_hash=None, commit_label=None,
                 ...
                 tensorboard_parent_run_id=None, attached_resources=None, description=None, envvars=None,
                 conda_file=None, run_type="user", idempotent=False, provider=None, local_root=None, workflow_id=None,
                 github_url=None, github_ref=None, distributed=None, stop_conditions=None, uncommitted_hash=None):
        ...
        self.tensorboard_enabled = tensorboard_enabled
        self.tensorboard_directory = tensorboard_directory
        self.tensorboard_parent_run_id = tensorboard_parent_run_id
        self.description = description
    ...
    def to_payload(self):
        return {
            ...
            "tensorboard_parent_run_id": self.tensorboard_parent_run_id,
...
class ConditionSpecs:
    def __init__(self, metric, operator, value, min_steps):
        self.metric = metric
