...
def parse_1(trs):
    ...
    for i in range(1, len(trs)):
        ...
        if 'http' in href:
            ...
            href = 'https://jyzx.dh.gov.cn' + href
...
data = [
    ...
    ["gcjs_zhaobiao_gg", "https://jyzx.dh.gov.cn/jyxx/jsgcZbgg", ["name", "href", "ggstart_time", "info"], f1, f2],
    ["zfcg_zhaobiao_gg", "https://jyzx.dh.gov.cn/jyxx/zfcg/cggg", ["name", "href", "ggstart_time", "info"], f1, f2],

    ["gcjs_gqita_da_bian_gg", "https://jyzx.dh.gov.cn/jyxx/jsgcBgtz", ["name", "href", "ggstart_time", "info"], f1,
     f2],

    ["gcjs_zhongbiaohx_gg", "https://jyzx.dh.gov.cn/jyxx/jsgcpbjggs", ["name", "href", "ggstart_time", "info"], f1,
     f2],

    ["gcjs_zhongbiao_gg", "https://jyzx.dh.gov.cn/jyxx/jsgcZbjggs", ["name", "href", "ggstart_time", "info"], f1,
     f2],

    ["gcjs_liubiao_gg", "https://jyzx.dh.gov.cn/jyxx/jsgcZbyc", ["name", "href", "ggstart_time", "info"], f1, f2],
    ["zfcg_liubiao_gg", "https://jyzx.dh.gov.cn/jyxx/zfcg/zfcgYcgg", ["name", "href", "ggstart_time", "info"], f1,
     f2],

    ["zfcg_gqita_da_bian_gg", "https://jyzx.dh.gov.cn/jyxx/zfcg/gzsx", ["name", "href", "ggstart_time", "info"],
     f1, f2],
    ["zfcg_zhongbiaohx_gg", "https://jyzx.dh.gov.cn/jyxx/zfcg/zbjggs", ["name", "href", "ggstart_time", "info"],
     f1, f2],
...
def work(conp, **args):
    est_meta(conp, data=data, diqu="云南省德宏市", **args)
    est_html(conp, f=f3, **args)


if __name__ == '__main__':
    conp = ["postgres", "since2015", "192.168.3.171", "yunnan_new", "dehong"]
