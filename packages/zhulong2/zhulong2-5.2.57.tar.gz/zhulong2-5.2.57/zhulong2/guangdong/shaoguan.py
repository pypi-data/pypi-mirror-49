...
def work(conp, **args):
    est_meta_large(conp, data=data, diqu="广东省韶关市", **args)
...
if __name__ == '__main__':
    work(conp=["postgres", "since2015", "192.168.3.171", "guoziqiang", "shaoguan"],pageloadtimeout=120,interval_page=10)
