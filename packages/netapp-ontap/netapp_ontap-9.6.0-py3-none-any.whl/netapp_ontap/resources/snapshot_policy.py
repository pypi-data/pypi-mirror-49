...
ONTAP provides three cluster wide Snapshot copy policies, which are "default", "default-1weekly" and "none" policies.
...
There is also a retention count associated with every schedule. This count indicates the maximum number of Snapshot copies that can exist for a given schedule. So once the Snapshot copy count reaches the retention count, on the next create the oldest Snapshot copy is deleted.<br/>
...
class SnapshotPolicySchema(ResourceSchema):
 ...
 """
    copies = fields.List(fields.Nested("SnapshotPolicyCopiesSchema", unknown=EXCLUDE))
...
class SnapshotPolicy(Resource):
 ...
 """
    ...
    get_collection.__func__.__doc__ = r"""Retrieves a collection of Snapshot copy policies.
...
"""
    ...
    patch_collection.__func__.__doc__ = r"""Updates a Snapshot copy policy
### Related ONTAP commands
...
"""
    ...
    delete_collection.__func__.__doc__ = r"""Deletes a Snapshot copy policy
### Related ONTAP commands
...
"""
    ...
    find.__func__.__doc__ = r"""Retrieves a collection of Snapshot copy policies.
### Related ONTAP commands
* `snapshot policy show`
### Learn more
* [`DOC /storage/snapshot-policies`](#docs-storage-storage_snapshot-policies)
"""
    ...
    get.__doc__ = r"""Retrieves details of a specific Snapshot copy policy.
### Related ONTAP commands
* `snapshot policy show`
### Learn more
* [`DOC /storage/snapshot-policies`](#docs-storage-storage_snapshot-policies)
"""
    ...
    post.__doc__ = r"""Creates a Snapshot copy policy.
### Required properties
...
"""
    ...
    patch.__doc__ = r"""Updates a Snapshot copy policy
### Related ONTAP commands
* `snapshot policy modify`
* `snapshot policy modify-schedule`
* `snapshot policy add-schedule`
...
"""
    ...
    delete.__doc__ = r"""Deletes a Snapshot copy policy
### Related ONTAP commands
* `snapshot policy delete`
### Learn more
* [`DOC /storage/snapshot-policies`](#docs-storage-storage_snapshot-policies)
