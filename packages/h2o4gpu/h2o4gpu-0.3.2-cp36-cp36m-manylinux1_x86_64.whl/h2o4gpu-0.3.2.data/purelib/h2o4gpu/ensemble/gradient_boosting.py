...
shape (n_estimators, ``loss_.K``)
    ...
    def __init__(self, loss='deviance', learning_rate=0.1, n_estimators=100,
        ...
        super(GradientBoostingClassifierSklearn, self).__init__(
...
class GradientBoostingRegressorSklearn(BaseGradientBoosting, RegressorMixin):
    ...
    See also
    --------
    DecisionTreeRegressor, RandomForestRegressorSklearn
    ...
    def __init__(self, loss='ls', learning_rate=0.1, n_estimators=100,
        ...
        super(GradientBoostingRegressorSklearn, self).__init__(
            loss=loss, learning_rate=learning_rate, n_estimators=n_estimators,
            criterion=criterion, min_samples_split=min_samples_split,
            min_samples_leaf=min_samples_leaf,
            min_weight_fraction_leaf=min_weight_fraction_leaf,
    ...
    def apply(self, X):
        ...
        leaves = super(GradientBoostingRegressorSklearn, self).apply(X)
