...
class Wikipedia(Client):
    ...
    def save(self, path, **kwargs):
        ...
        countries = self.data[['wikipedia_parl_prev', 'wikipedia_parl_next',
                               ...
                               'country', 'wikipedia_head_state_title',
                               'wikipedia_head_state_name', 'wikipedia_head_gov_title',
...
def scrape_visas():
    ...
    from_ = df['wikipedia_visa_country_from'].map(Country.denonym_to_id())
    df['wikipedia_visa_country_from'] = from_.fillna(
        df['wikipedia_visa_country_from'].map(dict(Country.name_to_id())))
