...
class VscanSchema(ResourceSchema):
 ...
 """
    on_access_policies = fields.List(fields.Nested("VscanOnAccessSchema", unknown=EXCLUDE))
    r""" The on_access_policies field of the vscan.
 """
    on_demand_policies = fields.List(fields.Nested("VscanOnDemandSchema", unknown=EXCLUDE))
    r""" The on_demand_policies field of the vscan.
 """
    scanner_pools = fields.List(fields.Nested("VscanScannerPoolSchema", unknown=EXCLUDE))
...
class Vscan(Resource):
 ...
 """
    ...
    get_collection.__func__.__doc__ = r"""Retrieves the Vscan configuration.
...
"""
    ...
    patch_collection.__func__.__doc__ = r"""Updates the Vscan configuration of an SVM. Allows you to either enable or disable a Vscan, and allows you to clear the Vscan cache that stores the past scanning data for an SVM.<br/>
Important note:
...
"""
    ...
    delete_collection.__func__.__doc__ = r"""Deletes a Vscan configuration.<br/>
Important notes:
...
"""
    ...
    find.__func__.__doc__ = r"""Retrieves the Vscan configuration.
This includes scanner-pools, On-Access policies, On-Demand policies, and information about whether a Vscan is enabled or disabled on an SVM.<br/>
Important notes:
* There can be only one Vscan configuration enabled for an SVM at any time.
* You can only query using `svm.uuid` or `svm.name`.
...
"""
    ...
    get.__doc__ = r"""Retrieves the Vscan configuration for a specified SVM.
This includes scanner-pools, On-Access policies, On-Demand policies, and information about whether a Vscan is enabled or disabled on an SVM.<br/>
Important note:
* There can be only one Vscan configuration enabled for an SVM at any time.
### Related ONTAP commands
...
"""
    ...
    post.__doc__ = r"""Creates a Vscan configuration, which includes a list of scanner-pools, Vscan On-Access policies and Vscan On-Demand policies. Defines whether the Vscan configuration you’re creating is enabled or disabled for a specified SVM.<br/>
Important notes:
* There can be only one Vscan configuration enabled for an SVM at any time.
...
"""
    ...
    patch.__doc__ = r"""Updates the Vscan configuration of an SVM. Allows you to either enable or disable a Vscan, and allows you to clear the Vscan cache that stores the past scanning data for an SVM.<br/>
Important note:
* The Vscan PATCH endpoint does not allow you to modify scanner-pools, On-Demand policies or On-Access policies. Those modifications can only be done through their respective endpoints.
### Related ONTAP commands
* `vserver vscan enable`
...
"""
    ...
    delete.__doc__ = r"""Deletes a Vscan configuration.<br/>
Important notes:
* The Vscan DELETE endpoint deletes all of the Vscan configuration of an SVM. It first disables the Vscan and then deletes all of the SVM scanner-pools, On-Access policies, and On-Demand policies.
* Any active Vscan On-Access policy must first be disabled on an SVM before performing the Vscan delete operation on that SVM.
### Related ONTAP commands
