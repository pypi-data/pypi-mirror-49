...
from tlclient.trader.constant import ExchangeID, OffsetFlag, OrderType, MsgType, TradingStyle, BarType
...
class Client(Fist):
    ...
    def insert_algo_order(self, tg_name, exchange, ticker, volume, direction, order_type, start_time, end_time, sec_interval, trading_style, **algo_args):
        req = message_trade.ReqOrderInsert()
        req.tg_name = bytify(tg_name)
        req.exchange = exchange
        req.ticker = bytify(ticker)
    ...
    def insert_algo_order_twap(self, tg_name, exchange, ticker, volume, direction, start_time, end_time, sec_interval, trading_style=TradingStyle.NEUTRAL):
        return self.insert_algo_order(tg_name, exchange, ticker, volume, direction, OrderType.TWAP, start_time, end_time, sec_interval, trading_style)  # no extra args
