...
def get_data():
    ...
    regionIds = OrderedDict([ ("中山市", "0112") ])
...
def work(conp, **args):
    est_meta_large(conp, data=data, diqu="广东省中山市", **args)
...
if __name__ == '__main__':
    work(conp=["postgres", "since2015", "192.168.3.171", "guoziqiang", "zhongshan1"],pageloadtimeout=120,interval_page=10)
