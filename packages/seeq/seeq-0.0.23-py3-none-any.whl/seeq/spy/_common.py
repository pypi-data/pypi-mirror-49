...
DEFAULT_FETCH_PAGE_SIZE = 1000000
...
def ipython_display(*objs, include=None, exclude=None, metadata=None, transient=None, display_id=None, **kwargs):
    IPython.display.display(objs=objs, include=include, exclude=exclude, metadata=metadata, transient=transient,
                            display_id=display_id, kwargs=kwargs)
