...
class Player(object):
    ...
    def get_label_markup(self, text):
...
class Winner(object):
    ...
    def get_colored_player_name(self):
        ...
        if self.color[1] in "bcdef" or self.color[3] in "bcdef" or self.color[5] in "bcdef":
            player_name = "<span background='{}' foreground='#000000'>{}</span>".format(self.color,
                self.name)
        else:
            player_name = "<span background='{}' foreground='#ffffff'>{}</span>".format(self.color,
                self.name)
