...
class TextModel(object):
	...
	def save(self, model_name):
		...
		self.svm_model.save(model_name + '/learner', True)
...
def train_text(name, text_src, svm_file = None, converter_arguments = '', grid_arguments = '0', feature_arguments = '', train_arguments = '', extra_svm_files = []):
	"""
	...
	*extra_svm_files* is a list of user-defined LIBSVM-format file paths 
	...
	"""
	svm_file = svm_file or os.path.join (name, 'data.svm')
...
def predict_text(name, text_src, text_model, svm_file=None, predict_arguments='', extra_svm_files = []):
	"""
