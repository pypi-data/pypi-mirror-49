...
function GetOciCommandsToLongParams_db() {
    $ociCommandsToLongParams = @{
        ...
        'db autonomous-database create' = 'admin-password autonomous-container-database-id compartment-id cpu-core-count data-storage-size-in-tbs db-name db-workload defined-tags display-name freeform-tags from-json help is-auto-scaling-enabled is-dedicated is-preview-version-with-service-terms-accepted license-model max-wait-seconds wait-for-state wait-interval-seconds'
        'db autonomous-database create-from-clone' = 'admin-password autonomous-container-database-id clone-type compartment-id cpu-core-count data-storage-size-in-tbs db-name db-workload defined-tags display-name freeform-tags from-json help is-auto-scaling-enabled is-dedicated is-preview-version-with-service-terms-accepted license-model max-wait-seconds source-id wait-for-state wait-interval-seconds'
