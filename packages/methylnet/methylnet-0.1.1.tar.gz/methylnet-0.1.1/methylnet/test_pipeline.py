...
methylnet-embed launch_hyperparameter_scan {0} --hyperparameter_yaml example_embedding_hyperparameter_grid.yaml -sc Age -mc 0.84 -b 1. -g -j 20
methylnet-embed launch_hyperparameter_scan {0} --hyperparameter_yaml example_embedding_hyperparameter_grid.yaml -sc Age -g -n 1 -b 1.
pymethyl-visualize transform_plot -i embeddings/vae_methyl_arr.pkl -nn 8 -c Age -o results/vae_embedding_plot.html
methylnet-predict launch_hyperparameter_scan {0} --hyperparameter_yaml example_prediction_hyperparameter_grid.yaml -ic Age -mc 0.84 -g -j 20
methylnet-predict launch_hyperparameter_scan {0} --hyperparameter_yaml example_prediction_hyperparameter_grid.yaml -ic Age -g -n 1
