...
# -*- coding: utf-8 -*-
"""
Created on Thu Jul 18 20:38:21 2019
...
def generate_data_set(url):
    ...
    try:
        ...
        '''
        rank = BeautifulSoup(urllib.request.urlopen("http://data.alexa.com/data?cli=10&dat=snbamz&url=%"+ url+'%').read(), "xml").find("REACH")['RANK']
        'http://tools.mercenie.com/alexa-rank-checker/api/?format=json&urls=
        '''
        rank= int(rank)
        if (rank<100000):
            data_set.append(1)
