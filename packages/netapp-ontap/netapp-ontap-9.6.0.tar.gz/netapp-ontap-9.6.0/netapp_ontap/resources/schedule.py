...
# Overview
The /cluster/schedules API is used to view, create, and modify job schedules in a cluster.
## Retrieving a job schedule
Job schedules can be retrieved by issuing a GET request to /cluster/schedules. It is also possible to retrieve a specific schedule when qualified by its UUID to /cluster/schedules/{uuid}. Queries on fields can be applied to retrieve all schedules that match the combined query.
## Example
```
# The API:
...
A job schedule is created by issuing a POST request to /cluster/schedules to a node in the cluster. For a successful request, the POST request returns a status code of 201.
...
You are required to provide a "minutes" field for a cron schedule. An "interval" field is required for an interval schedule. You must not provide both a "cron" field and an "interval" field.
...
```
### Optional fields
By default, the schedule is owned by the local cluster. In a MetroCluster configuration, the partner cluster can be specified if the local cluster is in the switchover state.

* cluster.name - Name of the cluster owning the schedule
* cluster.uuid - UUID of the cluster owning the schedule
### Records field
Multiple schedules can be created in one request by providing an array of named records with schedule entries. Each entry must follow the required and optional fields listed above.
...
* cron.months
* interval
Note: The name, cluster, and type of schedule cannot be modified. Also, you cannot modify a cron field of an interval schedule, or the interval field of a cron schedule. Queries on fields can be applied to modify all schedules that match the combined query.
## Example
```
# The API:
/api/cluster/schedules/{uuid}
...
Job schedules can be deleted based on their UUID. Queries on fields can be applied to delete all schedules that match the combined query.
## Example
```
# The API:
/api/cluster/schedules/{uuid}
...
class ScheduleSchema(ResourceSchema):
 ...
 """
    cluster = fields.Nested("ScheduleClusterSchema", unknown=EXCLUDE)
    r""" The cluster field of the schedule.
 """
    cron = fields.Nested("ScheduleCronSchema", unknown=EXCLUDE)
...
Example: P1DT2H3M4S """
    name = fields.Str(validate=len_validation(minimum=1, maximum=256))
    r""" Schedule Name. Required in the URL or POST body.
 """
    type = fields.Str(validate=enum_validation(['cron', 'interval']))
    r""" Schedule type
...
class Schedule(Resource):
 ...
 """
    ...
    get_collection.__func__.__doc__ = r"""Retrieves a schedule.
### Learn more
* [`DOC /cluster/schedules`](#docs-cluster-cluster_schedules)"""
    ...
    patch_collection.__func__.__doc__ = r"""Updates a schedule. Note that you cannot modify a cron field of an interval schedule, or the interval field of a cron schedule.
### Learn more
* [`DOC /cluster/schedules`](#docs-cluster-cluster_schedules)"""
    ...
    delete_collection.__func__.__doc__ = r"""Deletes a schedule.
### Learn more
* [`DOC /cluster/schedules`](#docs-cluster-cluster_schedules)"""
    ...
    find.__func__.__doc__ = r"""Retrieves a schedule.
### Learn more
* [`DOC /cluster/schedules`](#docs-cluster-cluster_schedules)"""
    ...
    get.__doc__ = r"""Retrieves a schedule.
### Learn more
* [`DOC /cluster/schedules`](#docs-cluster-cluster_schedules)"""
    ...
    post.__doc__ = r"""Create a schedule.
### Required Fields
* name - Name of the job schedule
It is required to provide a minutes field for a cron schedule. An interval field is required for an interval schedule. You must not provide both a cron field and an interval field.
...
* [`DOC /cluster/schedules`](#docs-cluster-cluster_schedules)"""
    ...
    patch.__doc__ = r"""Updates a schedule. Note that you cannot modify a cron field of an interval schedule, or the interval field of a cron schedule.
### Learn more
* [`DOC /cluster/schedules`](#docs-cluster-cluster_schedules)"""
    ...
    delete.__doc__ = r"""Deletes a schedule.
### Learn more
* [`DOC /cluster/schedules`](#docs-cluster-cluster_schedules)"""
