...
function GetOciSubcommands_health_checks() {
    $ociSubcommands = @{
        ...
        'health-checks http-monitor' = 'create delete get list update'
        'health-checks http-probe' = 'create-on-demand'
        'health-checks http-probe-result' = 'list'
        'health-checks ping-monitor' = 'create delete get list update'
...
function GetOciCommandsToLongParams_health_checks() {
    $ociCommandsToLongParams = @{
        ...
        'health-checks http-monitor list' = 'all compartment-id display-name from-json help limit page page-size sort-by sort-order'
        ...
        'health-checks ping-monitor list' = 'all compartment-id display-name from-json help limit page page-size sort-by sort-order'
