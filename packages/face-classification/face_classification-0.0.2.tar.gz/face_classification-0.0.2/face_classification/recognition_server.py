...
from face_classification.classifier import FaceClassifier
...
class RecognitionServer(FaceClassifier, ViewStream):
    ...
    def predict(self, img):
        ...
        """
        boundings = FaceClassifier.get_face_boundings(self, img)

        names = []     
        if len(boundings) > 0:            
            embeddings = FaceClassifier.get_face_embeddings(self, img, boundings)
    ...
    def detect(self):
        ...
        boundings = FaceClassifier.get_face_boundings(self, frame)
