...
class Problem(object):
    ...
    def type(self):
        ...
        A relative URI reference that identifies the problem type. When dereferenced, it SHOULD provide human-readable documentation for the problem type (e.g. using HTML).  # noqa: E501
    ...
    def status(self, status):
        ...
        if status is not None and status < 400:  # noqa: E501
            raise ValueError("Invalid value for `status`, must be a value greater than or equal to `400`")  # noqa: E501
