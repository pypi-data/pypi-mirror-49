...
def get_sdk_generator_cli(sdk_generator=None, sdkgen_release=None, temp_dir=None):
    ...
    if not sdk_generator:
        ...
        if sdkgen_release:
            sdkgen_url='https://api.github.ibm.com/repos/CloudEngineering/openapi-sdkgen/releases/tags/'+sdkgen_release
        else:
            sdkgen_url='https://api.github.ibm.com/repos/CloudEngineering/openapi-sdkgen/releases/latest'
