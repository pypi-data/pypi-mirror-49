...
class Interface(object, tk.Frame):
	def __init__(self, fenetre, screens=None, fileIn=None, **kwargs):
		...
		try:
			self._repo = version.Repo(classPaths.PATHS.root, 'hg', self, screen=screens[0][0])
	...
	def _resizeMainWindow(self):
		...
		self._screens[0][0].resizeFrame(self._fenetre, width, height)
