...
class ModelServerClient(base_client.BaseClient):
    ...
    def new_model_server(self, server_name, tag, path, type, cluster_id, docker_image=None, owner=None):
    ...
    def get_model_server_log_entries(self, server_name, tag, follow, owner=None):
