...
# TODO : Should this be named SetSecurityProviderArgs or SetSecurityClientArgsOperation?
...
class SetSecurityClientArgsOperation(PipelineOperation):
    """
    A PipelineOperation object which contains connection arguments which were retrieved from a
    ...
    def __init__(self, provisioning_host, registration_id, id_scope, callback=None):
        """
        Initializer for SetSecurityClientArgsOperation.
        ...
        """
        super(SetSecurityClientArgsOperation, self).__init__(callback=callback)
