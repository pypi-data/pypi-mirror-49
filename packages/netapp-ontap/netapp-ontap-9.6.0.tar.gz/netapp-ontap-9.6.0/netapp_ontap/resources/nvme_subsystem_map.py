...
Example: 00103050h """
    namespace = fields.Nested("NvmeSubsystemMapNamespaceSchema", unknown=EXCLUDE)
...
class NvmeSubsystemMap(Resource):
 ...
 """
    ...
    get_collection.__func__.__doc__ = r"""Retrieves NVMe subsystem maps.
...
"""
    ...
    delete_collection.__func__.__doc__ = r"""Deletes an NVMe subsystem map.
### Related ONTAP commands
...
"""
    ...
    find.__func__.__doc__ = r"""Retrieves NVMe subsystem maps.
### Expensive properties
There is an added cost to retrieving values for these properties. They are not included by default in GET results and must be explicitly requested using the `fields` query parameter. See [`DOC Requesting specific fields`](#docs-docs-Requesting-specific-fields) to learn more.
* `anagrpid`
### Related ONTAP commands
...
"""
    ...
    get.__doc__ = r"""Retrieves an NVMe subsystem map.
### Expensive properties
There is an added cost to retrieving values for these properties. They are not included by default in GET results and must be explicitly requested using the `fields` query parameter. See [`DOC Requesting specific fields`](#docs-docs-Requesting-specific-fields) to learn more.
* `anagrpid`
### Related ONTAP commands
...
"""
    ...
    post.__doc__ = r"""Creates an NVMe subsystem map.
### Required properties
...
"""
    ...
    delete.__doc__ = r"""Deletes an NVMe subsystem map.
### Related ONTAP commands
* `vserver nvme subsystem map delete`
### Learn more
* [`DOC /protocols/nvme/subsystem-maps`](#docs-NVMe-protocols_nvme_subsystem-maps)
