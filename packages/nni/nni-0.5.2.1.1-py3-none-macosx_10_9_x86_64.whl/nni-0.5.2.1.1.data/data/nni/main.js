...
async function initContainer(platformMode) {
    if (platformMode === 'local') {
        ...
        typescript_ioc_1.Container.bind(trainingService_1.TrainingService).to(frameworkcontrollerTrainingService_1.FrameworkControllerTrainingService).scope(typescript_ioc_1.Scope.Singleton);
    }
    else {
