...
def f2(driver):
    ...
    driver.quit()
    if page_num:return int(page_num)
...
def get_data():
    data = []
    sitewebName = OrderedDict([ ("河源市", "河源市,河源市高新区,江东新区,紫金县,和平县,东源县,连平县,龙川县,源城区")])

    sitewebId = OrderedDict([
        ("河源市",
         "4028889705bedd7e0105beed4b240005,40288ba96b167094016b1883a0e90b3c,40288ba95aec0b9e015af034e181604e,297e6a6a49176e8401491832a3e50e87,297e6a6a49176e8401491831f0110e86,297e6a6a49176e840149183132010e85,297e6a6a49176e84014918304f8f0e84,297e6a6a49176e840149182fad390e83,297e6a6a49176e840149182ef2a20e82"),
    ])

    regionIds = OrderedDict([("河源市", "0107")])
    ...
    sx_sitewebId = OrderedDict([("河源市", "4028889705bedd7e0105beed4b240005")])
...
def work(conp, **args):
    est_meta_large(conp, data=data, diqu="广东省河源市", **args)
...
if __name__ == '__main__':
    work(conp=["postgres", "since2015", "192.168.3.171", "guoziqiang", "heyuan"],pageloadtimeout=120,interval_page=10)
