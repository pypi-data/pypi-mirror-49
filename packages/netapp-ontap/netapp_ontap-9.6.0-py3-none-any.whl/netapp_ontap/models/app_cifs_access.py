...
class AppCifsAccessSchema(ResourceSchema):
    ...
    access = fields.Str()
    r""" The CIFS access granted to the user or group. Optional in the POST body
...
* read """
    ...
    r""" The name of the CIFS user or group that will be granted access. Optional in the POST body
 """
