...
start_end=str(start_end.iloc[0,0])
...
codreg1['state']= codreg1['state'].astype('int')
...
vars()['agesex'+str(period)].to_csv(inpath+ 'Avg/agesex'+str(period)+'.csv')
