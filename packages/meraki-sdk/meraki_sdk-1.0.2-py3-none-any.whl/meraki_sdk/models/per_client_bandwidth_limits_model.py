...
import meraki_sdk.models.bandwidth_limits1_model
...
class PerClientBandwidthLimitsModel(object):
    ...
    def from_dictionary(cls,
        ...
        bandwidth_limits = meraki_sdk.models.bandwidth_limits1_model.BandwidthLimits1Model.from_dictionary(dictionary.get('bandwidthLimits')) if dictionary.get('bandwidthLimits') else None
