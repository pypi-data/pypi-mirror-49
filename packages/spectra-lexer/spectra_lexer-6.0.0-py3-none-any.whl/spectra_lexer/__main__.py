...
add("spectra_lexer.steno",    "console",     "Run commands interactively from console.")
add("spectra_lexer.steno",    "analyze",     "Run the lexer on every item in a JSON steno translations dictionary.")
add("spectra_lexer.steno",    "index",       "Analyze a translations file and index each one by the rules it uses.")
