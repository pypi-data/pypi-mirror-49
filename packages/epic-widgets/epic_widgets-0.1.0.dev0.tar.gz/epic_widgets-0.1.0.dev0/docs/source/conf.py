...
# -*- coding: utf-8 -*-
#
# epic_widgets documentation build configuration file
#
...
project = 'epic_widgets'
copyright = '2019, Dmitry Romanov'
...
_version_py = os.path.join(repo, 'epic_widgets', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'epic_widgetsdoc'
...
latex_documents = [
    (master_doc, 'epic_widgets.tex', 'epic_widgets Documentation',
     'Dmitry Romanov', 'manual'),
]
