...
from src.silver_surfer_models.resources.OrangeBookExclusivity import (
    OrangeBookExclusivity,
)
from src.silver_surfer_models.utils.utils import convert_string_to_datetime
...
class OrangeBookExclusivityResourceTestCase(TestCase):
    ...
    @parameterized.expand([
        (['id'],),
        (['appl_no', 'product_no', 'exclusivity_code'],)
    ])
