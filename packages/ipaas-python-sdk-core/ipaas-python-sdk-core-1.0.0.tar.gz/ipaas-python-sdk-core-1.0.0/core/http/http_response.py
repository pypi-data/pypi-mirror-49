...
from core.vendored.requests import Request, Session
from core.vendored.requests.packages import urllib3
from core.http.http_request import HttpRequest
from core.http import protocol_type as PT

from core.vendored.requests import status_codes
