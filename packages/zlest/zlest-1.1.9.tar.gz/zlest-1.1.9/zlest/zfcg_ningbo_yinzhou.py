...
def work(conp, **args):
    est_meta(conp, data=data, diqu="鄞州区人民政府", **args)
    est_html(conp, f=f3, **args)


if __name__ == "__main__":
    conp = ["postgres", "since2015", "192.168.3.171", "zlest", "zfcg_ningbo_yinzhou"]
