...
## Overview
Manages a specific instance of a destination. There are limits to the information that can be modified once a destination is created. For example, a destination's type cannot be changed but the underlying details of the type can be modified.
See the documentation for [/support/ems/destinations](#/docs/support/support_ems_destinations) for details on the various fields in a destination.
## Examples
...
```
### Updating an existing destination (change of e-mail address)
```JSON
# API
...
class EmsDestinationSchema(ResourceSchema):
 ...
 """
    certificate = fields.Nested("EmsDestinationCertificateSchema", unknown=EXCLUDE)
...
Example: administrator@mycompany.com """
    filters = fields.List(fields.Nested("EmsFilterSchema", unknown=EXCLUDE))
...
Example: Admin_Email """
    type = fields.Str(validate=enum_validation(['snmp', 'email', 'syslog', 'rest_api']))
...
class EmsDestination(Resource):
    ...
    get_collection.__func__.__doc__ = r"""Retrieves a collection of event destinations.
...
* [`DOC /support/ems/destinations`](#docs-support-support_ems_destinations)"""
    ...
    patch_collection.__func__.__doc__ = r"""Updates an event destination.
...
* [`DOC /support/ems/destinations/{name}`](#docs-support-support_ems_destinations_{name})"""
    ...
    delete_collection.__func__.__doc__ = r"""Deletes an event destination.
### Related ONTAP commands
...
* [`DOC /support/ems/destinations/{name}`](#docs-support-support_ems_destinations_{name})"""
    ...
    find.__func__.__doc__ = r"""Retrieves a collection of event destinations.
### Related ONTAP commands
* `event notification destination show`
* `event notification show`
...
* [`DOC /support/ems/destinations`](#docs-support-support_ems_destinations)"""
    ...
    get.__doc__ = r"""Retrieves event destinations.
### Related ONTAP commands
* `event notification destination show`
* `event notification show`
...
* [`DOC /support/ems/destinations/{name}`](#docs-support-support_ems_destinations_{name})"""
    ...
    post.__doc__ = r"""Creates an event destination.
### Required properties
* `name` - String that uniquely identifies the destination.
* `type` - Type of destination that is to be created.
* `destination` - String that identifies the destination. The contents of this field changes depending on type.
### Recommended optional properties
...
* [`DOC /support/ems/destinations`](#docs-support-support_ems_destinations)"""
    ...
    patch.__doc__ = r"""Updates an event destination.
### Recommended optional properties
* `filters.name` - New list of filters that should direct to this destination. The existing list is discarded.
* `certificate` - New certificate parameters when the destination type is `rest api`.
### Related ONTAP commands
...
* [`DOC /support/ems/destinations/{name}`](#docs-support-support_ems_destinations_{name})"""
    ...
    delete.__doc__ = r"""Deletes an event destination.
### Related ONTAP commands
* `event notification destination delete`
* `event notification delete`
