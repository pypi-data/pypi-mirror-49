...
class LicensePackageSchema(ResourceSchema):
 ...
 """
    licenses = fields.List(fields.Nested("LicenseSchema", unknown=EXCLUDE))
...
Example: NFS """
    scope = fields.Str(validate=enum_validation(['not_available', 'site', 'cluster', 'node']))
...
* cluster
* node """
    state = fields.Str(validate=enum_validation(['compliant', 'noncompliant', 'unlicensed', 'unknown']))
...
class LicensePackage(Resource):
    ...
    get_collection.__func__.__doc__ = r"""Retrieves a collection of license packages.
...
* [`DOC /cluster/licensing/licenses`](#docs-cluster-cluster_licensing_licenses)"""
    ...
    delete_collection.__func__.__doc__ = r"""Deletes a license.
### Related ONTAP commands
...
* [`DOC /cluster/licensing/licenses/{name}`](#docs-cluster-cluster_licensing_licenses_{name})"""
    ...
    find.__func__.__doc__ = r"""Retrieves a collection of license packages.
### Related ONTAP commands
* `system license show-status`
* `system license show`
...
* [`DOC /cluster/licensing/licenses`](#docs-cluster-cluster_licensing_licenses)"""
    ...
    get.__doc__ = r"""Retrieves a specific license package.
### Related ONTAP commands
* `system license show`
* `system license show-status`
...
* [`DOC /cluster/licensing/licenses/{name}`](#docs-cluster-cluster_licensing_licenses_{name})"""
    ...
    post.__doc__ = r"""Installs one or more feature licenses.
### Required properties
...
* [`DOC /cluster/licensing/licenses`](#docs-cluster-cluster_licensing_licenses)"""
    ...
    delete.__doc__ = r"""Deletes a license.
### Related ONTAP commands
* `system license delete`
