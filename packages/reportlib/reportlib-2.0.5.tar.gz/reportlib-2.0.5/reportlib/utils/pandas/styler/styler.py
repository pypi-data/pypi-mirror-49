...
class Styler(BaseStyler):
    ...
    def __init__(self, data, precision=None, table_styles=None, uuid=None,
        ...
        if not isinstance(table_attributes, dict):
            raise ValueError('table_attributes must be a dict')
        table_attributes['class'] = 'rp-table rp-table-hover rp-table-striped'
        
        super().__init__(data, precision=precision, table_styles=table_styles, uuid=uuid, caption=caption, table_attributes=table_attributes, cell_ids=cell_ids)
    ...
    def set_head(self, head):
        return self.update_render_kwargs(head=head)
      
    def set_foot(self, foot):
        return self.update_render_kwargs(foot=foot)
        
    def update_render_kwargs(self, **kwargs):
        self.render_kwargs.update(kwargs)
        return self
    ...
    def show(self):
        display(HTML(self.render(**self.render_kwargs)))
