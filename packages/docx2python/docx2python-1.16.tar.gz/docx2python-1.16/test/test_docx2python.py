...
from docx2python.main import get_docx_content
from docx2python.iterators import iter_at_depth

OUTPUT = get_docx_content("resources/example.docx")
HTML_OUTPUT = get_docx_content("resources/example.docx", html=True)
...
class TestImageDir:
    ...
    def test_pull_image_files(self) -> None:
        ...
        get_docx_content("resources/example.docx", "delete_this/path/to/images")
