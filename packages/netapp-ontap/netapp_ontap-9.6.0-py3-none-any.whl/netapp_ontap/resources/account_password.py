...
Only cluster administrators with the <i>"admin"</i> role can change the password for other cluster or SVM user accounts. If you are not a cluster administrator, you can change your own password only.
## Examples
...
class AccountPassword(Resource):
 ...
 """
    ...
    post.__doc__ = r"""Updates the password for a user account.
### Required parameters
