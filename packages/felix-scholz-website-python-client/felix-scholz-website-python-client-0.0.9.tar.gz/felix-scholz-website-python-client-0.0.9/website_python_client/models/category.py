...
from typing import NoReturn, Optional, List, Union, Tuple
...
from website_python_client.models import Model, Acl
...
class Category(Model):
    def __init__(self, identifier):
        ...
        self.__acl: Acl = Acl()
        self.__tags: List[website_python_client.models.tag.Tag] = []
        self.__preview: List[website_python_client.models.file.File] = []
    ...
    @staticmethod
    def create_from_json_file(path: List[str], name: str, source: str = 'blog', parent_id: Optional[int] = None) \
            -> 'Category':
    ...
    def create_from_json(self, category_json: dict) -> 'Category':
        ...
        self.acl = Acl().create_from_json(json.dumps(category_json['rights']))
