...
class LoginMessagesSchema(ResourceSchema):
 ...
 """
    banner = fields.Str(validate=len_validation(minimum=0, maximum=2048))
...
Optional in the PATCH body. """
    message = fields.Str(validate=len_validation(minimum=0, maximum=2048))
...
class LoginMessages(Resource):
 ...
 """
    ...
    get_collection.__func__.__doc__ = r"""Retrieves the login banner and messages of the day (MOTD) configured in the cluster
...
* [`DOC /security/login/messages`](#docs-security-security_login_messages)"""
    ...
    patch_collection.__func__.__doc__ = r"""Updates the login messages configuration.
There are no required fields. An empty body will make no modifications.
...
* [`DOC /security/login/messages`](#docs-security-security_login_messages)"""
    ...
    find.__func__.__doc__ = r"""Retrieves the login banner and messages of the day (MOTD) configured in the cluster
and in specific SVMs.
...
* [`DOC /security/login/messages`](#docs-security-security_login_messages)"""
    ...
    get.__doc__ = r"""Retrieves the login messages configuration by UUID.
### Learn more
* [`DOC /security/login/messages`](#docs-security-security_login_messages)"""
    ...
    patch.__doc__ = r"""Updates the login messages configuration.
There are no required fields. An empty body will make no modifications.
