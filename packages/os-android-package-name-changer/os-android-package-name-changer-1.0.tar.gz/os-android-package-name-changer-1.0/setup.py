...
setup(
    ...
    packages=['package_name_changer'],
    version='1.0',
    license='MIT',
    description='will change the package name of an app programmatically (dynamically)',
    author='Oz Shabat',
    ...
    install_requires=['os', 'shutil', 'sys', 'xml', 'ostools'],
    classifiers=[
