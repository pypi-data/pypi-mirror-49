...
def transform_to_correlation_dist(data):
    ...
    # we just need the magnitude of the correlation and don't care
...
def solar_corr(data, labels, center, orbits=10, show_window=True,
               image_path="solar.png", save_png=False):
    """"""
...
def main():
    ...
    solar_corr(data, labels, 'JEDI', save_png=False)
