...
class Datastore(object):
    ...
    def register_azure_blob_container(workspace, datastore_name, container_name, account_name, sas_token=None,
                                      ...
                                      create_if_not_exists=False, skip_validation=False, grant_workspace_access=False,
        ...
        return Datastore._client().register_azure_blob_container(
            workspace, datastore_name, container_name, account_name, sas_token, account_key, protocol,
            endpoint, overwrite, create_if_not_exists, skip_validation, grant_workspace_access=grant_workspace_access,
