...
data = [
    ["gcjs_zhaobiao_gg", "https://www.cdggzy.com/qionglai/site/JSGC/List.aspx",
     ["name", "ggstart_time", "href", "info"], click_link_1(f1), click_link_1(f2)],

    ["gcjs_zhongbiaohx_lx1_gg", "https://www.cdggzy.com/qionglai/site/JSGC/List.aspx",
     ["name", "ggstart_time", "href", "info"], click_link_2(add_info(f1, {'gglx':'结果公布'})), click_link_2(f2)],

    ["gcjs_gqita_bian_bu_gg", "https://www.cdggzy.com/qionglai/site/JSGC/List.aspx",
     ["name", "ggstart_time", "href", "info"], click_link_3(f1), click_link_3(f2)],

    ["gcjs_zhongbiaohx_lx2_gg", "https://www.cdggzy.com/qionglai/site/JSGC/List.aspx",
     ["name", "ggstart_time", "href", "info"], click_link_4(add_info(f1, {'gglx':'评标结果公示'})), click_link_4(f2)],

    ["gcjs_hetong_gg", "https://www.cdggzy.com/qionglai/site/JSGC/List.aspx",
     ["name", "ggstart_time", "href", "info"], click_link_5(f1), click_link_5(f2)],

    ["gcjs_gqita_liu_zhongz_gg", "https://www.cdggzy.com/qionglai/site/JSGC/List.aspx",
     ["name", "ggstart_time", "href", "info"], click_link_6(f1), click_link_6(f2)],
    #
    #
    ["zfcg_zhaobiao_gg", "https://www.cdggzy.com/qionglai/site/Notice/ZFCG/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], click_link_1(f1), click_link_1(f2)],

    ["zfcg_biangeng_gg", "https://www.cdggzy.com/qionglai/site/Notice/ZFCG/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], click_link_2(f1), click_link_2(f2)],

    ["zfcg_gqita_zhong_liu_gg", "https://www.cdggzy.com/qionglai/site/Notice/ZFCG/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], click_link_3(f1), click_link_3(f2)],
    #
    ["zfcg_zhaobiao_wsjj_gg", "https://www.cdggzy.com/qionglai/site/Notice/WSJJ/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], click_link_1(add_info(f1, {'zbfs':'网上竞价'})), click_link_1(f2)],

    ["zfcg_zhongbiao_wsjj_gg", "https://www.cdggzy.com/qionglai/site/Notice/WSJJ/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], click_link_2(add_info(f1, {'zbfs':'网上竞价'})), click_link_2(f2)],

    ["zfcg_liubiao_wsjj_gg", "https://www.cdggzy.com/qionglai/site/Notice/WSJJ/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], click_link_3(add_info(f1, {'zbfs':'网上竞价'})), click_link_3(f2)],

    ["zfcg_gqita_jieguobiangeng_wsjj_gg", "https://www.cdggzy.com/qionglai/site/Notice/WSJJ/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], click_link_4(add_info(f1, {'zbfs':'网上竞价','gglx':'结果变更公告'})), click_link_4(f2)],
    # #
    ["zfcg_zhaobiao_ddcg_gg", "https://www.cdggzy.com/qionglai/site/Notice/DDCG/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], click_link_1(add_info(f1, {'zbfs':'定点采购'})), click_link_1(f2)],

    ["zfcg_zhongbiao_ddcg_gg", "https://www.cdggzy.com/qionglai/site/Notice/DDCG/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], click_link_2(add_info(f1, {'zbfs':'定点采购'})), click_link_2(f2)],

    ["zfcg_liubiao_ddcg_gg", "https://www.cdggzy.com/qionglai/site/Notice/DDCG/NoticeList.aspx",
...
def work(conp,**args):
    est_meta(conp,data=data,diqu="四川省邛崃市",**args)
    est_html(conp,f=f3,**args)


if __name__=='__main__':
    work(conp=["postgres","since2015","192.168.3.171","sichuan","qionglai"])
