...
def itkChangeLabelImageFilterIUS2IUS2_Superclass_cast(obj):
...
def itkChangeLabelImageFilterIUS3IUS3_Superclass_cast(obj):
...
def itkChangeLabelImageFilterIUS2IUS2_cast(obj):
...
def itkChangeLabelImageFilterIUS3IUS3_cast(obj):
