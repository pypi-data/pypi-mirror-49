...
See the documentation for [/support/ems/filters](#/docs/support/support_ems_filters) for details on the various fields in a rule.
## Examples
...
Example: 1 """
    message_criteria = fields.Nested("EmsFilterRuleMessageCriteriaSchema", unknown=EXCLUDE)
    r""" The message_criteria field of the ems_filter_rule.
 """
    type = fields.Str(validate=enum_validation(['include', 'exclude']))
    r""" Rule type
...
class EmsFilterRule(Resource):
 ...
 """
    ...
    get_collection.__func__.__doc__ = r"""Retrieves event filter rules.
...
* [`DOC /support/ems/filters/{name}/rules`](#docs-support-support_ems_filters_{name}_rules)"""
    ...
    patch_collection.__func__.__doc__ = r"""Updates an event filter rule.
...
* [`DOC /support/ems/filters/{name}/rules/{index}`](#docs-support-support_ems_filters_{name}_rules_{index})"""
    ...
    delete_collection.__func__.__doc__ = r"""Deletes an event filter rule.
### Related ONTAP commands
* `event filter rule delete`
...
* [`DOC /support/ems/filters/{name}/rules/{index}`](#docs-support-support_ems_filters_{name}_rules_{index})"""
    ...
    find.__func__.__doc__ = r"""Retrieves event filter rules.
### Related ONTAP commands
* `event filter show`
...
* [`DOC /support/ems/filters/{name}/rules`](#docs-support-support_ems_filters_{name}_rules)"""
    ...
    get.__doc__ = r"""Retrieves an event filter rule.
### Related ONTAP commands
* `event filter show`
...
* [`DOC /support/ems/filters/{name}/rules/{index}`](#docs-support-support_ems_filters_{name}_rules_{index})"""
    ...
    post.__doc__ = r"""Creates an event filter rule.
### Required properties
...
* [`DOC /support/ems/filters/{name}/rules`](#docs-support-support_ems_filters_{name}_rules)"""
    ...
    patch.__doc__ = r"""Updates an event filter rule.
### Recommended optional properties
* `message_criteria` - New criteria on which a rule is to match an event.
### Related ONTAP commands
* `event filter rule add`
...
* [`DOC /support/ems/filters/{name}/rules/{index}`](#docs-support-support_ems_filters_{name}_rules_{index})"""
    ...
    delete.__doc__ = r"""Deletes an event filter rule.
### Related ONTAP commands
* `event filter rule delete`
