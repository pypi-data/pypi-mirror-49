...
#        self.detectorROI = []
    ...
    def findImageQs(self, angles, ub, en):
        ...
        logging.debug("Sys.executable %s" % str(sys.executable))
        logging.debug("__file__ %s " % str(__file__))
        ...
        #---- Feed image Info for calculating the q's
        ...
        image_info = comm_work.bcast(image_info, root = MPI.ROOT)
        comm_work.Barrier()
