...
__all__ = [
    ...
    'unblock_get_random_proxy_ip_from_ip_pool',         # 非阻塞获取随机ip
...
async def unblock_get_random_proxy_ip_from_ip_pool(ip_pool_type=tri_ip_pool,
                                                   high_conceal=True,
                                                   logger=None,) -> str:
    """
    非阻塞获取随机ip
    ...
    proxy_ip = await unblock_func(
        func_name=get_random_proxy_ip_from_ip_pool,
        func_args=func_args,
        logger=logger,
        default_res='',)
