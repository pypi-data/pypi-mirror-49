...
class ProxyHandler(web.RequestHandler):
    ...
    def _execute(self, transforms, *args, **kwargs):
        ...
        try:
            ...
            log.gen_log.debug("request_body:{}".format(self.request.body))
            send_body = self.request.body
            proxy_headers = {}
            ...
            if send_body:
                ...
                proxy_request = HTTPRequest(
                                            ...
                                            method=self.request.method.upper(),
                                            headers=proxy_headers)
            log.gen_log.debug("proxy_request: url:{proxy_request.url}, method:{proxy_request.method}".format(proxy_request=proxy_request))
