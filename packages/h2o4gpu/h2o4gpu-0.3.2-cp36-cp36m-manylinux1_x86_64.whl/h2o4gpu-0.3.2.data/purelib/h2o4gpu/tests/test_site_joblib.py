import os
import pytest
from h2o4gpu import externals
from h2o4gpu.externals import joblib as joblib_vendored
...
def test_old_pickle(tmpdir):
    ...
    h2o4gpu_externals_home = os.path.dirname(externals.__file__)
    if not vendored_joblib_home.startswith(h2o4gpu_externals_home):
