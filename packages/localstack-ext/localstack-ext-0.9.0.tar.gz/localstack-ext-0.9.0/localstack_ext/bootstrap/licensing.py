...
def read_api_key():
    ...
    if key:
        return key
    raise Exception('Unable to retrieve API key. Please configure $LOCALSTACK_API_KEY in your environment')
...
def prepare_environment():
    ...
    if not ENV_PREPARED.get('done'):
        try:
            ...
            # a meaningful log message here (asking the user to set $LOCALSTACK_API_KEY)
            pass
