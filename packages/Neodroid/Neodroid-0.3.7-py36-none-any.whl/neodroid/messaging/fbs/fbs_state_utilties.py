...
def deserialise_euler_transform(f_obs)-> Tuple[Any, Any]:
  ...
  return [[position.X(), position.Y(), position.Z()],
          ...
          ], [N.Range(decimal_granularity=10) for _ in range(9)]
...
def deserialise_body(f_obs):
  ...
  return [
           ...
           ], [N.Range(decimal_granularity=10) for _ in range(6)]
...
def deserialise_quadruple(f_obs) -> Tuple[Any, Any]:
  ...
  return data, [N.Range(decimal_granularity=10) for _ in range(4)]
...
def deserialise_quaternion_transform(f_obs) -> Tuple[Any, Any]:
  ...
  return data, [N.Range(decimal_granularity=10) for _ in range(7)]
...
def deserialise_array(f_obs)-> Tuple[Any, Any]:
  ...
  return data, [N.Range(decimal_granularity=10) for _ in range(array.ArrayLength())]
