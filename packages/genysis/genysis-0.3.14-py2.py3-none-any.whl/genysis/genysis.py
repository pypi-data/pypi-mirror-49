...
class fea:
    ...
    def run(self,token):
        inputs = [self.volume] + [ load['condition']['file'] for load in self.setting['load_conditions'] ]  + [ support['condition']['file'] for support in self.setting['support_conditions'] ]
