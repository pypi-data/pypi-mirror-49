...
class MagicCategory(object):
    ...
    def score(self):
        ...
        *WARNING* Categories have been replaced by labels. If the category type is `ground_truth`, score is the number of users who have labeled  the binary with the given category. If category type is `inferred`, score is the number of MAGIC matches that have the given category.  # noqa: E501
