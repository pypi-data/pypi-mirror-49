...
# Whether or not to inherit the parent environment
# The upstream nerdvegas/rez inherits each key/value pair
# of the parent environment, except for when a key is referenced
# by a package. The result is an unreliable context, relative
