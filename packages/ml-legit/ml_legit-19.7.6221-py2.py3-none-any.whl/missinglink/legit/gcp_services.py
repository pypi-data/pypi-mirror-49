...
class GcpComputeCredentials(object):
    @classmethod
    def get_project_id_from_gcp_compute_instance(cls):
        import requests
        from requests.adapters import HTTPAdapter
    ...
    @classmethod
    def get_gcp_credentials(cls, **_):

        def _is_rm_job():
            return 'ML_JOB_ID' in os.environ
...
class GCPServices(object):
    ...
    def get_default_project_id(cls):
        project_methods = (
            GaeCredentials.get_project_id_from_gae,
            GcpComputeCredentials.get_project_id_from_gcp_compute_instance,
            GoogleCredentialsFile.get_project_id_from_path
        )
        for project_id_method in project_methods:
    ...
    def gcp_default_credentials(cls, scopes=None, **kwargs):
        ...
        method_checkers = [
            ...
            GcpComputeCredentials.get_gcp_credentials(**kwargs),
        ]
