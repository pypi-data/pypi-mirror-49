...
## Overview
Quotas are defined in quota rules specific to FlexVols or FlexGroup volumes.  Each quota rule has a type. The type can be "user", "group", or "tree".</br>
...
This API is used to create a new quote policy rule. <br/>
...
class QuotaRuleSchema(ResourceSchema):
 ...
 """
    files = fields.Nested("QuotaRuleFilesSchema", unknown=EXCLUDE)
    r""" The files field of the quota_rule.
 """
    group = fields.Nested("QuotaRuleGroupSchema", unknown=EXCLUDE)
    r""" The group field of the quota_rule.
 """
    qtree = fields.Nested("QuotaRuleQtreeSchema", unknown=EXCLUDE)
    r""" The qtree field of the quota_rule.
 """
    space = fields.Nested("QuotaRuleSpaceSchema", unknown=EXCLUDE)
    r""" The space field of the quota_rule.
 """
    svm = fields.Nested("SvmSchema", unknown=EXCLUDE)
    r""" The svm field of the quota_rule.
 """
    type = fields.Str(validate=enum_validation(['tree', 'user', 'group']))
...
* group """
 ...
 """
    users = fields.List(fields.Nested("QuotaReportUsersSchema", unknown=EXCLUDE))
...
class QuotaRule(Resource):
    ...
    get_collection.__func__.__doc__ = r"""Retrieves quota policy rules configured for all FlexVols and FlexGroup volumes.
...
* [`DOC /storage/quota/rules`](#docs-storage-storage_quota_rules)"""
    ...
    patch_collection.__func__.__doc__ = r"""Updates properties of a specific quota policy rule. <br>
Important notes:
...
* [`DOC /storage/quota/rules`](#docs-storage-storage_quota_rules)"""
    ...
    delete_collection.__func__.__doc__ = r"""Deletes a quota policy rule.
### Related ONTAP commands
...
* [`DOC /storage/quota/rules`](#docs-storage-storage_quota_rules)"""
    ...
    find.__func__.__doc__ = r"""Retrieves quota policy rules configured for all FlexVols and FlexGroup volumes.
### Related ONTAP commands
* `quota policy rule show`
...
* [`DOC /storage/quota/rules`](#docs-storage-storage_quota_rules)"""
    ...
    get.__doc__ = r"""Retrieves properties for a specific quota policy rule.
### Related ONTAP commands
* `quota policy rule show`
...
* [`DOC /storage/quota/rules`](#docs-storage-storage_quota_rules)"""
    ...
    post.__doc__ = r"""Creates a quota policy rule for a FlexVol or a FlexGroup volume.<br/>
Important notes:
...
* [`DOC /storage/quota/rules`](#docs-storage-storage_quota_rules)"""
    ...
    patch.__doc__ = r"""Updates properties of a specific quota policy rule. <br>
Important notes:
* The quota resize functionality is supported with the PATCH operation.
* Quota resize allows you to modify the quota limits, directly in the filesystem.
* The quota must be enabled on a FlexVol or a FlexGroup volume for `quota resize` to take effect.
...
* [`DOC /storage/quota/rules`](#docs-storage-storage_quota_rules)"""
    ...
    delete.__doc__ = r"""Deletes a quota policy rule.
### Related ONTAP commands
* `quota policy rule delete`
