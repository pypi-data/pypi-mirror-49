...
class SqlOnSanDbSchema(ResourceSchema):
    ...
    size = fields.Integer()
    r""" The size of the db. Usage: {&lt;integer&gt;[KB|MB|GB|TB|PB]} Required in the POST body and optional in the PATCH body
 """
    storage_service = fields.Nested("SqlOnSanDbStorageServiceSchema", unknown=EXCLUDE)
