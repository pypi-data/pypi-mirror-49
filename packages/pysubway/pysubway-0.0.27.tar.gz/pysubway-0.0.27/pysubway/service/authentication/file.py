...
class AuthenticationFile(AuthenticationBase):
    ...
    def __init__(self, code_book_path: str = '', default_section: str = ''):
        """

        :param code_book_path: records account and password, support ini
        """
        super().__init__()
        self.file_path: str = code_book_path
