...
class Stories(ApiModule):
    ...
    def get(self, owner_id=None, extended=0):
        return self._get_response(locals())

    def getBanned(self, extended=None, fields=None):
        return self._get_response(locals())

    def getById(self, stories, extended=0, fields=None):
        return self._get_response(locals())
    ...
    def getReplies(self, owner_id, story_id, access_key=None, extended=0, fields=None):
        return self._get_response(locals())
    ...
    def getViewers(self, story_id, owner_id=None, count=100, offset=0, extended=0):
        return self._get_response(locals())
