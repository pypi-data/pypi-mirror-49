...
Example: 10.254.101.111/28 """
    direction = fields.Str(validate=enum_validation(['win_unix', 'unix_win', 'krb_unix']))
...
* unix_win
* krb_unix """
    index = fields.Integer(validate=integer_validation(minimum=1, maximum=2147483647))
...
class NameMapping(Resource):
 ...
 """
    ...
    get_collection.__func__.__doc__ = r"""Retrieves the name mapping configuration for all SVMs.
...
"""
    ...
    patch_collection.__func__.__doc__ = r"""Updates the name mapping configuration of an SVM.
### Related ONTAP commands
...
"""
    ...
    delete_collection.__func__.__doc__ = r"""Deletes the name mapping configuration.
### Related ONTAP commands
...
"""
    ...
    find.__func__.__doc__ = r"""Retrieves the name mapping configuration for all SVMs.
### Related ONTAP commands
* `vserver name-mapping show`
### Learn more
* [`DOC /name-services/name-mappings`](#docs-name-services-name-services_name-mappings)
"""
    ...
    get.__doc__ = r"""Retrieves the name mapping configuration of an SVM.
### Related ONTAP commands
* `vserver name-mapping show`
### Learn more
* [`DOC /name-services/name-mappings`](#docs-name-services-name-services_name-mappings)
"""
    ...
    post.__doc__ = r"""Creates name mappings for an SVM.
### Required properties
...
"""
    ...
    patch.__doc__ = r"""Updates the name mapping configuration of an SVM.
### Related ONTAP commands
* `vserver name-mapping insert`
* `vserver name-mapping modify`
### Learn more
...
"""
    ...
    delete.__doc__ = r"""Deletes the name mapping configuration.
### Related ONTAP commands
* `vserver name-mapping delete`
### Learn more
* [`DOC /name-services/name-mappings`](#docs-name-services-name-services_name-mappings)
