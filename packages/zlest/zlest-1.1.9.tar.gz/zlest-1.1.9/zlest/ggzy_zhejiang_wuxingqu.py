...
def f3(driver, url):
    ...
    locator = (By.XPATH, '//div[@class="zw"][string-length()>100]')
    WebDriverWait(driver, 10).until(EC.presence_of_element_located(locator))
    ...
    div = soup.find('div', id='zw').parent
...
data = [
    ...
    ["gcjs_zhongbiaohx_fangjian_gg", "http://ggzy.wuxing.gov.cn/jyxx/fjsz/zbjggg/index.html",["name", "ggstart_time", "href", "info"], add_info(f1,{"gclx":"房建市政"}), f2],
    ...
    ["gcjs_zhongbiaohx_jiaotong_gg", "http://ggzy.wuxing.gov.cn/jyxx/jtgc/zbjggg/index.html",["name", "ggstart_time", "href", "info"], add_info(f1,{"gclx":"交通工程"}), f2],
    ...
    ["gcjs_zhongbiaohx_shuili_gg", "http://ggzy.wuxing.gov.cn/jyxx/slgc/zbjggg/index.html",["name", "ggstart_time", "href", "info"], add_info(f1,{"gclx":"水利工程"}), f2],
