...
#
from neptune.internal.cli.hardware.gauges.cpu import CGroupCpuUsageGauge, SystemCpuUsageGauge
from neptune.internal.cli.hardware.gauges.gauge_mode import GaugeMode
from neptune.internal.cli.hardware.gauges.gpu import GpuMemoryGauge, GpuUsageGauge
from neptune.internal.cli.hardware.gauges.memory import CGroupMemoryUsageGauge, SystemMemoryUsageGauge
...
class GaugeFactory(object):
    ...
    def create_gpu_usage_gauge(self, card_index):
        return GpuUsageGauge(card_index=card_index)

    def create_gpu_memory_gauge(self, card_index):
