...
def f1(driver, num):
    ...
    if num != int(cnum):
        val = driver.find_element_by_xpath("//div[@class='morecontent']/table/tbody/tr[1]/td/a").get_attribute('href')[-40:]
...
data = [
    ["gcjs_zhaobiao_gg",
     "http://www.dzggzy.cn/wysweb/jyxx/005005/005005001/",
     ["name", "ggstart_time", "href", "info"],f1,f2],

    ["gcjs_liubiao_gg",
     "http://www.dzggzy.cn/wysweb/jyxx/005005/005005002/",
     ["name", "ggstart_time", "href", "info"],f1,f2],

    ["gcjs_zhongbiaohx_gg",
     "http://www.dzggzy.cn/wysweb/jyxx/005005/005005003/",
     ["name", "ggstart_time", "href", "info"], f1, f2],
    #
    ["zfcg_zhaobiao_gg",
     "http://www.dzggzy.cn/wysweb/jyxx/005004/005004001/",
     ["name", "ggstart_time", "href", "info"], f1, f2],

    ["zfcg_biangeng_gg",
     "http://www.dzggzy.cn/wysweb/jyxx/005004/005004002/",
     ["name", "ggstart_time", "href", "info"], f1, f2],

    ["zfcg_zhongbiao_gg",
     "http://www.dzggzy.cn/wysweb/jyxx/005004/005004004/",
     ["name", "ggstart_time", "href", "info"], f1, f2],

    ["zfcg_liubiao_gg",
     "http://www.dzggzy.cn/wysweb/jyxx/005004/005004006/",
     ["name", "ggstart_time", "href", "info"], f1, f2],
...
def work(conp,**args):
    est_meta(conp,data=data,diqu="四川省万源市",**args)
    est_html(conp,f=f3,**args)


if __name__=='__main__':
    work(conp=["postgres","since2015","192.168.3.171","sichuan","wanyuan"])
