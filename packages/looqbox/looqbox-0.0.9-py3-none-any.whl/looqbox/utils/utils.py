...
def format(value, value_format=None):
    """
    ...
    if isinstance(date_int[0], datetime.date) and isinstance(date_int[1], datetime.date):
        if date_int[0] == date_int[1]:
            date_result = header + " " + var_day + " " + \
                          format(date_int[0], "Date") + date_range_name(date_int)
        else:
            date_result = header + " " + var_from + " " + format(date_int[0], "Date") + var_to \
                          + format(date_int[1], "Date") + date_range_name(date_int)
    else:
        if date_int[0] == date_int[1]:
            date_result = header + " " + var_day + " " + format(date_int[0], "datetime")
        else:
            date_result = header + " " + var_from + " " + format(date_int[0], "datetime") + var_to \
                          + format(date_int[1])
