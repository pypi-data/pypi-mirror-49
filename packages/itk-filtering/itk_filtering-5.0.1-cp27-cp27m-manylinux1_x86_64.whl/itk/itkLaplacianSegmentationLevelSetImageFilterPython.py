...
def itkLaplacianSegmentationLevelSetImageFilterIF2IF2F___New_orig__():
...
def itkLaplacianSegmentationLevelSetImageFilterIF2IF2F_cast(obj):
...
def itkLaplacianSegmentationLevelSetImageFilterIF3IF3F___New_orig__():
...
def itkLaplacianSegmentationLevelSetImageFilterIF3IF3F_cast(obj):
