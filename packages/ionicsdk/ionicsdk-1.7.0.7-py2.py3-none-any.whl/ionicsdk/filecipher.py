...
Classes:\n
        ...
        FileCipherPdf - Cipher that supports PDF file encryption /
                        decryption.\n
    FileCipherDecryptAttributes - Allows for extended input and output
                                  options during decryption.\n
    FileCipherEncryptAttributes - Allows for extended input and output
                                  options during encryption.\n
    FileInfo - Data class used to describe attributes of a file.\n
    FileCipherFamily - Enumeration of all supported cipher families.\n
    FileCrypto - Holds utility functions to retrieve FileInfo from
                 protected data.\n
...
class FileCipherEncryptAttributes(object):
    ...
    Instance Variables:\n
        ...
        version (string): The file format version to encrypt with. It can be left empty to 
        ...
        mutableAttributes (agent::KeyAttributesDict): The key mutable attributes
...
class FileCipherDecryptAttributes(object):
    ...
    Instance Variables:\n
        ...
        attributesOut (agent.KeyAttributesDict): The key attributes
                       associated with the key used to decrypt the file.\n
        accessdeniedpageOut (bytes): The access denied page.\n
        enableaccessdeniedpage (boolean): Indicate whether access denied
                            page object should be populated in the event
...
class FileCipherBase(object):
    ...
    def encryptbytes(self, plaintextbytes, attributes = None, metadata = None, mutableAttributes = None):
        ...
        @param
            attributes (agent.KeyAttributesDict, optional): The
                        attributes to use when creating a key to protect data.
        @param
            metadata (agent.MetadataDict, optional): The metadata
    ...
    def encryptbytes2(self, plaintextbytes, encryptattributesInOut):
        ...
        try:
            ...
            _private.raiseExceptionWithServerResponse(cFileEncryptAttrs.pServerResponseOut, e)
...
class FileCipherAuto(FileCipherBase):
    ...
    Args:
        agentkeyservice(AgentKeyServicesBase): An Agent or your own implementation of AgentKeyServicesBase.
        coverpageservice(CoverPageService): Optional, a custom cover page service. A default service is created if nothing is passed here.
    """
...
class FileCipherGeneric(FileCipherBase):
    ...
    Args:
        agentkeyservice(AgentKeyServicesBase): An Agent or your own
        implementation of AgentKeyServicesBase.
    """
    ##(FileCipherFamily) File Cipher Family enumeration for this class
