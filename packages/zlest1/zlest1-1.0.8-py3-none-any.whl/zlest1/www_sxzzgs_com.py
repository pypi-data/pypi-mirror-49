...
import json
from zlest1.util.etl import est_tbs, est_meta, est_html, gg_existed, add_info
...
data = [
    ["qy_zhaobiao_gg", "http://www.sxzzgs.com/zbgg/index_1.jhtml",["name", "ggstart_time", "href", "info"], f1, f2],
    ["qy_biangeng_gg", "http://www.sxzzgs.com/bggg/index_1.jhtml",["name", "ggstart_time", "href", "info"], f1, f2],
    ["qy_zhongbiaohx_gg", "http://www.sxzzgs.com/jggs/index_1.jhtml",["name", "ggstart_time", "href", "info"], f1, f2],
    ["qy_liubiao_gg", "http://www.sxzzgs.com/cxgg/index_1.jhtml",["name", "ggstart_time", "href", "info"], f1, f2],

]


def work(conp, **args):
    est_meta(conp, data=data, diqu="山西中招招标代理有限公司", **args)
