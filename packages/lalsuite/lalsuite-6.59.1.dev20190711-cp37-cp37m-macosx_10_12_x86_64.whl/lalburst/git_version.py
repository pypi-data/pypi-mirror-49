...
id = "c44c1d1129a02086076aa234082395690ce248fa"
date = "2019-07-10 14:22:51 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "c44c1d1129a02086076aa234082395690ce248fa":
        return
    msg = "Program id (c44c1d1129a02086076aa234082395690ce248fa) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
