...
def f1(driver, num):
    ...
    for tr in trs:
        ...
        if 'http' in href:
            ...
            href = "http://202.109.244.105" + href
...
data = [
    ...
    ["zfcg_zhaobiao_gg",
     "http://202.109.244.105/350200/noticelist/d03180adb4de41acbb063875889f9af1/?page=2&notice_type=463fa57862ea4cc79232158f5ed02d03",
     ['name', 'ggstart_time', 'href', 'info'], f1, f2],
    ["zfcg_biangeng_gg",
     "http://202.109.244.105/350200/noticelist/d03180adb4de41acbb063875889f9af1/?page=1&notice_type=7dc00df822464bedbf9e59d02702b714",
     ['name', 'ggstart_time', 'href', 'info'], f1, f2],
    ["zfcg_zhongbiao_gg",
     "http://202.109.244.105/350200/noticelist/d03180adb4de41acbb063875889f9af1/?page=2&notice_type=b716da75fe8d4e4387f5a8c72ac2a937",
     ['name', 'ggstart_time', 'href', 'info'], f1, f2],
    ["zfcg_gqita_bian_gg",
     "http://202.109.244.105/350200/noticelist/d03180adb4de41acbb063875889f9af1/?page=2&notice_type=d812e46569204c7fbd24cbe9866d0651",
     ['name', 'ggstart_time', 'href', 'info'], f1, f2],
    ["zfcg_zhaobiao_danyilaiyuan_gg",
     "http://202.109.244.105/350200/noticelist/d03180adb4de41acbb063875889f9af1/?page=2&notice_type=255e087cf55a42139a1f1b176b244ebb",
...
if __name__ == '__main__':
    conp = ["postgres", "since2015", "192.168.3.171", "lch", "fujian_xiamen"]
