# Copyright 2018 ClickPaas Cloud Inc. All rights reserved.
#
...
from core.endpoint import EndpointResolver
from core.endpoint.chained_endpoint_resolver import ChainedEndpointResolver
from core.endpoint.user_customized_endpoint_resolver import UserCustomizedEndpointResolver
from core.endpoint.local_config_regional_endpoint_resolver \
    import LocalConfigRegionalEndpointResolver
from core.endpoint.local_config_global_endpoint_resolver \
    import LocalConfigGlobalEndpointResolver
from core.endpoint.location_service_endpoint_resolver \
