...
class Orbit(object):
    ...
    def __init__(self, suppress_logger=False, **kwargs):
        ...
        for kwarg in kwargs:
            self._logger.debug("setting property {} of class instance {} to {}"
                               "".format(kwarg, Orbit.__name__, kwargs[kwarg]))
    ...
    def eccentric_anomaly(self, mean_anomaly=None):
        ...
        try:
            ...
            self._logger.debug("solver scipy.optimize.newton in function "
                               "Orbit.eccentric_anomaly did not provide solution. "
                               "reason: {}".format(e))
            return False
    ...
    def compute_periastron_distance(self):
        ...
        self._logger.debug("setting property {} of class instance {} to {}"
                           "".format('periastron_distance', Orbit.__name__, periastron_distance))
