...
from semilattices.objectbase import SLO
...
class CoordinateDict( object ): 
    ...
    #@exactly_one_kwarg_optional('add_to_coordinate','subtract_from_coordinate')      #generalize to instead be a value to increment/decrment by. this would also be faster
    ...
    @property
    def l0(self):
        r""" :math:`l_{0}` semi-norm of the coordinates.
    ...
    def lp(self, p, w=None):
        r""" Returns the :math:`l_p` norm (:math:`p\geq 1`) or semi-norm (:math:`0\leq p < 1`) of the coordinates.
        ...
        Args:
          p (float): the order of the norm/semi-norm
