...
def itkImageToImageMetricv4F2F2_Superclass_cast(obj):
...
def itkImageToImageMetricv4F3F3_Superclass_cast(obj):
...
def itkImageToImageMetricv4F2F2_cast(obj):
...
def itkImageToImageMetricv4F3F3_cast(obj):
