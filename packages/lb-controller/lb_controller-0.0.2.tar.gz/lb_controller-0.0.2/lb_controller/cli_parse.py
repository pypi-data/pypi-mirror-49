...
_DEF_CONFIG_FILE = '/etc/lbmanager/lbmanager.yaml'
...
def parse():
    ...
    parser.add_argument('-c', '--config', dest='config_filename',
                        default=os.getenv('LBMANAGER_CONFIG', _DEF_CONFIG_FILE),
                        help=f'read configuration from CONFIG (defaults to $LBMANAGER_CONFIG or {_DEF_CONFIG_FILE})',
                        metavar='CONFIG')
