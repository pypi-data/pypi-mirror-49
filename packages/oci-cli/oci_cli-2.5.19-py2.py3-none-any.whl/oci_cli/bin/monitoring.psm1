...
function GetOciSubcommands_monitoring() {
    $ociSubcommands = @{
        ...
        'monitoring alarm' = 'create delete get list update'
...
function GetOciCommandsToLongParams_monitoring() {
    $ociCommandsToLongParams = @{
        'monitoring alarm create' = 'body compartment-id defined-tags destinations display-name freeform-tags from-json help is-enabled max-wait-seconds metric-compartment-id metric-compartment-id-in-subtree namespace pending-duration query-text repeat-notification-duration resolution severity suppression wait-for-state wait-interval-seconds'
        'monitoring alarm delete' = 'alarm-id force from-json help max-wait-seconds wait-for-state wait-interval-seconds'
        ...
        'monitoring alarm update' = 'alarm-id body compartment-id defined-tags destinations display-name force freeform-tags from-json help is-enabled max-wait-seconds metric-compartment-id metric-compartment-id-in-subtree namespace pending-duration query-text repeat-notification-duration resolution severity suppression wait-for-state wait-interval-seconds'
        ...
        'monitoring metric list' = 'all compartment-id compartment-id-in-subtree dimension-filters from-json group-by help limit name namespace page page-size sort-by sort-order'
        'monitoring metric-data post' = 'batch-atomicity from-json help metric-data'
        'monitoring metric-data summarize-metrics-data' = 'compartment-id compartment-id-in-subtree end-time from-json help namespace query-text resolution start-time'
        'monitoring suppression remove' = 'alarm-id from-json help'
    }
