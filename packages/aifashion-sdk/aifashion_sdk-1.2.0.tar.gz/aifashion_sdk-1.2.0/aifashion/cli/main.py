...
from aifashion import __version__
...
# python -m aifashion.cli.completion to update autocompletion.
commands = [
    # ('run', program+'.cli.run'),
...
def main(prog=program, description='AI Fashion command line tool.',
    ...
    parser.add_argument('--id', help='client id & secret yaml file')
    parser.add_argument('subcommand', help='subcommand, including XXXXXX')
