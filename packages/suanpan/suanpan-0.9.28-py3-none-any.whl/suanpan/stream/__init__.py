...
class StreamBase(HasBaseServices, HasLogger, HasDevMode):
    ...
    def initCurrent(self, args):  # pylint: disable=unused-argument
        ...
        self.emptyHandler.initCurrent(message=message)
        return Context.froms(message=message, handler=self.emptyHandler)
...
class Stream(StreamBase):
    ...
    def startMultiRunners(self, runners):
        asyncio.run(runners, thread=True, wait=True)
