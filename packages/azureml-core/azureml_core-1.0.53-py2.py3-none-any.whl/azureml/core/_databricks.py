...
class DatabricksSection(_AbstractRunConfigElement):
    ...
    :type maven_libraries: :class:`list[azureml.core.environment.MavenLibrary]`

    :param pypi_libraries: List of PyPi libraries.
    :type pypi_libraries: :class:`list[azureml.core.environment.PyPiLibrary]`

    :param rcran_libraries: List of RCran libraries.
    :type rcran_libraries: :class:`list[azureml.core.environment.RCranLibrary]`

    :param jar_libraries: List of JAR libraries.
    :type jar_libraries: :class:`list[azureml.core.environment.JarLibrary]`

    :param egg_libraries: List of Egg libraries.
    :type egg_libraries: :class:`list[azureml.core.environment.EggLibrary]`

    :param cluster: Databricks cluster information
    :type cluster: azureml.core.environment.DatabricksCluster
    """
