...
class PlotTwistProject(artella_project.ArtellaProject):
    ...
    def __init__(self, resource=None):
        ...
        super(PlotTwistProject, self).__init__(resource=resource)

    def init_config(self):
        super(PlotTwistProject, self).init_config()
    ...
    def send_email(self, title=None):
        ...
        webbrowser.open("mailto:%s?subject=%s" % (','.join(self._emails), urllib2.quote(title)))
