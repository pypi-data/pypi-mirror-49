...
class MarkovChain(object):
    ...
    def __str__(self) -> str:
        ...
        lines.append(f'{indentation}SIZE:         {self._size:d}')
        lines.append(f'{indentation}CLASSES:      {len(self.communicating_classes):d}')
        lines.append(f'{indentation} - RECURRENT: {len(self.recurrent_classes):d}')
        lines.append(f'{indentation} - TRANSIENT: {len(self.transient_classes):d}')
