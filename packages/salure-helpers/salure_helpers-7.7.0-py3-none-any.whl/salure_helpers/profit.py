...
class UpdateConnector:
    ...
    def update_contract(self, data: dict, overload_fields={}):
        ...
        allowed_fields_contract = ['employee_id', 'type_of_employment', 'enddate_contract', 'termination_reason', 'probation_period', 'probation_enddate',
                                   'cao', 'terms_of_employment', 'type_of_contract', 'employer_number', 'type_of_employee', 'employment']
        required_fields_contract = ['employee_id', 'startdate_contract']
        allowed_fields_function = ['costcarrier_id', 'organizational_unit', 'function_id', 'costcenter_id']
        required_fields_function = []
        allowed_fields_timetable = ['changing_work_pattern', 'weekly_hours', 'parttime_percentage']
        required_fields_timetable = []
        allowed_fields_salary = ['step', 'type_of_salary', 'salary_amount', 'period_table']
        required_fields_salary = []
