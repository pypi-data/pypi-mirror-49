...
from akeyless_auth_api import DefaultApi as AuthApi, SystemUserCredentialsReplyObj, SetUAMAccessCredsParams, \
    CredentialsReplyObj
...
from akeyless_uam_api import DefaultApi as UamApi, DerivationCredsReplyObj, RSADecryptCredsReplyObj, \
    ...
    GetRoleReplyObj, SecretAccessCredsReplyObj, GetAccountRolesReplyObj, GetAccountUsersReplyObj
...
class AkeylessApi(AkeylessApiI):
    ...
    def authenticate_uam_api_key_access(self, access_id, timestamp, nonce, signature, **kwargs):
        ...
        return self.auth_api.authenticate_uam(access_id, timestamp=timestamp, nonce=nonce, signature=signature, **kwargs)
    ...
    def create_user(self, akeyless_uam_user_creds, akeyless_set_user_access_creds, user_name, **kwargs):
        # type: (str, str, str, dict) -> CreateUserReplyObj
        return self.uam_api.create_user(akeyless_uam_user_creds, akeyless_set_user_access_creds,
                                        user_name, **kwargs)
    ...
    def update_user(self, akeyless_uam_user_creds, akeyless_set_user_access_creds,
                    new_user_name, user_name, **kwargs):
        # type: (str, str, str, str, dict) -> None
        return self.uam_api.update_user(akeyless_uam_user_creds, akeyless_set_user_access_creds,
                                        new_user_name, user_name, **kwargs)
