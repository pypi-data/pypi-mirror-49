...
try:
    from h2o4gpu.externals.joblib.externals.cloudpickle import dumps, loads
    cloudpickle = True
except ImportError:
    cloudpickle = False
...
def wrap_non_picklable_objects(obj, keep_wrapper=True):
    ...
    """
    if not cloudpickle:
        raise ImportError("could not from h2o4gpu.externals.joblib.externals import cloudpickle. Please install "
