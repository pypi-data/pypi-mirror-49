...
Example: bd1 """
    ports = fields.List(fields.Nested("PortSchema", unknown=EXCLUDE))
...
class BroadcastDomain(Resource):
 ...
 """
    ...
    get_collection.__func__.__doc__ = r"""Retrieves a collection of broadcast domains for the entire cluster.
...
* [`DOC /network/ethernet/broadcast-domains`](#docs-networking-network_ethernet_broadcast-domains)"""
    ...
    patch_collection.__func__.__doc__ = r"""Updates the properties of a broadcast domain.
### Related ONTAP commands
...
* [`DOC /network/ethernet/broadcast-domains`](#docs-networking-network_ethernet_broadcast-domains)"""
    ...
    delete_collection.__func__.__doc__ = r"""Deletes a broadcast domain.
### Related ONTAP commands
...
* [`DOC /network/ethernet/broadcast-domains`](#docs-networking-network_ethernet_broadcast-domains)"""
    ...
    find.__func__.__doc__ = r"""Retrieves a collection of broadcast domains for the entire cluster.
### Related ONTAP commands
* `network port broadcast-domain show`
...
* [`DOC /network/ethernet/broadcast-domains`](#docs-networking-network_ethernet_broadcast-domains)"""
    ...
    get.__doc__ = r"""Retrieves details of a broadcast domain.
### Related ONTAP commands
* `network port broadcast-domain show`
...
* [`DOC /network/ethernet/broadcast-domains`](#docs-networking-network_ethernet_broadcast-domains)"""
    ...
    post.__doc__ = r"""Creates a new broadcast domain.<br/>
### Required properties
...
* [`DOC /network/ethernet/broadcast-domains`](#docs-networking-network_ethernet_broadcast-domains)"""
    ...
    patch.__doc__ = r"""Updates the properties of a broadcast domain.
### Related ONTAP commands
* `network port broadcast-domain modify`
* `network port broadcast-domain rename`
...
* [`DOC /network/ethernet/broadcast-domains`](#docs-networking-network_ethernet_broadcast-domains)"""
    ...
    delete.__doc__ = r"""Deletes a broadcast domain.
### Related ONTAP commands
* `network port broadcast-domain delete`
