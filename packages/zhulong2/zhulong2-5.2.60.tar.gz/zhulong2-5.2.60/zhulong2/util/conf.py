...
data1 = {
        ...
        'guangdong': ['shenghui', "dongguan", "guangzhou", 'shenzhen',"shantou","zhongshan",
                      ...
                      "chaozhou", "dongguan1", "foshan", "guangzhou1", "heyuan", "huizhou",
                      "jiangmen", "jieyang","maoming","meizhou", "qingyuan", "shantou1",
                      "shanwei", "shaoguan", "shenzhen1", "yangjiang", "yunfu",
...
def get_df():
    ...
    for w in data1.keys():
        tmp1 = data1[w]
        for w1 in tmp1:
            tmp = ["postgres", "since2015", "192.168.4.199", 'zfcg', w + '_' + w1]
            data.append(tmp)
...
# add_conp(["postgres","since2015","192.168.4.199",'zfcg','public'])
