...
The following example configures EMS to send a support e-mail when a WAFL event is observed with an error severity.
...
class EmsConfig(Resource):
    ...
    get.__doc__ = r"""Retrieves the EMS configuration.
...
* [`DOC /support/ems`](#docs-support-support_ems)"""
    ...
    patch.__doc__ = r"""Updates the EMS configuration.
### Related ONTAP commands
* `event config modify`
