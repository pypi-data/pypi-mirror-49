...
class TaskMonkClient:
    ...
    def __init__(self, _base_url, _project_id, _client_id = '', _client_secret = ''):
    ...
    def create_batch(self, batch_name, priority = 0, comments = '', notifications = []):
        ...
        response = apiCall.post(self._get_token(), url, data, 30)
    ...
    def import_taxonomy(self, taxonomy_id, file_path):
        ...
        response = apiCall.file_upload(self._get_token(), url, files, 30)
    ...
    def get_job_progress(self, job_id):
        ...
        response = apiCall.get(self._get_token(), url, {}, 10)
