...
def training_embeddings(walks, dim, cbow=1, workers=3):
    ### GENSIM ###

    epoch_logger = EpochLogger()
    embeddings = Word2Vec(corpus_file=walks, size=dim, workers=workers, min_count=1, callbacks=[epoch_logger],
                          batch_words=100,  sg=cbow)  # gensim.models.
