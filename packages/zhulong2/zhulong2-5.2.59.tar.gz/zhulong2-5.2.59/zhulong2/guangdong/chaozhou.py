...
def get_data():
    ...
    sitewebId = OrderedDict([
        ("潮州市",
         "4028889705bedd7e0105bef5da47000a,40288ba95c3aa249015c3d824d833081,297e55e84b2b5b59014b39c6bebe46de,297e6a6a49176e8401491845c3100e96,297e6a6a49176e840149184392de0e95,297e6a6a49176e8401491841ddd20e94"),
    ])

    regionIds = OrderedDict([("潮州市", "0119")])
...
def work(conp, **args):
    est_meta_large(conp, data=data, diqu="广东省潮州市", **args)
...
if __name__ == '__main__':
    work(conp=["postgres", "since2015", "192.168.3.171", "guoziqiang", "chaozhou"],pageloadtimeout=120,interval_page=10)
