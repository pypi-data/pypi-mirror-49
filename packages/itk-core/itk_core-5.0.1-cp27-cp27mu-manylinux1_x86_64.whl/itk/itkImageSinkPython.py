...
def itkImageSinkICVF22_cast(obj):
...
def itkImageSinkICVF23_cast(obj):
...
def itkImageSinkICVF32_cast(obj):
...
def itkImageSinkICVF33_cast(obj):
...
def itkImageSinkICVF42_cast(obj):
...
def itkImageSinkICVF43_cast(obj):
...
def itkImageSinkIRGBAUC2_cast(obj):
...
def itkImageSinkIRGBAUC3_cast(obj):
...
def itkImageSinkIRGBUC2_cast(obj):
...
def itkImageSinkIRGBUC3_cast(obj):
...
def itkImageSinkIVF22_cast(obj):
...
def itkImageSinkIVF23_cast(obj):
...
def itkImageSinkIVF32_cast(obj):
...
def itkImageSinkIVF33_cast(obj):
...
def itkImageSinkIVF42_cast(obj):
...
def itkImageSinkIVF43_cast(obj):
...
def itkImageSinkVISS2_cast(obj):
...
def itkImageSinkVISS3_cast(obj):
...
def itkImageSinkVIUC2_cast(obj):
...
def itkImageSinkVIUC3_cast(obj):
...
def itkImageSinkVIUS2_cast(obj):
...
def itkImageSinkVIUS3_cast(obj):
