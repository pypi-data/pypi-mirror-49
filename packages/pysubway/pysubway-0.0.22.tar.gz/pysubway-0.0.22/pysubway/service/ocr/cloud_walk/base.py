...
def get_authorization(sk: str, msg: str) -> str:
    k = to_bytes(sk)
    m = to_bytes(msg)
...
class CloudWalkOCRBase:
    ...
    def gen_sign(self, send_data: Dict[str, Any]) -> str:
        ...
        code = to_str(base64.b64encode(code))
        return code
    ...
    @classmethod
    def get_response_body(cls, resp: Dict[str, Any]) -> Dict[str, Any]:
        return resp.get(cls.f_data)

    @classmethod
    def get_code(cls, resp: Dict[str, Any]) -> str:
