...
class Notes(ApiModule):
    ...
    def get(self, note_ids=None, user_id=None, offset=0, count=20, sort=0):
        return self._get_response(locals())

    def getById(self, note_id, owner_id=None, need_wiki=0):
        return self._get_response(locals())

    def getComments(self, note_id, owner_id=None, sort=0, offset=0, count=20):
        return self._get_response(locals())
