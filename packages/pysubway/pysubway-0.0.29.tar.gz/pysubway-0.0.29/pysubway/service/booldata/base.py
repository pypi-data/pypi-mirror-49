...
class BoolDataBase:
    ...
    @staticmethod
    def generate_biz_data(*args: str) -> Dict[str, Any]:
    ...
    def generate_sign(self, biz_data: Dict[str, str]) -> str:
        ...
        return RSAEncryption.generate_signature(sorted_str, self.rsa_prv_key)
    ...
    def result_as_df(self, valuable_part: Union[List, Dict, None], default_part: Union[List, Dict, None],
