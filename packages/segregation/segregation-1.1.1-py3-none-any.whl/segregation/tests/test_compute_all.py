...
class ComputeAll_Tester(unittest.TestCase):
    def test_ComputeAll(self):
        ...
        np.testing.assert_almost_equal(np.array(res.computed['Value']), np.array([ 0.26119743,  0.68914224,  0.00518929,  0.21492221,  0.80449692,
       -0.11194178,  0.00909563,  0.13100189,  0.83965834,  0.15621625,
        ...
        0.21492221,  0.80449692, -0.11194178,  0.00909563,  0.13100189,
