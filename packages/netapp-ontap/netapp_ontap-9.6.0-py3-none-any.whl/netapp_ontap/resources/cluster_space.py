...
class ClusterSpaceSchema(ResourceSchema):
    ...
    block_storage = fields.Nested("ClusterSpaceBlockStorageSchema", unknown=EXCLUDE)
    r""" The block_storage field of the cluster_space.
 """
    cloud_storage = fields.Nested("ClusterSpaceCloudStorageSchema", unknown=EXCLUDE)
    r""" The cloud_storage field of the cluster_space.
 """
    efficiency = fields.Nested("SpaceEfficiencySchema", unknown=EXCLUDE)
    r""" The efficiency field of the cluster_space.
 """
    efficiency_without_snapshots = fields.Nested("SpaceEfficiencySchema", unknown=EXCLUDE)
...
class ClusterSpace(Resource):
    ...
    get.__doc__ = r"""Reports cluster wide storage details across different tiers. By default, this endpoint returns all fields.
