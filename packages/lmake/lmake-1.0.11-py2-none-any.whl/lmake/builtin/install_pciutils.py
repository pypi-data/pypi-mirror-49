...
URL_BASE = "https://github.com/pciutils/pciutils/archive/v{}.tar.gz"
FILENAME_BASE = "v{}.tar.gz"
VERSION = "3.6.2"
...
def check_installed():
    lib_path = os.path.join(get_install_dir(), "lib",  "libpci.a")
...
def install():
    ...
    print("Download pciutils from url: ", url)
    ...
    pciutils_folder = os.path.join(cache_dir, "pciutils-{}".format(VERSION))
    platform = get_platform()
    run_command(["make", "all", "install-lib",
                 "OPT=-O2 -m{}".format(platform),
