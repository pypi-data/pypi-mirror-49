...
class AddRepo(object): # TODO integrate to repo class
	def __init__(self, paths, exe, screens=None, updateData=None, **kwargs):
		...
		fenetre.update()
		if screens:
			screens[0][0].centerFrame(fenetre)
...
class Repo(object):
	def __init__(self, path, exe, papa=None, screen=None, **kwargs):
	...
	def __gui(self):
		if self.__showGui:
			...
			if self.__screen:
				...
				Xpos = (self.__screen.width - width) // 2
				Ypos = (self.__screen.height - height) // 2
