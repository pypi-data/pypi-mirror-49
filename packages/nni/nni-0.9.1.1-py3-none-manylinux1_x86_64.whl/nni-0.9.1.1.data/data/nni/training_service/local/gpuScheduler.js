...
class GPUScheduler {
    ...
    async runGpuMetricsCollectorScript() {
        ...
        const gpuMetricsCollectorScriptPath = path.join(this.gpuMetricCollectorScriptFolder, util_1.getScriptName('gpu_metrics_collector'));
        ...
        util_1.runScript(gpuMetricsCollectorScriptPath);
    }
