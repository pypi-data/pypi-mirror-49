...
def filter_HGT(args):
    ...
    file_out = '%s/%s_min_levels_%s.%s' % (file_in_path, file_in_basename, n, file_in_extension)
    ...
    if flk_plot_folder is not None:
        ...
        flk_plot_folder_qualified = '%s/%s_min_levels_%s' % (flk_plot_folder_path, flk_plot_folder_name, n)
