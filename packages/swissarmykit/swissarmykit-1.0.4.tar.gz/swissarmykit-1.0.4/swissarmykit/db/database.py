...
class %s(%s):\n%s    
    ...
    @classmethod
    def save_id(cls, id, name=None, url=None, others=None): # type: (str, str, str, dict) -> RecordModel
        ''' Note: this method for scraping, but used many place'''
    ...
    @classmethod
    def save_url(cls, url, name=None, html=None, data=None, extra=None, attr=None): # type: (str, str, str, dict, dict, dict) -> RecordModel
        ''' Note: this method for scraping, but used many place'''
        if not url:
            return 0
