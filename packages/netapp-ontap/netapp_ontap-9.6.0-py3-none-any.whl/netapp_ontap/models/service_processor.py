...
class ServiceProcessorSchema(ResourceSchema):
 ...
 """
    ipv4_interface = fields.Nested("IpInterfaceAndGatewaySchema", unknown=EXCLUDE)
    r""" The ipv4_interface field of the service_processor.
 """
    ipv6_interface = fields.Nested("IpInterfaceAndGatewaySchema", unknown=EXCLUDE)
    r""" The ipv6_interface field of the service_processor.
 """
    link_status = fields.Str()
