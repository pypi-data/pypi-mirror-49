...
class BinarySimilarityBinaries(object):
    ...
    def __init__(self, sha1=None, similarity=None):  # noqa: E501
        """BinarySimilarityBinaries - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def sha1(self):
        """Gets the sha1 of this BinarySimilarityBinaries.  # noqa: E501

        A SHA1 cryptographic hash  # noqa: E501

        :return: The sha1 of this BinarySimilarityBinaries.  # noqa: E501
        :rtype: str
        """
        return self._sha1
    ...
    @sha1.setter
    def sha1(self, sha1):
        """Sets the sha1 of this BinarySimilarityBinaries.

        A SHA1 cryptographic hash  # noqa: E501

        :param sha1: The sha1 of this BinarySimilarityBinaries.  # noqa: E501
        :type: str
        """
    ...
    @property
    def similarity(self):
        """Gets the similarity of this BinarySimilarityBinaries.  # noqa: E501

        Similarity score of the match. If using `semantic_hash`, will always be 1.  # noqa: E501

        :return: The similarity of this BinarySimilarityBinaries.  # noqa: E501
        :rtype: float
        """
    ...
    def similarity(self, similarity):
        """Sets the similarity of this BinarySimilarityBinaries.

        Similarity score of the match. If using `semantic_hash`, will always be 1.  # noqa: E501

        :param similarity: The similarity of this BinarySimilarityBinaries.  # noqa: E501
        :type: float
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BinarySimilarityBinaries):
            return False
