...
data = [
    ["qy_gqita_zhao_zhong_gg",
     "http://www.fjic.gov.cn/was5/web/search?channelid=244979&sortfield=-docreltime&classsql=chnlid%3D15908&prepage=20&page=8",
...
def work(conp, **args):
    est_meta(conp, data=data, diqu="福建省经济信息中心 ", **args)
