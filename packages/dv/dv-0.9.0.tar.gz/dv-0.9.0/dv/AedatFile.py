...
class _AedatFileIterator:
    def __init__(self, file_name, data_offset, stream_id, compression_type):
...
class _AedatFileEventIterator(_AedatFileIterator):
    def __init__(self, file_name, data_offset, stream_id, compression_type):
        super().__init__(file_name, data_offset, stream_id, compression_type)
...
class AedatFile:
    ...
    def __getitem__(self, name):
        ...
        if self._name_type_map[name] == 'EVTS':
            iterator = _AedatFileEventIterator(self._file_name, self._data_offset, self._name_id_map[name], self._compression)
        elif self._name_type_map[name] == 'FRME':
            iterator = _AedatFileFrameIterator(self._file_name, self._data_offset, self._name_id_map[name], self._compression)
        elif self._name_type_map[name] == 'IMUS':
            iterator = _AedatFileIMUIterator(self._file_name, self._data_offset, self._name_id_map[name], self._compression)
        elif self._name_type_map[name] == 'TRIG':
            iterator = _AedatFileTriggerIterator(self._file_name, self._data_offset, self._name_id_map[name], self._compression)
        else:
