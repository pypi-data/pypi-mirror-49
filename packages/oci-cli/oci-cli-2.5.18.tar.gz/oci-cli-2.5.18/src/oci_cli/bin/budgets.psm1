...
function GetOciCommandsToLongParams_budgets() {
    $ociCommandsToLongParams = @{
        ...
        'budgets budget create' = 'amount compartment-id defined-tags description display-name freeform-tags from-json help max-wait-seconds reset-period target-compartment-id wait-for-state wait-interval-seconds'
        ...
        'budgets budget list' = 'all compartment-id display-name from-json help lifecycle-state limit page page-size sort-by sort-order'
