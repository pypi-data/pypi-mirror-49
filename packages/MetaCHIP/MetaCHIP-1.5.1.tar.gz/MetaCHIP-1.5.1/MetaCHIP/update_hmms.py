...
MetaCHIP update_hmms -metachip_hmm MetaCHIP_phylo.hmm -pfam_db Pfam-A.hmm -tigrfam_db TIGRFAMs_14.0_HMM
...
def update_hmms(args):
    ...
    current_43_hmm_file =        args['metachip_hmm']
    downloaded_pfam_db =         args['pfam_db']
    TIGRFAMs_profiles_folder =   args['tigrfam_db']
    ...
    cat_cmd = 'cat %s %s/TIGR00344.HMM %s/TIGR00422.HMM > %s' % (Pfam_profiles_updated, TIGRFAMs_profiles_folder, TIGRFAMs_profiles_folder, updated_43_profiles)
    os.system(cat_cmd)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-metachip_hmm',  required=True,                help='MetaCHIP_phylo.hmm file')
    parser.add_argument('-pfam_db',       required=False, default=None, help='Pfam db file, e.g. Pfam-A.hmm')
    parser.add_argument('-tigrfam_db',    required=False, default=None, help='TIGRFAMs db folder, e.g. TIGRFAMs_14.0_HMM')
