...
_BLOCKMSGWITHTRANSFORM.fields_by_name['transform_entry'].message_type = ipc__pb2._TRANSFORMENTRY
...
BlockMsgWithTransform = _reflection.GeneratedProtocolMessageType('BlockMsgWithTransform', (_message.Message,), dict(
