...
Example: scanner-1 """
    privileged_users = fields.List(fields.Str)
...
Example: ["cifs\\u1","cifs\\u2"] """
    role = fields.Str(validate=enum_validation(['primary', 'secondary', 'idle']))
...
class VscanScannerPool(Resource):
 ...
 """
    ...
    get_collection.__func__.__doc__ = r"""Retrieves the Vscan scanner-pool configuration of an SVM.
...
"""
    ...
    patch_collection.__func__.__doc__ = r"""Updates the Vscan scanner-pool configuration of an SVM.<br/>
Important notes:
...
"""
    ...
    delete_collection.__func__.__doc__ = r"""Deletes a Vscan scanner-pool configuration.<br/>
Important notes:
...
"""
    ...
    find.__func__.__doc__ = r"""Retrieves the Vscan scanner-pool configuration of an SVM.
### Related ONTAP commands
* `vserver vscan scanner-pool show`
* `vserver vscan scanner-pool privileged-users show`
* `vserver vscan scanner-pool servers show`
...
"""
    ...
    get.__doc__ = r"""Retrieves the configuration of a specified scanner-pool of an SVM.
### Related ONTAP commands
* `vserver vscan scanner-pool show`
* `vserver vscan scanner-pool privileged-users show`
* `vserver vscan scanner-pool servers show`
...
"""
    ...
    post.__doc__ = r"""Creates a Vscan scanner-pool configuration for a specified SVM. A scanner-pool can be created with all fields specified or only mandatory fields specified.<br/>
Important notes:
...
"""
    ...
    patch.__doc__ = r"""Updates the Vscan scanner-pool configuration of an SVM.<br/>
Important notes:
* Along with servers and privileged-users, the role of a scanner-pool can also be updated with the cluster on which a scanner-pool is allowed.
* If role is specified and cluster isn't, then role is applied to the local cluster.
### Related ONTAP commands
...
"""
    ...
    delete.__doc__ = r"""Deletes a Vscan scanner-pool configuration.<br/>
Important notes:
* The Vscan scanner-pool DELETE endpoint deletes all of the Vscan scanner-pools for a specified SVM.
* If a Vscan is enabled, it requires at least one scanner-pool to be in the active state. Therefore, Vscan must be disabled on the specified SVM so that all of the scanner-pools configured on that SVM can be deleted.
### Related ONTAP commands
