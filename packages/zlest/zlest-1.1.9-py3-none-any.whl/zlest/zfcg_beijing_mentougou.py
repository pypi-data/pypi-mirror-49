...
import pandas as pd
from zlest1.util.fake_useragent import UserAgent

from zlest.util.etl import est_html, est_meta, add_info
import time

_name_ = 'zfcg_beijing_mentougou'
...
def work(conp, **args):
    est_meta(conp, data=data, diqu="北京门头沟政府采购网", **args)
    est_html(conp, f=f3, **args)


if __name__ == "__main__":
    conp = ["postgres", "since2015", "192.168.3.171", "zlest", "zfcg_beijing_mentougou"]
    work(conp)
