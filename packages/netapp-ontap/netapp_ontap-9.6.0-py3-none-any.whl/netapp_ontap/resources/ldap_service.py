...
Example: 389 """
    preferred_ad_servers = fields.List(fields.Str)
...
class LdapService(Resource):
    ...
    get_collection.__func__.__doc__ = r"""Retrieves the LDAP configurations for all SVMs.
...
* [`DOC /name-services/ldap`](#docs-name-services-name-services_ldap)"""
    ...
    patch_collection.__func__.__doc__ = r"""Updates an LDAP configuration of an SVM.
### Important notes
...
* [`DOC /name-services/ldap`](#docs-name-services-name-services_ldap)"""
    ...
    delete_collection.__func__.__doc__ = r"""Deletes the LDAP configuration of the specified SVM. LDAP can be removed as a source from the ns-switch if LDAP is not used as a source for lookups.
...
* [`DOC /name-services/ldap`](#docs-name-services-name-services_ldap)"""
    ...
    find.__func__.__doc__ = r"""Retrieves the LDAP configurations for all SVMs.
...
* [`DOC /name-services/ldap`](#docs-name-services-name-services_ldap)"""
    ...
    get.__doc__ = r"""Retrieves LDAP configuration for an SVM. All parameters for the LDAP configuration are displayed by default.
...
* [`DOC /name-services/ldap`](#docs-name-services-name-services_ldap)"""
    ...
    post.__doc__ = r"""Creates an LDAP configuration for an SVM.
### Important notes
...
* [`DOC /name-services/ldap`](#docs-name-services-name-services_ldap)"""
    ...
    patch.__doc__ = r"""Updates an LDAP configuration of an SVM.
### Important notes
* Both mandatory and optional parameters of the LDAP configuration can be updated.
* The LDAP servers and Active Directory domain are mutually exclusive fields. These fields cannot be empty. At any point in time, either the LDAP servers or Active Directory domain must be populated.
* IPv6 must be enabled if IPv6 family addresses are specified.<br/>
...
* [`DOC /name-services/ldap`](#docs-name-services-name-services_ldap)"""
    ...
    delete.__doc__ = r"""Deletes the LDAP configuration of the specified SVM. LDAP can be removed as a source from the ns-switch if LDAP is not used as a source for lookups.
