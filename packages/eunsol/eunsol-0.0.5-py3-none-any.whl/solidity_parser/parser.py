...
class AstVisitor(SolidityVisitor):
    ...
    def visitParameter(self, ctx: SolidityParser.ParameterContext):
        ...
        typeName = ctx.typeName().getText() if ctx.typeName() else None
...
def objectify(start_node):
    ...
    class ObjectifyContractVisitor(object):
        ...
        def visitUsingForDeclaration(self, _node):
            self.usings[_node.libraryName] = _node

        #def visitMapping(self, _node):
        #    self.mappings[_node] = _node
    
        def visitInheritanceSpecifier(self, _node):
            self.inherited_names[_node.baseName.namePath]=_node
        ...
        def visitFunctionDefinition(self, _node, _definition_type=None):
            ...
            class IdentifierDecVisitor(object):
                ...
                def visitFunctionCall(self, __node):
                    self.idents.append(__node.expression)
            ...
            current_function.parameters = funcargvisitor.parameters
            current_function.declarations.update(current_function.parameters)
            ...
            if _node.get("returnParameters"):
                ...
                current_function.returnsParameters = funcargvisitor.parameters
                current_function.declarations.update(current_function.returnsParameters)
