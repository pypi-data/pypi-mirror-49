...
ALLOWED_GENERAL_KEYS = (
    ...
    'reservation-id', 'local-hostname', 'local-ip', 'hostname',
...
async def status(request: web.Request) -> web.Response:
    return web.json_response({
        'version': __version__,
        'registered': request.app['core'].aws_metadata['registered-state']
    })
...
async def register(request: web.Request) -> web.Response:
    ...
    status, text = await request.app['core'].register_proxy(server_url, key, only_if_not_registered)
