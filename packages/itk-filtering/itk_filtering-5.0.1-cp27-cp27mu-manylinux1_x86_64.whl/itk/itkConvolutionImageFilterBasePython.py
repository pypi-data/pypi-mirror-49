...
def itkConvolutionImageFilterBaseIF2IF2_cast(obj):
...
def itkConvolutionImageFilterBaseIF3IF3_cast(obj):
...
def itkConvolutionImageFilterBaseISS2ISS2_cast(obj):
...
def itkConvolutionImageFilterBaseISS3ISS3_cast(obj):
...
def itkConvolutionImageFilterBaseIUC2IUC2_cast(obj):
...
def itkConvolutionImageFilterBaseIUC3IUC3_cast(obj):
...
def itkConvolutionImageFilterBaseIUS2IUS2_cast(obj):
...
def itkConvolutionImageFilterBaseIUS3IUS3_cast(obj):
