...
```bash
TAG=2.18.0b15 REGISTRY=us.gcr.io/onepanelio make publish-pip-package
```
...
```bash
TAG=2.18.0b13 REGISTRY=us.gcr.io/onepanelio make build-docker-image push-docker-image
```
