# Copyright 2019 ClickPaas Cloud Inc. All rights reserved.
#
...
from core.exception.exceptions import ClientException, ServerException
import core.exception.error_code as error_code
...
class DefaultConfigRetryCondition(MixedRetryCondition):
    ...
    def __init__(self, max_retry_times=None):
        if not self._loaded_retry_config:
            self._loaded_retry_config = core.utils._load_json_from_data_dir(
