...
from core.auth.signers.signer import Signer
from core.exception import error_code
from core.exception import error_msg
from core.exception import exceptions
from core.request import RpcRequest
from core.auth.algorithm import sha_hmac256
...
class RsaKeyPairSigner(Signer):
    ...
    def __init__(self, credential, region_id, debug=False):
        ...
        from core.client import ClickClient
        self._sts_client = ClickClient(
