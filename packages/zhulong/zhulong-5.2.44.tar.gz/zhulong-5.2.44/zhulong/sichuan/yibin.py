...
def f3(driver, url):
    ...
    if 'http://elyg.yibin.gov.cn:88' in url:
        locator = (By.XPATH,"//div[@class='content_nr']//table[string-length()>100]")
...
if __name__=='__main__':
    ...
    #         print(d)
    # driver = webdriver.Chrome()
    # df = f3(driver, ' http://elyg.yibin.gov.cn:88/elyg-xunjia-web/xunjiaxinxi/xjcgGongGao/view/71a6a9f3-6716-4bc1-9447-7153b245df2f.html')
    # print(df)