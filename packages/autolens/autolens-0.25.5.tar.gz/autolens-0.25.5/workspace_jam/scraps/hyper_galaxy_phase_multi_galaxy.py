...
class HyperGalaxyPhase(HyperPhase):
    ...
    class Analysis(af.Analysis):
        ...
        def fit_for_instance(self, instance):
            ...
            if instance.hyper_noise_background is not None:
                noise_map_1d = instance.hyper_noise_background.noise_map_scaled_noise_from_noise_map(
                    noise_map=self.lens_data.noise_map_1d
                )
            else:
                noise_map_1d = self.lens_data.noise_map_1d
    ...
    def run_hyper(self, data, results=None):
        ...
        for path, galaxy in results.last.path_galaxy_tuples:
            ...
            # TODO : WE need to associate each galaxy, for each optimizer, here, to get the new hyper galaxy phase to work.
