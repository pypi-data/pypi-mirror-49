...
the display of folders or other shared resources that the user does not have access to. """
    acls = fields.List(fields.Nested("CifsShareAclSchema", unknown=EXCLUDE))
 ...
 """
    comment = fields.Str(validate=len_validation(minimum=1, maximum=256))
...
%w, %u, and %d variables with the corresponding Windows user name, UNIX user name, and domain name, respectively. """
    name = fields.Str(validate=len_validation(minimum=1, maximum=80))
...
which can increase performance for file operations. """
    path = fields.Str(validate=len_validation(minimum=1, maximum=256))
...
Example: /volume_1/eng_vol/ """
 ...
 """
    unix_symlink = fields.Str(validate=enum_validation(['local', 'widelink', 'disable']))
...
When a CIFS share is created, ONTAP creates a default ACL for the share with Full Control permissions for Everyone. """
    ...
    get_collection.__func__.__doc__ = r"""Retrieves CIFS shares.
...
"""
    ...
    patch_collection.__func__.__doc__ = r"""Updates a CIFS share.
### Related ONTAP commands
...
"""
    ...
    delete_collection.__func__.__doc__ = r"""Deletes a CIFS share.
### Related ONTAP commands
...
"""
    ...
    find.__func__.__doc__ = r"""Retrieves CIFS shares.
### Related ONTAP commands
* `vserver cifs share show`
* `vserver cifs share properties show`
### Learn more
...
"""
    ...
    get.__doc__ = r"""Retrieves a CIFS share.
### Related ONTAP commands
* `vserver cifs share show`
* `vserver cifs share properties show`
### Learn more
...
"""
    ...
    post.__doc__ = r"""Creates a CIFS share.
### Required properties
...
"""
    ...
    patch.__doc__ = r"""Updates a CIFS share.
### Related ONTAP commands
* `vserver cifs share modify`
* `vserver cifs share properties add`
* `vserver cifs share properties remove`
...
"""
    ...
    delete.__doc__ = r"""Deletes a CIFS share.
### Related ONTAP commands
* `vserver cifs share delete`
### Learn more
* [`DOC /protocols/cifs/shares`](#docs-NAS-protocols_cifs_shares)
