...
def itkContinuousIndexD2___len__():
...
def itkContinuousIndexD3___len__():
...
def itkContinuousIndexD4___len__():
...
def itkContinuousIndexF2___len__():
...
def itkContinuousIndexF3___len__():
...
def itkContinuousIndexF4___len__():
