...
import api_tester_upload_test.models.validate

class NestedModelException(api_tester_upload_test.exceptions.api_exception.APIException):
    ...
    def unbox(self, dictionary):
        ...
        self.model = api_tester_upload_test.models.validate.Validate.from_dictionary(dictionary.get('model')) if dictionary.get('model') else None
