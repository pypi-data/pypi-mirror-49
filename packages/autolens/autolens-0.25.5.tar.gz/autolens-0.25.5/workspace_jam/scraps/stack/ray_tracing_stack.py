...
class Tracer.from_galaxies_and_image_plane_grid_stackStack(AbstractTracerStack):
    def __init__(
        self,
        galaxies,
        galaxies,
        ...
        image_plane_grid_stacks = list(
            map(
                lambda data_grids: pix.setup_image_plane_pixelization_grid_from_galaxies_and_grid_stack(
                    galaxies=galaxies, grid_stack=data_grids
                ),
                image_plane_grid_stacks,
            )
        )
        ...
        super(Tracer.from_galaxies_and_image_plane_grid_stackStack, self).__init__(
