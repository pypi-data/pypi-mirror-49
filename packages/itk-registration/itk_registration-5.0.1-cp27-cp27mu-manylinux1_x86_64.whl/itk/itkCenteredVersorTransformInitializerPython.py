...
def itkCenteredVersorTransformInitializerIF3IF3_cast(obj):
...
def itkCenteredVersorTransformInitializerISS3ISS3___New_orig__():
    """itkCenteredVersorTransformInitializerISS3ISS3___New_orig__() -> itkCenteredVersorTransformInitializerISS3ISS3_Pointer"""
    return _itkCenteredVersorTransformInitializerPython.itkCenteredVersorTransformInitializerISS3ISS3___New_orig__()

def itkCenteredVersorTransformInitializerISS3ISS3_cast(obj):
...
def itkCenteredVersorTransformInitializerIUC3IUC3_cast(obj):
...
def itkCenteredVersorTransformInitializerIUS3IUS3_cast(obj):
