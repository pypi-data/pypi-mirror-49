...
def itkMagnitudeAndPhaseToComplexImageFilterIF2IF2ICF2___New_orig__():
...
def itkMagnitudeAndPhaseToComplexImageFilterIF2IF2ICF2_cast(obj):
...
def itkMagnitudeAndPhaseToComplexImageFilterIF3IF3ICF3___New_orig__():
...
def itkMagnitudeAndPhaseToComplexImageFilterIF3IF3ICF3_cast(obj):
