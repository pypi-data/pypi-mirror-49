...
def compatible_platforms(required):
    ...
    ['cannonlake-any', 'skylake_avx512-any', 'skylake-any', 'cannonlake-centos7', 'skylake_avx512-centos7', 'skylake-centos7']
    >>> compatible_platforms('skylake-slc6')
    ['cannonlake-any', 'skylake_avx512-any', 'skylake-any', 'cannonlake-centos7', 'skylake_avx512-centos7', 'skylake-centos7', 'cannonlake-slc6', 'skylake_avx512-slc6', 'skylake-slc6']
