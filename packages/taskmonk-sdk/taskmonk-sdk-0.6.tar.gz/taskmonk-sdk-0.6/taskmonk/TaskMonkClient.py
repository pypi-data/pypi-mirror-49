...
class TaskMonkClient:
    ...
    def create_taxonomy(self, taxonomy_name):
        url = self.base_url + urlConfig.URLS['Project'] + '/' + self.project_id + '/taxonomy'
    ...
    def import_taxonomy(self, taxonomy_id, file_path):
        url = self.base_url + urlConfig.URLS['Project'] + '/v2/' + self.project_id + '/taxonomy/' + taxonomy_id + '/import'
