...
#
# Created: Sat Jul 27 10:54:35 2019
...
"QLabel { color : green; font-weight: bold; font-size: 32pt; }")
    ...
    def retranslateUi(self, Form):
        ...
        self.statisticComboBox.setItemText(4, QtWidgets.QApplication.translate("Form", "mean", None, -1))
        self.statisticComboBox.setItemText(5, QtWidgets.QApplication.translate("Form", "standard deviation", None, -1))
        self.statisticComboBox.setItemText(6, QtWidgets.QApplication.translate("Form", "minimum", None, -1))
        self.statisticComboBox.setItemText(7, QtWidgets.QApplication.translate("Form", "maximum", None, -1))
        self.statisticComboBox.setItemText(8, QtWidgets.QApplication.translate("Form", "peak-to-peak", None, -1))
