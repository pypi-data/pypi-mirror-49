...
class SnapmirrorTransferSchema(ResourceSchema):
 ...
 """
    files = fields.List(fields.Nested("SnapmirrorTransferFilesSchema", unknown=EXCLUDE))
 ...
 """
    relationship = fields.Nested("SnapmirrorTransferRelationshipSchema", unknown=EXCLUDE)
 ...
 """
    state = fields.Str(validate=enum_validation(['aborted', 'failed', 'hard_aborted', 'queued', 'success', 'transferring']))
...
* transferring """
    ...
    r""" This is supported for transfer of restore relationship only. Set this field to 'false' to turn off storage efficiency for data transferred over the wire and written to the destination.
 """
    uuid = fields.Str()
...
class SnapmirrorTransfer(Resource):
 ...
 """
    ...
    get_collection.__func__.__doc__ = r"""Retrieves the list of ongoing SnapMirror transfers for the specified relationship.
...
"""
    ...
    patch_collection.__func__.__doc__ = r"""Aborts an ongoing SnapMirror transfer.
### Related ONTAP commands
* `snapmirror abort`
### Example
<br/>
...
"""
    ...
    find.__func__.__doc__ = r"""Retrieves the list of ongoing SnapMirror transfers for the specified relationship.
### Related ONTAP commands
* `snapmirror show`
### Example
<br/>
...
"""
    ...
    get.__doc__ = r"""Retrieves the attributes of a specific ongoing SnapMirror transfer.
### Related ONTAP commands
* `snapmirror show`
### Example
<br/>
...
"""
    ...
    post.__doc__ = r"""Starts a SnapMirror transfer operation. This API initiates a restore operation if the SnapMirror relationship is of type "restore". Otherwise, it intiates a SnapMirror "initialize" operation or "update" operation based on the current SnapMirror state.
...
"""
    ...
    patch.__doc__ = r"""Aborts an ongoing SnapMirror transfer.
### Related ONTAP commands
* `snapmirror abort`
### Example
<br/>
