...
from zhulong.util.etl import est_tbs, est_meta, est_html, est_gg, est_meta_large
...
def parse_1(trs):
    ...
    for tr in trs:
        ...
        if 'http' in href:
            ...
            href = 'https://www.ynggzyxx.gov.cn' + href
...
data=[
    #
    ["gcjs_zhaobiao_gg","https://www.ynggzyxx.gov.cn/jyxx/jsgcZbgg",[ "name", "href", "ggstart_time", "info"],f1,f2],

    ["gcjs_gqita_da_bian_gg","https://www.ynggzyxx.gov.cn/jyxx/jsgcBgtz",[ "name", "href", "ggstart_time", "info"],f1,f2],

    ["gcjs_zhongbiaohx_gg","https://www.ynggzyxx.gov.cn/jyxx/jsgcpbjggs",[ "name", "href", "ggstart_time", "info"],f1,f2],

    ["gcjs_zhongbiao_gg","https://www.ynggzyxx.gov.cn/jyxx/jsgcZbjggs",["name", "href", "ggstart_time", "info"],f1,f2],

    ["gcjs_liubiao_gg","https://www.ynggzyxx.gov.cn/jyxx/jsgcZbyc",["name", "href", "ggstart_time", "info"],f1,f2],

    ["zfcg_zhaobiao_gg","https://www.ynggzyxx.gov.cn/jyxx/zfcg/cggg",[ "name", "href", "ggstart_time", "info"],f1,f2],

    ["zfcg_gqita_da_bian_gg","https://www.ynggzyxx.gov.cn/jyxx/zfcg/gzsx",[ "name", "href", "ggstart_time", "info"],f1,f2],

    ["zfcg_zhongbiaohx_gg","https://www.ynggzyxx.gov.cn/jyxx/zfcg/zbjggs",["name", "href", "ggstart_time", "info"],f1,f2],

    ["zfcg_liubiao_gg","https://www.ynggzyxx.gov.cn/jyxx/zfcg/zfcgYcgg",["name", "href", "ggstart_time", "info"],f1,f2],
