...
class itkHessian3DToVesselnessMeasureImageFilterF(itkImageToImageFilterBPython.itkImageToImageFilterISSRTD33IF3):
    ...
    Shigeyuki Yoshida, Ron Kikinis. http://www.spl.harvard.edu/archive
    /spl-pre2007/pages/papers/yoshi/
...
def itkHessian3DToVesselnessMeasureImageFilterF_cast(obj):
...
def itkHessian3DToVesselnessMeasureImageFilterSS___New_orig__():
    """itkHessian3DToVesselnessMeasureImageFilterSS___New_orig__() -> itkHessian3DToVesselnessMeasureImageFilterSS_Pointer"""
    return _itkHessian3DToVesselnessMeasureImageFilterPython.itkHessian3DToVesselnessMeasureImageFilterSS___New_orig__()

def itkHessian3DToVesselnessMeasureImageFilterSS_cast(obj):
...
def itkHessian3DToVesselnessMeasureImageFilterUC_cast(obj):
...
def itkHessian3DToVesselnessMeasureImageFilterUS_cast(obj):
