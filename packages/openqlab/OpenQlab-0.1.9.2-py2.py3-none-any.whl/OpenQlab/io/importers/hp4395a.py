    ...
    def read(self):
        ...
        while line:
            ...
            if line.startswith('"NUMBER of POINTS'):
                ...
                #       position here.
                channels.append(pd.read_csv(self._stream, index_col=0, nrows=points, sep='\t',
                                            names=['Frequency (Hz)',
                                                   f'{prefix}_DataReal',
                                                   f'{prefix}_DataImag',
                                                   f'{prefix}_MemReal',
        ...
        if data.empty:
            raise EmptyDataError(f'{self.NAME} importer: no data found in file {self._stream.name}')
