...
class CifsShareAclSchema(ResourceSchema):
 ...
 """
    permission = fields.Str(validate=enum_validation(['no_access', 'read', 'change', 'full_control']))
...
* change
* full_control """
    type = fields.Str(validate=enum_validation(['windows', 'unix_user', 'unix_group']))
...
class CifsShareAcl(Resource):
 ...
 """
    ...
    get_collection.__func__.__doc__ = r"""Retrieves the share-level ACL on a CIFS share.
...
"""
    ...
    patch_collection.__func__.__doc__ = r"""Updates a share-level ACL on a CIFS share.
### Related ONTAP commands
...
"""
    ...
    delete_collection.__func__.__doc__ = r"""Deletes a share-level ACL on a CIFS share.
### Related ONTAP commands
...
"""
    ...
    find.__func__.__doc__ = r"""Retrieves the share-level ACL on a CIFS share.
### Related ONTAP commands
* `vserver cifs share access-control show`
### Learn more
* [`DOC /protocols/cifs/shares/{svm.uuid}/{share}/acls`](#docs-NAS-protocols_cifs_shares_{svm.uuid}_{share}_acls)
"""
    ...
    get.__doc__ = r"""Retrieves the share-level ACL on CIFS share for a specified user or group.
### Related ONTAP commands
* `vserver cifs share access-control show`
### Learn more
* [`DOC /protocols/cifs/shares/{svm.uuid}/{share}/acls`](#docs-NAS-protocols_cifs_shares_{svm.uuid}_{share}_acls)
"""
    ...
    post.__doc__ = r"""Creates a share-level ACL on a CIFS share.
### Required properties
...
"""
    ...
    patch.__doc__ = r"""Updates a share-level ACL on a CIFS share.
### Related ONTAP commands
* `vserver cifs share access-control modify`
### Learn more
* [`DOC /protocols/cifs/shares/{svm.uuid}/{share}/acls`](#docs-NAS-protocols_cifs_shares_{svm.uuid}_{share}_acls)
"""
    ...
    delete.__doc__ = r"""Deletes a share-level ACL on a CIFS share.
### Related ONTAP commands
* `vserver cifs share access-control delete`
### Learn more
* [`DOC /protocols/cifs/shares/{svm.uuid}/{share}/acls`](#docs-NAS-protocols_cifs_shares_{svm.uuid}_{share}_acls)
