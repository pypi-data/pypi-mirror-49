...
def f3(driver, url):
    ...
    try:
        locator = (By.XPATH, "//div[@class='notice'][string-length()>100] | //div[@class='Main-p floatL']//img | //div[@class='content-Border floatL']//img")
...
if __name__=='__main__':
    ...
    #         print(d)
    # driver = webdriver.Chrome()
    # df = f3(driver, ' http://www.jhztb.gov.cn/platform/project/notice/notice.jsp?id=d797ae09efcca4bb75c5e40e27aa13ae')
    # print(df)
