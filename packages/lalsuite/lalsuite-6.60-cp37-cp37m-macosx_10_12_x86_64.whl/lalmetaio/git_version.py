...
id = "413788d4afeff8b759d8d75abe589ae4a846120c"
date = "2019-07-12 19:13:12 +0000"
branch = "None"
tag = "lalsuite-v6.60"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "413788d4afeff8b759d8d75abe589ae4a846120c":
        return
    msg = "Program id (413788d4afeff8b759d8d75abe589ae4a846120c) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
