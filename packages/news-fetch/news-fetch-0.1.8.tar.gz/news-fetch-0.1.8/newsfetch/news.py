    ...
    def __init__(self, url):
        ...
        try:
            if cleaning_text(' '.join(article.text.split())) != None:
                self.cleaned_article = spacy_tokenizer(' '.join(cleaning_text(' '.join(article.text.split())).split()))
            elif cleaning_text(' '.join(newsplease.text.split())) != None:
                self.cleaned_article = spacy_tokenizer(' '.join(cleaning_text(' '.join(newsplease.text.split())).split()))
            else:
        ...
        try:
            if cleaning_text(' '.join(article.text.split())) != None:
                self.article = ' '.join(cleaning_text(' '.join(article.text.split())).split())
            elif cleaning_text(' '.join(newsplease.text.split())) != None:
                self.article = ' '.join(cleaning_text(' '.join(newsplease.text.split())).split())
            else:
                self.article = 'N/A'
        except:
            self.article = 'N/A'
