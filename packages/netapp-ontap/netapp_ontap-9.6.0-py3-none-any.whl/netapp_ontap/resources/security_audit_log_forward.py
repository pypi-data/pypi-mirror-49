...
class SecurityAuditLogForwardSchema(ResourceSchema):
 ...
 """
    facility = fields.Str(validate=enum_validation(['kern', 'user', 'local0', 'local1', 'local2', 'local3', 'local4', 'local5', 'local6', 'local7']))
...
For encrypted destinations the default port is 6514. """
    protocol = fields.Str(validate=enum_validation(['udp_unencrypted', 'tcp_unencrypted', 'tcp_encrypted']))
...
class SecurityAuditLogForward(Resource):
    ...
    get_collection.__func__.__doc__ = r"""Defines remote syslog/splunk server for sending audit information
### Learn more
* [`DOC /security/audit/destinations`](#docs-security-security_audit_destinations)"""
    ...
    patch_collection.__func__.__doc__ = r"""Updates remote syslog/splunk server information.
### Learn more
* [`DOC /security/audit/destinations`](#docs-security-security_audit_destinations)"""
    ...
    delete_collection.__func__.__doc__ = r"""Deletes remote syslog/splunk server information.
### Learn more
* [`DOC /security/audit/destinations`](#docs-security-security_audit_destinations)"""
    ...
    find.__func__.__doc__ = r"""Defines remote syslog/splunk server for sending audit information
### Learn more
* [`DOC /security/audit/destinations`](#docs-security-security_audit_destinations)"""
    ...
    get.__doc__ = r"""Defines remote syslog/splunk server for sending audit information.
### Learn more
* [`DOC /security/audit/destinations`](#docs-security-security_audit_destinations)"""
    ...
    post.__doc__ = r"""Configures remote syslog/splunk server information.
### Required properties
All of the following fields are required for creating a remote syslog/splunk destination
* `address`
### Optional properties
...
* [`DOC /security/audit/destinations`](#docs-security-security_audit_destinations)"""
    ...
    patch.__doc__ = r"""Updates remote syslog/splunk server information.
### Learn more
* [`DOC /security/audit/destinations`](#docs-security-security_audit_destinations)"""
    ...
    delete.__doc__ = r"""Deletes remote syslog/splunk server information.
### Learn more
* [`DOC /security/audit/destinations`](#docs-security-security_audit_destinations)"""
