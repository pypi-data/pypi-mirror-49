...
def get_data():
    ...
    sitewebId = OrderedDict([
        ("江门市",
         "4028889705bebb510105becf79c2000a,297e6a6a49176e840149181c4a690e6b,297e6a6a49176e840149181b845d0e6a,297e6a6a49176e840149181ab2dc0e69,297e6a6a49176e8401491819ec060e68,297e6a6a49176e84014918191c880e67,297e6a6a49176e8401491818512e0e66,297e6a6a49176e840149181771e80e65"),
    ])

    regionIds = OrderedDict([("江门市", "0113")])
...
def work(conp, **args):
    est_meta_large(conp, data=data, diqu="广东省江门市", **args)
...
if __name__ == '__main__':
    work(conp=["postgres", "since2015", "192.168.3.171", "guoziqiang", "jiangmen"],pageloadtimeout=120,interval_page=10)
