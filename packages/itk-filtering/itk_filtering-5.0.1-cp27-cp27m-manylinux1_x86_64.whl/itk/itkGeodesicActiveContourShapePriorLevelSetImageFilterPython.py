...
def itkGeodesicActiveContourShapePriorLevelSetImageFilterIF2IF2F___New_orig__():
...
def itkGeodesicActiveContourShapePriorLevelSetImageFilterIF2IF2F_cast(obj):
...
def itkGeodesicActiveContourShapePriorLevelSetImageFilterIF3IF3F___New_orig__():
...
def itkGeodesicActiveContourShapePriorLevelSetImageFilterIF3IF3F_cast(obj):
