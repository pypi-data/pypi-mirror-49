...
def f3(driver, url):
    driver.get(url)
    if 'indexmc_two.htm' in url:
        locator = (By.XPATH, "//div[@id='vsb_content'][string-length()>100]")
...
if __name__ == '__main__':
    work(conp=["postgres", "since2015", "192.168.3.171", "zlest", "ggzy_hubei_macheng"])
    ...
    #         print(d)
    # driver = webdriver.Chrome()
    # d = f3(driver, 'http://www.ggzymc.cn/ceinwz/Hyzq/HyWsdyMutilDetail.aspx?sgzbbm=MCCG-2019-40&kind=buyi')
    # print(d)
