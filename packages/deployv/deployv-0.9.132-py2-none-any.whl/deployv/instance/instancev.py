...
class InstanceV(DockerV):
    ...
    def restore_database(self, db_name=False, backup_dir=False):
        ...
        # TODO: This method has too many return statements, to avoid lint errors, this was
        # commented but should be re-applied when we enable the `keep_db` feature again.
        # the `keep_db` feature has been temprarily disabled.
    ...
    def generate_backup(self, params):
        ...
        tmp_dir = params.get('temp_folder') or self.__full_config.temp_folder or gettempdir()
        ...
        try:
            files = self.files2backup(db_name, tmp_dir, params.get('data_dir'))
