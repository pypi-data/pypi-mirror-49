...
class Use(unit_decl1): # Constructor
    ...
    def __init__(self, module=None, symbols=[], lineno=1, col_offset=1):
        self.module = module
        checkinstance(module, use_symbol, False)
...
class Stop(stmt): # Constructor
    ...
    def __init__(self, code=0, lineno=1, col_offset=1):
        self.code = code
...
class DoLoop(stmt): # Constructor
    ...
    def __init__(self, head=None, body=[], lineno=1, col_offset=1):
        self.head = head
...
class Select(stmt): # Constructor
    ...
    def __init__(self, test=None, body=[], default=None, lineno=1, col_offset=1):
        self.test = test
        checkinstance(test, expr, False)
        self.body = body
        assert isinstance(body, list)
...
class decl(AST): # Product
    ...
    def __init__(self, sym=None, sym_type=None, dims=[], attrs=[]):
        self.sym = sym
        ...
        self._fields = ('sym', 'sym_type', 'dims', 'attrs')
        self._type = None
...
class do_loop_head(AST): # Product
    ...
    def __init__(self, var=None, start=None, end=None, increment=None):
        self.var = var
        checkinstance(var, str, False)
        self.start = start
        ...
        self._fields = ('var', 'start', 'end', 'increment')
        self._type = None
...
class NodeTransformerBase(ASTVisitor):
    ...
    def visit_decl(self, node):
        ...
        return decl(sym=sym, sym_type=sym_type, dims=dims, attrs=attrs)
    ...
    def visit_do_loop_head(self, node):
        ...
        if node.increment:
            ...
            increment = None
        return do_loop_head(var=var, start=start, end=end, increment=increment)
    ...
    def visit_use_symbol(self, node):
        ...
        return use_symbol(sym=sym, rename=rename)
