...
let RemoteMachineTrainingService = class RemoteMachineTrainingService {
    ...
    async generateGpuMetricsCollectorScript(userName) {
        ...
        const gpuMetricsCollectorScriptContent = typescript_string_operations_1.String.Format(remoteMachineData_1.GPU_COLLECTOR_FORMAT, remoteGPUScriptsDir, path.join(remoteGPUScriptsDir, 'pid'));
