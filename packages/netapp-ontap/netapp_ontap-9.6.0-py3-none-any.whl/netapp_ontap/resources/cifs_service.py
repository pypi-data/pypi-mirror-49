...
class CifsServiceSchema(ResourceSchema):
 ...
 """
    ad_domain = fields.Nested("AdDomainSchema", unknown=EXCLUDE)
    r""" The ad_domain field of the cifs_service.
 """
    comment = fields.Str(validate=len_validation(minimum=0, maximum=48))
...
Example: This CIFS Server Belongs to CS Department """
 ...
 """
    name = fields.Str(validate=len_validation(minimum=1, maximum=15))
    r""" The name of the CIFS server.

Example: CIFS1 """
    netbios = fields.Nested("CifsNetbiosSchema", unknown=EXCLUDE)
    r""" The netbios field of the cifs_service.
 """
    security = fields.Nested("CifsServiceSecuritySchema", unknown=EXCLUDE)
...
class CifsService(Resource):
    ...
    get_collection.__func__.__doc__ = r"""Retrieves CIFS servers.
...
"""
    ...
    patch_collection.__func__.__doc__ = r"""Updates both the mandatory and optional parameters of the CIFS configuration. Ensure the CIFS server is administratively disabled when renaming the CIFS server or modifying the <i>ad_domain</i> properties.
### Related ONTAP commands
...
"""
    ...
    delete_collection.__func__.__doc__ = r"""Deletes a CIFS server and related CIFS configurations.
### Related ONTAP commands
...
"""
    ...
    find.__func__.__doc__ = r"""Retrieves CIFS servers.
### Related ONTAP commands
* `vserver cifs server show`
* `vserver cifs server options show`
* `vserver cifs server security show`
...
"""
    ...
    get.__doc__ = r"""Retrieves a CIFS server.
### Related ONTAP commands
* `vserver cifs server show`
* `vserver cifs server options show`
* `vserver cifs server security show`
...
"""
    ...
    post.__doc__ = r"""Creates a CIFS server. Each SVM can have one CIFS server.</br>
### Important notes
- The CIFS server name might or might not be the same as the SVM name.
...
"""
    ...
    patch.__doc__ = r"""Updates both the mandatory and optional parameters of the CIFS configuration. Ensure the CIFS server is administratively disabled when renaming the CIFS server or modifying the <i>ad_domain</i> properties.
### Related ONTAP commands
* `vserver cifs server modify`
* `vserver cifs server options modify`
* `vserver cifs security modify`
...
"""
    ...
    delete.__doc__ = r"""Deletes a CIFS server and related CIFS configurations.
### Related ONTAP commands
* `vserver cifs server delete`
* `vserver cifs remove-netbios-aliases`
### Learn more
