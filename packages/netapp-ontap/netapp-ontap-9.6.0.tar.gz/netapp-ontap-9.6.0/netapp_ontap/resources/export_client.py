...
class ExportClient(Resource):
    ...
    get_collection.__func__.__doc__ = r"""Retrieves export policy rule clients.
### Learn more
...
"""
    ...
    delete_collection.__func__.__doc__ = r"""Deletes an export policy client
...
"""
    ...
    find.__func__.__doc__ = r"""Retrieves export policy rule clients.
### Learn more
* [`DOC /protocols/nfs/export-policies`](#docs-NAS-protocols_nfs_export-policies)
"""
    ...
    post.__doc__ = r"""Creates an export policy rule client
### Required properties
...
"""
    ...
    delete.__doc__ = r"""Deletes an export policy client
### Related ONTAP commands
* `vserver export-policy rule remove-clientmatches`
### Learn more
* [`DOC /protocols/nfs/export-policies`](#docs-NAS-protocols_nfs_export-policies)
