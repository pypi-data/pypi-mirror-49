...
# -*- coding: utf-8 -*-
#
# apisoptimizer/colony.py
# v.1.0.0
# Developed in 2019 by Travis Kessler <travis.j.kessler@gmail.com>
#
# Contains the Colony object
#
...
from apisoptimizer.utils import apply_mutation, call_obj_fn, choose_bee,\
    determine_best_bee
...
class Colony:
    ...
    def __init__(self, num_employers: int,
                 ...
                 num_processes: int=1):
        ''' Colony object: optimizes hyper-parameters for user-supplied function
    ...
    def add_param(self, min_val: Union[int, float], max_val: Union[int, float],
                  restrict: bool=True):
        ''' Colony.add_param: adds a parameter to be processed by the user-
    ...
    def initialize(self):
        ''' Colony.initialize: creates `num_employers` employer bees and
    ...
    def search(self):
        ''' Colony.search: performs one "search cycle" for all bees in the
