...
try:
    from h2o4gpu.externals.joblib.externals import cloudpickle  # noqa: F401
...
def set_loky_pickler(loky_pickler=None):
    ...
    if loky_pickler == "cloudpickle":
        from h2o4gpu.externals.joblib.externals.cloudpickle import CloudPickler as loky_pickler_cls
    else:
        try:
