...
class itkImageToImageMetricIF2IF2(ITKCostFunctionsPython.itkSingleValuedCostFunction):
    ...
    def SetUseFixedImageIndexes(self, useIndex):
    ...
    def SetUseSequentialSampling(self, sequentialSampling):
        """
...
def itkImageToImageMetricIF2IF2_cast(obj):
...
def itkImageToImageMetricIF3IF3_cast(obj):
...
def itkImageToImageMetricISS2ISS2_cast(obj):
...
def itkImageToImageMetricISS3ISS3_cast(obj):
...
def itkImageToImageMetricIUC2IUC2_cast(obj):
...
def itkImageToImageMetricIUC3IUC3_cast(obj):
...
def itkImageToImageMetricIUS2IUS2_cast(obj):
...
def itkImageToImageMetricIUS3IUS3_cast(obj):
