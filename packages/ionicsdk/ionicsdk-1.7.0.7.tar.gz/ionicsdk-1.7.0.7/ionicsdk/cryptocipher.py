...
class CryptoCipherBase(object):
    ...
    def encryptstr(self, plaintext):
        ...
        try:
            ...
            raise IonicException("Could not encrypt string", e.code)
    ...
    def encryptbytes(self, plaintextbytes):
        ...
        try:
            ...
            raise IonicException("Could not encrypt bytes", e.code)
    ...
    def decryptstr(self, ciphertext):
        ...
        try:
            ...
            raise IonicException("Could not decrypt string", e.code)
    ...
    def decryptbytes(self, ciphertext):
        ...
        try:
            ...
            raise IonicException("Could not decrypt bytes", e.code)
