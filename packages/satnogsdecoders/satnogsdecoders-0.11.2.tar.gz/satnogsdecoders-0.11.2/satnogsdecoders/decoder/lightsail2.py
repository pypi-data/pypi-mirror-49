...
class Lightsail2(KaitaiStruct):
    ...
    class LsbBeacondataT(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.sol_nxx = self._io.read_s2be()
            self.sol_nxy = self._io.read_s2be()
            self.sol_nyx = self._io.read_s2be()
            self.sol_nyy = self._io.read_s2be()
            self.sol_nzx = self._io.read_s2be()
            self.sol_nzy = self._io.read_s2be()
            self.sol_pxx = self._io.read_s2be()
            self.sol_pxy = self._io.read_s2be()
            self.sol_pyx = self._io.read_s2be()
            self.sol_pyy = self._io.read_s2be()
