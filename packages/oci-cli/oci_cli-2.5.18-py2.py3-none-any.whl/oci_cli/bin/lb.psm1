...
function GetOciSubcommands_lb() {
    $ociSubcommands = @{
        'lb' = 'backend backend-health backend-set backend-set-health certificate health-checker hostname listener load-balancer load-balancer-health nsg path-route-set policy protocol rule-set shape work-request'
...
function GetOciCommandsToLongParams_lb() {
    $ociCommandsToLongParams = @{
        ...
        'lb load-balancer create' = 'backend-sets certificates compartment-id defined-tags display-name freeform-tags from-json help hostnames is-private listeners max-wait-seconds nsg-ids path-route-sets rule-sets shape-name subnet-ids wait-for-state wait-interval-seconds'
