...
def as_escaped_unicode_literal(
    ...
    Example:
        >>> from flutils import as_escaped_unicode_literal
        >>> t = '1.★ 🛑'
        >>> as_literal(t)
...
def as_escaped_utf8_literal(
    ...
    Example:
        >>> from flutils import as_literal_utf8
        >>> t = '1.★ 🛑'
...
def convert_escaped_unicode_literal(
    ...
    Examples:
        ...
        Basic usage::
            ...
            >>> from flutils import convert_escaped_unicode_literal
...
def convert_escaped_utf8_literal(
    ...
    Examples:
        ...
        Basic usage:
            ...
            >>> from flutils import convert_raw_utf8_escape
            >>> a = 'test\\\\xc2\\\\xa9'
        ...
        ::
            ...
            'test©'
    """
    from flutils import register_codecs
    register_codecs()
