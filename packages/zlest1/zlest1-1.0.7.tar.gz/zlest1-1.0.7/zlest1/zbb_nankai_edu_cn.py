...
data = [
    ...
    ["qy_zhaobiao_gg", "http://zbb.nankai.edu.cn/sfw_cms/e?page=cms.psms.gglist&typeDetail=A",
     ["name", "ggstart_time", "href", "info"], f1, f2],
    ["qy_zhongbiao_gg", "http://zbb.nankai.edu.cn/sfw_cms/e?page=cms.psms.gglist&typeDetail=B",
     ["name", "ggstart_time", "href", "info"], f1, f2],
