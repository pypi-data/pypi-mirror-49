...
def itkMattesMutualInformationImageToImageMetricIF2IF2_cast(obj):
...
def itkMattesMutualInformationImageToImageMetricIF3IF3_cast(obj):
...
def itkMattesMutualInformationImageToImageMetricISS2ISS2___New_orig__():
...
def itkMattesMutualInformationImageToImageMetricISS2ISS2_cast(obj):
...
def itkMattesMutualInformationImageToImageMetricISS3ISS3___New_orig__():
...
def itkMattesMutualInformationImageToImageMetricISS3ISS3_cast(obj):
...
def itkMattesMutualInformationImageToImageMetricIUC2IUC2_cast(obj):
...
def itkMattesMutualInformationImageToImageMetricIUC3IUC3_cast(obj):
...
def itkMattesMutualInformationImageToImageMetricIUS2IUS2_cast(obj):
...
def itkMattesMutualInformationImageToImageMetricIUS3IUS3_cast(obj):
