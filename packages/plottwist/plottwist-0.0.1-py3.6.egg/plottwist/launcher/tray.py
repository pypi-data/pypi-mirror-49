...
"""
Module that contains implementation for Plot Twist Artella tray
"""
...
class PlotTwistTray(tray.ArtellaTray, object):
    def __init__(self, project, parent=None):
        super(PlotTwistTray, self).__init__(project=project, parent=parent)
    ...
    def create_menu(self):
        ...
        documentation_icon = plottwist.resource.icon('documentation')
        project_icon = plottwist.resource.icon('plottwist', theme=None)
        artella_icon = plottwist.resource.icon('artella')
        email_icon = plottwist.resource.icon('message')
        kitsu_icon = plottwist.resource.icon('kitsu')
        drive_icon = plottwist.resource.icon('drive')
