...
class VehicleClient:
    ...
    def simLoadLevel(self, level_name):
        if level_name not in ['Soccer_Field_Easy', 'Soccer_Field_Medium', 'ZhangJiaJie_Medium', 'Building99_Hard']:
            raise ValueError("Allowed level names are:  \'Soccer_Field_Easy\', \'Soccer_Field_Medium\', \'ZhangJiaJie_Medium\', \'Building99_Hard\', or \'MainMenu\'")
