...
## Overview
A world wide port name (WWPN) is a unique 64-bit identifier for a Fibre Channel (FC) initiator. It is displayed as a 16-character hexadecimal value. SAN administrators may find it easier to identify FC initiators using an alias, especially in larger SANs.<br/>
...
class WwpnAlias(Resource):
 ...
 """
    ...
    get_collection.__func__.__doc__ = r"""Retrieves FC WWPN aliases.
...
"""
    ...
    delete_collection.__func__.__doc__ = r"""Deletes an FC WWPN alias.
### Related ONTAP commands
...
"""
    ...
    find.__func__.__doc__ = r"""Retrieves FC WWPN aliases.
### Related ONTAP commands
* `vserver fcp wwpn-alias show`
### Learn more
* [`DOC /network/fc/wwpn-aliases`](#docs-SAN-network_fc_wwpn-aliases)
"""
    ...
    get.__doc__ = r"""Retrieves an FC WWPN alias.
### Related ONTAP commands
* `vserver fcp wwpn-alias show`
### Learn more
* [`DOC /network/fc/wwpn-aliases`](#docs-SAN-network_fc_wwpn-aliases)
"""
    ...
    post.__doc__ = r"""Creates an FC WWPN alias.
### Required properties
...
"""
    ...
    delete.__doc__ = r"""Deletes an FC WWPN alias.
### Related ONTAP commands
* `vserver fcp wwpn-alias remove`
### Learn more
* [`DOC /network/fc/wwpn-aliases`](#docs-SAN-network_fc_wwpn-aliases)
