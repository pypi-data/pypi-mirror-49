...
class Ipspace(Resource):
    ...
    get_collection.__func__.__doc__ = r"""Retrieves a collection of IPspaces for the entire cluster.
...
* [`DOC /network/ipspaces`](#docs-networking-network_ipspaces)"""
    ...
    patch_collection.__func__.__doc__ = r"""Updates an IPspace object.
### Related ONTAP commands
...
* [`DOC /network/ipspaces`](#docs-networking-network_ipspaces)"""
    ...
    delete_collection.__func__.__doc__ = r"""Deletes an IPspace object.
### Related ONTAP commands
...
* [`DOC /network/ipspaces`](#docs-networking-network_ipspaces)"""
    ...
    find.__func__.__doc__ = r"""Retrieves a collection of IPspaces for the entire cluster.
### Related ONTAP commands
* `network ipspace show`
...
* [`DOC /network/ipspaces`](#docs-networking-network_ipspaces)"""
    ...
    get.__doc__ = r"""Retrieves information about a specific IPspace.
### Related ONTAP commands
* `network ipspace show`
...
* [`DOC /network/ipspaces`](#docs-networking-network_ipspaces)"""
    ...
    post.__doc__ = r"""Creates a new domain within which IP addresses are unique. SVMs, ports, and networks are scoped within a single IPspace.
### Required properties
...
* [`DOC /network/ipspaces`](#docs-networking-network_ipspaces)"""
    ...
    patch.__doc__ = r"""Updates an IPspace object.
### Related ONTAP commands
* `network ipspace rename`
...
* [`DOC /network/ipspaces`](#docs-networking-network_ipspaces)"""
    ...
    delete.__doc__ = r"""Deletes an IPspace object.
### Related ONTAP commands
* `network ipspace delete`
