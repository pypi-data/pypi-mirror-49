...
class IscsiCredentialsSchema(ResourceSchema):
 ...
 """
    authentication_type = fields.Str(validate=enum_validation(['chap', 'none', 'deny']))
...
* none
* deny """
    chap = fields.Nested("IscsiCredentialsChapSchema", unknown=EXCLUDE)
...
Example: iqn.1998-01.com.corp.iscsi:name1 """
    initiator_address = fields.Nested("IscsiCredentialsInitiatorAddressSchema", unknown=EXCLUDE)
...
class IscsiCredentials(Resource):
    ...
    get_collection.__func__.__doc__ = r"""Retrieves iSCSI credentials.
...
"""
    ...
    patch_collection.__func__.__doc__ = r"""Updates specified iSCSI credentials.
### Related ONTAP commands
...
"""
    ...
    delete_collection.__func__.__doc__ = r"""Deletes specified iSCSI credentials.
### Related ONTAP commands
...
"""
    ...
    find.__func__.__doc__ = r"""Retrieves iSCSI credentials.
### Related ONTAP commands
* `vserver iscsi security show`
### Learn more
* [`DOC /protocols/san/iscsi/credentials`](#docs-SAN-protocols_san_iscsi_credentials)
"""
    ...
    get.__doc__ = r"""Retrieves specified iSCSI credentials.
### Related ONTAP commands
* `vserver iscsi security show`
### Learn more
* [`DOC /protocols/san/iscsi/credentials`](#docs-SAN-protocols_san_iscsi_credentials)
"""
    ...
    post.__doc__ = r"""Creates iSCSI credentials.
### Required properties
...
"""
    ...
    patch.__doc__ = r"""Updates specified iSCSI credentials.
### Related ONTAP commands
* `vserver iscsi security add-initiator-address-ranges`
* `vserver iscsi security default`
* `vserver iscsi security modify`
...
"""
    ...
    delete.__doc__ = r"""Deletes specified iSCSI credentials.
### Related ONTAP commands
* `vserver iscsi security delete`
### Learn more
* [`DOC /protocols/san/iscsi/credentials`](#docs-SAN-protocols_san_iscsi_credentials)
