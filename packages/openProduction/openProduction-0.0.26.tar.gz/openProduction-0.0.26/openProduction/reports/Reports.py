...
class Report:
    ...
    def getDeviceResults(self, productName, productVersion, stationName, deviceID=None, resultKeys=None, onlyGood=True, onlyNewest=False):
        ...
        if type(p) != type(None): 
            if deviceID != None and onlyNewest == True:
                p = p[p['date'] == (p[p['deviceID'] == deviceID]["date"].max())]
        return p
