...
def batch_test(
        ...
        names: Optional[Tuple[str, ...]] = ('money', 'phone', 'idcard'),
...
if __name__ == '__main__':
    ...
    file = '/Users/yutou/shouxin/sxProject/pysubway/pysubway/gitignore/jt_qjl.csv'
    output = '/Users/yutou/shouxin/sxProject/pysubway/pysubway/gitignore/jt_qjl_result.xlsx'
    # 有表头
    batch_test(file,
               BOOLDATA_ACCOUNT,
               output,
