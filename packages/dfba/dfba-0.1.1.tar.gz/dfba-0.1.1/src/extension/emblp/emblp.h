...
public:
    ...
    ///--------------------------
    ///Constructor
    EMBLP_MODEL(glp_prob *, glp_smcp, UserData);
    ///Updating model data
...
public:
    ...
    ///----------------------------------
    ///Constructor
    EMBLP_DIRECT(glp_prob *, glp_smcp, UserData);
    ///Updating model data
...
public:
    ...
    ///-----------------------------------
    ///Constructor
    EMBLP_HARWOOD(glp_prob *, glp_smcp, UserData);
    ///Updating model data
...
public:
    ...
    ///---------------------------------
    ///Constructor
    EMBLP_SCOTT(glp_prob *, glp_smcp, UserData);
    ///Algorithm
    int initialize();
    ///IDA
