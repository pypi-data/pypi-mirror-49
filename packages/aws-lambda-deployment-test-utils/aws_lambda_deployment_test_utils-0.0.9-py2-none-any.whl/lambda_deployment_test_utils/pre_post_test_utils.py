...
import os
import pprint
from typing import Callable, MutableMapping, Sequence, Type, Mapping, Any
...
def handler_factory(test_group: str, modules: Sequence[str])->Callable[[StringKeyedMapping,StringKeyedMapping],StringKeyedMapping]:
