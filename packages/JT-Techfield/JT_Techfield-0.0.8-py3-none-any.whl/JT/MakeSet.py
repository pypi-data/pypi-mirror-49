...
def TriCluster(num = 6000, scale = 1, skew = False):
	x1 = np.random.randn(num // 3, 2) * scale @ (np.random.randn(2, 2) ** skew) + np.array([[0, -6]])
	x2 = np.random.randn(num // 3, 2) * scale @ (np.random.randn(2, 2) ** skew) + np.array([[8, 0]])
	x3 = np.random.randn(num // 3, 2) * scale @ (np.random.randn(2, 2) ** skew) + np.array([[0, 6]])
