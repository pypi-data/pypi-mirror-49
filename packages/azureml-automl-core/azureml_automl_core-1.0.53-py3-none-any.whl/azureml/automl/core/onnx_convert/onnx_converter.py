...
class OnnxConverter:
    ...
    def initialize_with_metadata(self,
        ...
        if not self._is_initialized:
            try:
                ...
                self._logger_wrapper('error', evt_name=OnnxConvertConstants.EvtInitWithMetadata,
                                     status=OnnxConvertConstants.StatusError,
                                     model_name=model_name, model_desc=model_desc,
                                     message=err)
                self._logger_wrapper('warning', evt_name=OnnxConvertConstants.EvtInitWithMetadata,
                                     status=OnnxConvertConstants.StatusEndFailed,
                                     model_name=model_name, model_desc=model_desc,
    ...
    def convert(self, raw_model: Pipeline,
            ...
            -> Tuple[Optional[onnx_proto.ModelProto], Optional[Dict[str, Any]]]:
        """
