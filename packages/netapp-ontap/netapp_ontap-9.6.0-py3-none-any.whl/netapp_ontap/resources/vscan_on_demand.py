...
Example: task-1 """
    scan_paths = fields.List(fields.Str)
...
Example: ["/vol1/","/vol2/cifs/"] """
 ...
 """
    scope = fields.Nested("VscanOnDemandScopeSchema", unknown=EXCLUDE)
...
class VscanOnDemand(Resource):
 ...
 """
    ...
    get_collection.__func__.__doc__ = r"""Retrieves the Vscan On-Demand policy.
...
"""
    ...
    patch_collection.__func__.__doc__ = r"""Updates the Vscan On-Demand policy configuration of an SVM. Use schedule name or schedule UUID to schedule an On-Demand scan.
### Related ONTAP commands
...
"""
    ...
    delete_collection.__func__.__doc__ = r"""Deletes the Vscan On-Demand configuration.
### Related ONTAP commands
...
"""
    ...
    find.__func__.__doc__ = r"""Retrieves the Vscan On-Demand policy.
### Related ONTAP commands
* `vserver vscan on-demand-task show`
### Learn more
* [`DOC /protocols/vscan/{svm.uuid}/on-demand-policies`](#docs-NAS-protocols_vscan_{svm.uuid}_on-demand-policies)
"""
    ...
    get.__doc__ = r"""Retrieves the Vscan On-Demand configuration of an SVM.
### Related ONTAP commands
* `vserver vscan on-demand-task show`
### Learn more
* [`DOC /protocols/vscan/{svm.uuid}/on-demand-policies`](#docs-NAS-protocols_vscan_{svm.uuid}_on-demand-policies)
"""
    ...
    post.__doc__ = r"""Creates a Vscan On-Demand policy. Created only on a data SVM.
</br> Important notes:
...
"""
    ...
    patch.__doc__ = r"""Updates the Vscan On-Demand policy configuration of an SVM. Use schedule name or schedule UUID to schedule an On-Demand scan.
### Related ONTAP commands
* `vserver vscan on-demand-task modify`
* `vserver vscan on-demand-task schedule`
* `vserver vscan on-demand-task unschedule`
...
"""
    ...
    delete.__doc__ = r"""Deletes the Vscan On-Demand configuration.
### Related ONTAP commands
* `vserver vscan on-demand-task delete`
### Learn more
* [`DOC /protocols/vscan/{svm.uuid}/on-demand-policies`](#docs-NAS-protocols_vscan_{svm.uuid}_on-demand-policies)
