...
def itkFastMarchingUpwindGradientImageFilterBaseIF2IF2___New_orig__():
...
def itkFastMarchingUpwindGradientImageFilterBaseIF2IF2_cast(obj):
...
def itkFastMarchingUpwindGradientImageFilterBaseIF3IF3___New_orig__():
...
def itkFastMarchingUpwindGradientImageFilterBaseIF3IF3_cast(obj):
