...
def f3(driver, url):
    driver.get(url)
    locator = (By.XPATH, "//table[@class='s2'][string-length()>100]")
    ...
    div = soup.find('div', class_='tLayer-2')
    return div
...
if __name__ == '__main__':
    work(conp=["postgres", "since2015", "192.168.3.171", "zlest", "gcjs_yunnan_yunnan"])
