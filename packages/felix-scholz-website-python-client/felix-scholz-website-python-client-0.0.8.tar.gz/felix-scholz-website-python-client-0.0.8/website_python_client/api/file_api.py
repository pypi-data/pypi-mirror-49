...
class FileApi(Api):
    ...
    def show_or_create(self, post: File, sync: bool = False) \
            -> Union[Tuple[Union[File, List[File], dict], int, HTTPHeaderDict], AsyncResult]:
        try:
            return self.show(post, False, sync)
    ...
    def update_or_create(self, post: File, sync: bool = False) \
            -> Union[Tuple[Union[File, List[File], dict], int, HTTPHeaderDict], AsyncResult]:
        try:
            return self.update(post, [], sync)
        except ApiNotFoundException:
            return self.create(post, sync)
