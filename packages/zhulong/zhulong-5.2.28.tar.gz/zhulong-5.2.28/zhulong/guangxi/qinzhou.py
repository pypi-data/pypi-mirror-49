...
def f1(driver,num):
    ...
    val = driver.find_element_by_xpath('//*[@id="MoreInfoList1_DataGrid1"]//tr[1]//a').get_attribute("href")[-40:]
    ...
    for content in content_list:
        ...
        url = "http://www.qzggzy.org.cn" + content.xpath("./td[2]/a/@href")[0]
...
data =[
    ...
    ["gcjs_biangeng_gg",
     ...
     ["name", "ggstart_time", "href", "info"], f1, f2],
    ["gcjs_kongzhijia_gg",
     "http://ggzyjy.qinzhou.gov.cn/gxqzzbw/jyxx/001001/001001004/MoreInfo.aspx?CategoryNum=001001004",
     ["name", "ggstart_time", "href", "info"], f1, f2],
    ["gcjs_zhongbiaohx_gg",
     "http://ggzyjy.qinzhou.gov.cn/gxqzzbw/jyxx/001001/001001005/MoreInfo.aspx?CategoryNum=001001005",
     ["name", "ggstart_time", "href", "info"], f1, f2],
    ["gcjs_zhongbiao_gg",
     "http://ggzyjy.qinzhou.gov.cn/gxqzzbw/jyxx/001001/001001006/MoreInfo.aspx?CategoryNum=001001006",
     ["name", "ggstart_time", "href", "info"], f1, f2],
    ...
    ["zfcg_biangeng_gg",
     ...
     ["name", "ggstart_time", "href", "info"], f1, f2],
    ["zfcg_zhongbiao_gg",
     "http://ggzyjy.qinzhou.gov.cn/gxqzzbw/jyxx/001004/001004004/MoreInfo.aspx?CategoryNum=001004004",
     ["name", "ggstart_time", "href", "info"], f1, f2],
...
def work(conp,**arg):
    est_meta(conp, data=data, diqu="广西省钦州市",**arg)
...
if __name__ == "__main__":
    ...
    conp=["postgres", "since2015", "192.168.3.171", "guangxi", "qinzhou"]
    import sys
    arg=sys.argv
    if len(arg) >3:
