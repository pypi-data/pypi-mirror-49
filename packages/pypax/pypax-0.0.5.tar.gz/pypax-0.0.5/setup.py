...
PACKAGE_NAME = "pypax"
PACKAGE_SRC = "src"
DESCRIPTION = "CLI tool to organize, version and manage repositories."
REPO = "https://github.com/GenvisAU/pypax"
...
copy_version_to_package(PACKAGE_SRC)
...
setuptools.setup(
    ...
    version=VERSION,
    url=REPO,
    packages=find_packages_under(PACKAGE_SRC),
