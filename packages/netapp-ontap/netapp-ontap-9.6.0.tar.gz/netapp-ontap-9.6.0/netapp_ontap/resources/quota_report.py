...
class QuotaReportSchema(ResourceSchema):
 ...
 """
    files = fields.Nested("QuotaReportFilesSchema", unknown=EXCLUDE)
    r""" The files field of the quota_report.
 """
    group = fields.Nested("QuotaReportGroupSchema", unknown=EXCLUDE)
 ...
 """
    space = fields.Nested("QuotaReportSpaceSchema", unknown=EXCLUDE)
...
class QuotaReport(Resource):
    ...
    get_collection.__func__.__doc__ = r"""Retrieves the quota report records for all FlexVols and FlexGroup volumes.
...
* [`DOC /storage/quota/reports`](#docs-storage-storage_quota_reports)"""
    ...
    find.__func__.__doc__ = r"""Retrieves the quota report records for all FlexVols and FlexGroup volumes.
### Related ONTAP commands
* `quota report`
...
* [`DOC /storage/quota/reports`](#docs-storage-storage_quota_reports)"""
    ...
    get.__doc__ = r"""Retrieves a specific quota report record.
### Related ONTAP commands
* `quota report`
