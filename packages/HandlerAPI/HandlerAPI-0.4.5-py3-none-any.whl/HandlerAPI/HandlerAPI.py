...
def countCommit(api_contributor):
    ...
    for i in range(len(api_contributor)):
        ...
        for j in range(len(api_contributor[i]['weeks'])):
            ...
            save = df_commit.to_csv(r'E:/TA/Hasil/Commit/Base/commit_week{counter}.csv'.format(counter = weeks), index = None, header= True)
...
def countLOC(api_contributor):
    ...
    for i in range(len(api_contributor)):
        ...
        for j in range(len(api_contributor[i]['weeks'])):
            ...
            save = df_loc.to_csv(r'E:/TA/Hasil/LOC/Base/LOC_week{counter}.csv'.format(counter = weeks), index = None, header= True)