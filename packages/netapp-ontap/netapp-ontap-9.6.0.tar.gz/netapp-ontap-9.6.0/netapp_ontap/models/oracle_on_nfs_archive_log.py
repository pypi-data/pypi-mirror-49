...
class OracleOnNfsArchiveLogSchema(ResourceSchema):
    ...
    size = fields.Integer()
    r""" The size of the archive log. Usage: {&lt;integer&gt;[KB|MB|GB|TB|PB]} Optional in the POST or PATCH body
 """
    storage_service = fields.Nested("OracleOnNfsArchiveLogStorageServiceSchema", unknown=EXCLUDE)
