...
class Proxy(proxy2.BaseProxy):
    ...
    #
    #     :param attrs: The attributes to create a ipsec policy.
    #     :return: :class:`~openstack.network.v2.vpn_service.IPSecPolicy`
    #     """
    ...
    #     """List ipsec policy.
    #
    #     :param attrs: The attributes to list ipsec policy.
    ...
    #     """Get a ipsec policy.
    #
    #     :param ipsec_policy: Id of ipsec policy.
    #     :param attrs: The attributes to get a ipsec policy.
    #     :return: :class:`~openstack.network.v2.vpn_service.IPSecPolicy`
    #     """
    ...
    #
    #     :param ipsec_policy: Id of ipsec policy.
    #     :param attrs: The attributes to update a ipsec policy.
    #     :return: :class:`~openstack.network.v2.vpn_service.IPSecPolicy`
    #     """
    ...
    #                 When set to ``True``, None will be returned when
    #                 attempting to find a nonexistent resource.
    #     :param attrs: The attributes to delete a ipsec policy.
    #     :return: None
    #     """
    ...
    #
    #     :param attrs: The attributes to create a ipsec policy.
    #     :return: :class:`~openstack.network.v2.vpn_service.IKEPolicy`
    #     """
    ...
    #     """Get a ike policy.
    #
    #     :param ike_policy: Id of ike policy.
    #     :param ignore_missing: When set to ``False``
    #                 :class:`~openstack.exceptions.ResourceNotFound` will be
    #                 raised when the resource does not exist.
    #                 When set to ``True``, None will be returned when
    ...
    #
    #     :param attrs: The attributes to create a endpoint group.
    #     :return: :class:`~openstack.network.v2.vpn_service.EndPointGroup`
    #     """
    ...
    #     """List endpoint group.
    #
    #     :param attrs: The attributes to list endpoint group.
    #     :return: A generator of endpoint group.
    #     """
    ...
    #
    #     :param endpoint_group: Id of endpoint group.
    #     :param attrs: The attributes to get a endpoint group.
    #     :return: :class:`~openstack.network.v2.vpn_service.EndPointGroup`
    #     """
    ...
    #
    #     :param endpoint_group: Id of endpoint group.
    #     :param attrs: The attributes to update a endpoint group.
    #     :return: :class:`~openstack.network.v2.vpn_service.EndPointGroup`
    #     """
    ...
    #     """Delete a endpoint group.
    #
    #     :param enpoint_group: Id of endpoint group.
    #     :param ignore_missing: When set to ``False``
    #                 :class:`~openstack.exceptions.ResourceNotFound` will be
    #                 raised when the resource does not exist.
    #                 When set to ``True``, None will be returned when
    #                 attempting to find a nonexistent resource.
    #     :param attrs: The attributes to delete a endpoint group.
    #     :return: None
    #     """
    ...
    #
    #     :param attrs: The attributes to delete a vpn connection.
    #     :return: :class:`~openstack.network.v2.vpn_service.VPNConnetion`
    #     """
    ...
    #     """List vpn connection.
    #
    #     :param attrs: The attributes to list vpn connection.
    #     :return: A generator of vpn connection.
    #     """
    ...
    #
    #     :param vpn_connection: Id of vpn connection.
    #     :param attrs: The attributes to get a vpn connection.
    #     :return: :class:`~openstack.network.v2.vpn_service.VPNConnetion`
    #     """
    ...
    #
    #     :param vpn_connection: Id of vpn connection.
    #     :param attrs: The attributes to update a vpn connection.
    #     :return:
    #     """
