...
Classes:\n
    ChunkCipherBase - Base class for all data chunk encryption decryption ciphers.\n
        ...
        ChunkCipherV4 - Cipher that supports version 4 data chunk
                        encryption / decryption.\n
    ChunkCipherDecryptAttributes - Allows for extended input and output
                                   options during decryption.\n
    ChunkCipherEncryptAttributes - Allows for extended input and output
                                   options during encryption.\n
    ChunkInfo - Data class used to describe attributes of a data chunk.\n
    ChunkCrypto - Holds utility functions to retrieve ChunkInfo from
                  protected data.
"""
...
class ChunkCipherEncryptAttributes(object):
    ...
    Instance Variables:\n
        ...
        cipheridOut (string): The data chunk cipher ID that the data was encrypted with.\n
        attributes (agent::KeyAttributesDict): The key attributes to
                            associate with data chunk protection key.\n
        metadata (agent::MetadataDict): The metadata properties to send
...
class ChunkCipherDecryptAttributes(object):
    ...
    Instance Variables:\n
        keyidOut (string): The key ID (also known as the key tag).\n
        cipheridOut (string): The data chunk cipher ID that the data was
                              decrypted with.\n
        attributesOut (agent::KeyAttributesDict): The key attributes
              that are associated with the key used to decrypt the data.\n
        mutableAttributesOut (agent::KeyAttributesDict): The mutable key attributes
              that are associated with the key used to decrypt the data.\n
        metadata (agent::MetadataDict): The metadata properties to send
                                        along with the HTTP request.\n
    """
