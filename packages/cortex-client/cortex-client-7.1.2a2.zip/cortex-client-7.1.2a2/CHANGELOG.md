...
## [7.1.2] - 2019-07-10
### Changed
* Bumped the default base image for actions to `c12e/cortex-python36:37d1432301a2`, which fixes the python 3.6 installation in the base continuumio/miniconda3:4.5.4 image
