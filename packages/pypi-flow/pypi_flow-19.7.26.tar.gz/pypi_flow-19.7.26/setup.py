...
# folder = os.path.dirname(__file__) + '\\cmdline'
folder = 'cmdline/' #PATHS CALCULATED IN SETUP.PY NEED UNIX STYLE PATH REFERENCES WITH DIFFERENT SLASHES
cmdLineScripts = [f'cmdline\\{file}' for file in filesInFolder(folder,"*")]
...
setuptools.setup(
    ...
    scripts=[f'cmdline\\{file}' for file in filesInFolder(folder,"*")],
