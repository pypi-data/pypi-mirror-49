        ...
        while self.run:
            ...
            try:
                ...
                if l_value > 0.4:
                    value = 1
                    if body["left"] != value:
                        data = {"node":"perception", "primitive":"bumpers", "input":"add", "robot":self.robot, "parameters":{"left":value}}
                ...
                if r_value > 0.4:
                    value = 1
                    if body["right"] != value:
                        data = {"node":"perception", "primitive":"bumpers", "input":"add", "robot":self.robot, "parameters":{"right":value}}
                        self.sharo.send_json(data)
                        body["right"] = value
                        print data
                ...
                if b_value > 0.4:
                    value = 1
                    if body["back"] != value:
                        data = {"node":"perception", "primitive":"bumpers", "input":"add", "robot":self.robot, "parameters":{"back":value}}
                        self.sharo.send_json(data)
                        body["back"] = value
                        print data
