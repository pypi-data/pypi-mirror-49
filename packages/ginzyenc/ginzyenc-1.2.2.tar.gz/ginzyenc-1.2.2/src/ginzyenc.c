...
static PyMethodDef GinzyencMethods[] = {
    {
...
static struct PyModuleDef ginzyencmodule = {
...
PyMODINIT_FUNC
PyInit_ginzyenc(void)
{
    return PyModule_Create(&ginzyencmodule);
}

/*void initginzyenc(void) {
    // Add module
    PyObject *module;
    module = Py_InitModule3("ginzyenc", funcs, "Raw yenc operations");

    // Add version
    PyModule_AddStringConstant(module, "__version__", GINZYENC_VERSION);
}*/
