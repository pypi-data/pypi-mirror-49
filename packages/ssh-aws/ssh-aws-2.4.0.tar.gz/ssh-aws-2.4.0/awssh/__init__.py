...
def create_parser():
    ...
    parser.add_argument('-co', '--console-output', help='Display the instance console out before logging in.',
                        action='store_true')
    parser.add_argument('--profile', help='Use a specific profile from your credentials file.', default='default')
    parser.add_argument('v', '--version', help='Returns awssh\'s version.', action='store_true')
    return parser
