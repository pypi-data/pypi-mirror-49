...
from .keyvault_utils import keyvault_client_auth, keyvault_importCertificate
import base64, sys
...
def generate_v3cert(asus_account, cert_name):
    ...
    with open('{}.pfx'.format( cert_name ), 'wb') as pfx_file:
...
def upload_v3cert_to_kv(pfx_certfile):
    ...
    ret = keyvault_importCertificate( client, b64cert )
