...
*   The :setting:`LOGSTATS_INTERVAL` setting is now documented (:issue:`3730`)
...
*   The
    ...
    methods are now documented (:issue:`2253`, :issue:`3609`)

*   The :meth:`Crawler.stop() <scrapy.crawler.Crawler.stop>` method is now
    documented (:issue:`3842`)

*   Some parts of the documentation that were confusing or misleading are now
    clearer (:issue:`1347`, :issue:`1789`, :issue:`2289`, :issue:`3615`,
    :issue:`3626`, :issue:`3670`, :issue:`3762`, :issue:`3861`)

*   ``docs/index.rst`` uses now the Scrapy description from ``README.rst``
    (:issue:`3673`)

*   The docstring of
    :meth:`~scrapy.spidermiddlewares.SpiderMiddleware.process_spider_exception`
    in projects created with :command:`startproject` no longer suggests invalid
    yield data types (:issue:`3728`)

*   References to the unexisting ``retry_complete`` signal are now gone from
    the documentation (:issue:`3069`, :issue:`3668`)

*   Fixed broken links (:issue:`3662`, :issue:`3767`)

*   Fixed typos (:issue:`3648`, :issue:`3674`, :issue:`3676`, :issue:`3694`,
    :issue:`3724`, :issue:`3764`, :issue:`3791`, :issue:`3797`, :issue:`3812`)

*   Italics are no longer used in the documentation where code formatting is
    desired (:issue:`3649`)

*   It is now possible to generate an API documentation coverage report
    (:issue:`3806`, :issue:`3810`, :issue:`3860`)

*   Fixed API double-indexing issues (:issue:`3806`)
...
*   Internal fixes and cleanup (:issue:`3629`, :issue:`3684`, :issue:`3698`,
    :issue:`3734`, :issue:`3735`, :issue:`3736`, :issue:`3737`, :issue:`3809`,
    :issue:`3821`, :issue:`3825`, :issue:`3827`, :issue:`3833`, :issue:`3857`)
