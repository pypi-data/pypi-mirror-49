...
@click.pass_context
@login_required
def datasets_push(ctx, dataset_path, message, name, update_version, quiet, background, watch, in_background):
    _datasets_push(ctx, dataset_path, message, name, update_version, quiet, background, watch, in_background)


def _datasets_push(ctx, dataset_path, message, name, update_version, quiet, background, watch, in_background):
    ...
    if dataset_path is None:
        ...
        identifier = DatasetIdentifier(dataset_path)
