...
def itkJointHistogramMutualInformationImageToImageMetricv4IF2IF2___New_orig__():
...
def itkJointHistogramMutualInformationImageToImageMetricv4IF2IF2_cast(obj):
...
def itkJointHistogramMutualInformationImageToImageMetricv4IF3IF3___New_orig__():
...
def itkJointHistogramMutualInformationImageToImageMetricv4IF3IF3_cast(obj):
