...
from core.endpoint.endpoint_resolver_base import EndpointResolverBase
from core.endpoint.location.DescribeEndpointsRequest import DescribeEndpointsRequest

DEFAULT_LOCATION_SERVICE_ENDPOINT = "ipaas.successchannel.tech"
