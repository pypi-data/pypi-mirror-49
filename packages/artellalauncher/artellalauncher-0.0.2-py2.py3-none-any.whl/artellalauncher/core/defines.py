...
# Defines the name of the attribute that defines file that updater should download
UPDATER_TOOLS_FILE_ATTRIBUTE_NAME = "TOOLS_FILE_NAME"
...
# Defines the name of the attribute that defines URL used by updateer
...
UPDATER_LAST_VERSION_JSON_FILE_NAME = "LAST_VERSION_JSON_FILE_NAME"
