...
data = [
    ["qy_zhaobiao_gg", "http://www.soeasyjc.com/newTender?infoType=1&submitByForm=Y", ["name", "ggstart_time", "href", "info"], f1, f2],
    ["qy_zhongbiao_gg", "http://www.soeasyjc.com/newTender?infoType=2&submitByForm=Y", ["name", "ggstart_time", "href", "info"], f1, f2],
    ["qy_zhongbiao_2_gg", "http://www.soeasyjc.com/newTender?infoType=3&submitByForm=Y", ["name", "ggstart_time", "href", "info"], f1, f2],
