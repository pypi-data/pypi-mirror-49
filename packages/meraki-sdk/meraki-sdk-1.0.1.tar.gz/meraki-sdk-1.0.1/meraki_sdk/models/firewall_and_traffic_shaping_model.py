...
import meraki_sdk.models.l3_firewall_rule_model
import meraki_sdk.models.l7_firewall_rule_model
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('l3FirewallRules') != None:
            ...
            for structure in dictionary.get('l3FirewallRules'):
                l3_firewall_rules.append(meraki_sdk.models.l3_firewall_rule_model.L3FirewallRuleModel.from_dictionary(structure))
        l7_firewall_rules = None
        if dictionary.get('l7FirewallRules') != None:
            l7_firewall_rules = list()
            for structure in dictionary.get('l7FirewallRules'):
                l7_firewall_rules.append(meraki_sdk.models.l7_firewall_rule_model.L7FirewallRuleModel.from_dictionary(structure))
