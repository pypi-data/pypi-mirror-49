...
class SelectReports(Select):
    ...
    status = django.forms.ChoiceField(
        choices=[models.DEFAULT_ENTRY, ('1', 'Error'), ('0', 'Done')],
...
class SelectIncoming(Select):
    ...
    statust = django.forms.ChoiceField(
        choices=[models.DEFAULT_ENTRY, ('1','Error'), ('3','Done')],
        required=False,initial='')
    ...
    errortext = django.forms.CharField(required=False, label='Error', max_length=70)
...
class ViewIncoming(View):
    ...
    errortext = django.forms.CharField(required=False, widget=HIDDENINPUT())
