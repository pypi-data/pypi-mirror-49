...
def itkGaussianSmoothingOnUpdateDisplacementFieldTransformD2___New_orig__():
...
def itkGaussianSmoothingOnUpdateDisplacementFieldTransformD2_cast(obj):
...
def itkGaussianSmoothingOnUpdateDisplacementFieldTransformD3___New_orig__():
...
def itkGaussianSmoothingOnUpdateDisplacementFieldTransformD3_cast(obj):
