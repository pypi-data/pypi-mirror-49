...
def get_data():
    data = []
    sitewebName = OrderedDict([ ("梅州市", "梅州市,蕉岭县,平远县,五华县,丰顺县,大埔县,兴宁市,梅县区,梅江区"),])
    ...
    regionIds = OrderedDict([("梅州市", "0108")])
    ...
    sx_sitewebId = OrderedDict([ ("梅州市", "4028889705bedd7e0105beec36890004")])
...
def work(conp, **args):
    est_meta_large(conp, data=data, diqu="广东省梅州市", **args)
...
if __name__ == '__main__':
    work(conp=["postgres", "since2015", "192.168.3.171", "guoziqiang", "meizhou"],pageloadtimeout=120,interval_page=10)
