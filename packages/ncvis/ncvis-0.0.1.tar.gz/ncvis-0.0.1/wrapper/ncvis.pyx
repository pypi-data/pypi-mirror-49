...
class NCVis:
    def __init__(self, d=2, n_threads=1, n_neighbors=30, M=16, ef_construction = 200, random_seed = 42, n_epochs=30, n_init_epochs=10, spread=1., min_dist=0.1, alpha=1., alpha_Q=1., n_noise=3):
        self.model = NCVisWrapper(d, n_threads, n_neighbors, M, ef_construction, random_seed, n_epochs, n_init_epochs, spread, min_dist, alpha, alpha_Q, n_noise)
