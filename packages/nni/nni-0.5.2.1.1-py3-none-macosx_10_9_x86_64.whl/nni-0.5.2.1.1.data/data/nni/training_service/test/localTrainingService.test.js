...
const localTrainingServiceForGPU_1 = require("../local/localTrainingServiceForGPU");
...
describe('Unit Test for LocalTrainingService', () => {
    ...
    beforeEach(() => {
        localTrainingService = component.get(localTrainingServiceForGPU_1.LocalTrainingServiceForGPU);
