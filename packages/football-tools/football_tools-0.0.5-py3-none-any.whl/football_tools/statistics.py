...
class Statistics(TeamDomain):
    ...
    def percentage_of_matches_winner_by_team(self, team):
        return 

    def percentage_of_matches_lose_by_team(self, team):
        return 

    def percentage_of_matches_draw_by_team(self, team):
        return 
    ...
    def __init__(self, team):
        ...
        self.percentage_of_matches_winner = 0
        self.percentage_of_matches_lose = 0
        self.percentage_of_matches_draw = 0
