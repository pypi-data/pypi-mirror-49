...
def itkImageShapeModelEstimatorBaseIF2IF2_cast(obj):
...
def itkImageShapeModelEstimatorBaseIF3IF3_cast(obj):
...
def itkImageShapeModelEstimatorBaseISS2IF2_cast(obj):
...
def itkImageShapeModelEstimatorBaseISS3IF3_cast(obj):
...
def itkImageShapeModelEstimatorBaseIUC2IF2_cast(obj):
...
def itkImageShapeModelEstimatorBaseIUC3IF3_cast(obj):
...
def itkImageShapeModelEstimatorBaseIUS2IF2_cast(obj):
...
def itkImageShapeModelEstimatorBaseIUS3IF3_cast(obj):
