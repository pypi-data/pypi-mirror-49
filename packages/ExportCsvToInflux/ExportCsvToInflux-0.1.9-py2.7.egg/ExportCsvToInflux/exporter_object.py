...
class ExporterObject(object):
    ...
    def export_csv_to_influx(self,
        ...
        for csv_file_item in csv_file_generator:
            ...
            match_columns = self.__validate_match_and_filter(match_columns, csv_headers)
            filter_columns = self.__validate_match_and_filter(filter_columns, csv_headers)
