...
import meraki_sdk.models.bandwidth_limits6_model
...
class UpdateNetworkUplinkSettingsModel(object):
    ...
    def from_dictionary(cls,
        ...
        bandwidth_limits = meraki_sdk.models.bandwidth_limits6_model.BandwidthLimits6Model.from_dictionary(dictionary.get('bandwidthLimits')) if dictionary.get('bandwidthLimits') else None
