...
class itkArrayD(vnl_vectorPython.vnl_vectorD):
    ...
    def SetDataSameSize(self, data, LetArrayManageMemory=False):
        """
    ...
    def SetData(self, data, sz, LetArrayManageMemory=False):
        """
...
class itkArraySLL(vnl_vectorPython.vnl_vectorSLL):
    ...
    def __init__(self, *args):
        ...
        __init__(itkArraySLL self, long long * data, unsigned long sz, bool LetArrayManageMemory=False) -> itkArraySLL
        __init__(itkArraySLL self, long long * data, unsigned long sz) -> itkArraySLL
        __init__(itkArraySLL self, long long const * data, unsigned long sz, bool LetArrayManageMemory=False) -> itkArraySLL
        __init__(itkArraySLL self, long long const * data, unsigned long sz) -> itkArraySLL
    ...
    def SetData(self, data, sz, LetArrayManageMemory=False):
        """
        SetData(itkArraySLL self, long long * data, unsigned long sz, bool LetArrayManageMemory=False)
        SetData(itkArraySLL self, long long * data, unsigned long sz)
...
class itkArrayULL(vnl_vectorPython.vnl_vectorULL):
    ...
    def __init__(self, *args):
        ...
        __init__(itkArrayULL self, unsigned long long * data, unsigned long sz, bool LetArrayManageMemory=False) -> itkArrayULL
        __init__(itkArrayULL self, unsigned long long * data, unsigned long sz) -> itkArrayULL
        __init__(itkArrayULL self, unsigned long long const * data, unsigned long sz, bool LetArrayManageMemory=False) -> itkArrayULL
        __init__(itkArrayULL self, unsigned long long const * data, unsigned long sz) -> itkArrayULL
    ...
    def SetData(self, data, sz, LetArrayManageMemory=False):
        """
        SetData(itkArrayULL self, unsigned long long * data, unsigned long sz, bool LetArrayManageMemory=False)
        SetData(itkArrayULL self, unsigned long long * data, unsigned long sz)
