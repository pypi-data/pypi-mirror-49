...
class WFDLoader(Loader):
    ...
    def readHeader(self):
        """Headerを読み込みます"""
        data = self.unpack(self.buffer,  self.header_format, self.headerlen,  self.offset)
    ...
    def readData(self):
        ...
        time_all_block = self.headerA("time_all_block") - 1
        ...
        for dtype in self.indexes["DATATYPE"]:
            ...
            if dtype.find("spectrum") != -1:
                datasize -= 840 * struct.calcsize(dataformat)
