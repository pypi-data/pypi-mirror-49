...
class HDPowerModule (PowerModule):
    ...
    class HD12VOffsetCalibration (HDCalibration):
        ...
        def setCoefficients(self):
            ...
            #self.powerModule.dut.sendAndVerifyCommand("write 0xf011 " + self.offset.hexString(4)) # negative offsets don't read back in 1.5 and below
    ...
    class HD12VVoltageCalibration (HDCalibration):
        ...
        def setCoefficients(self):
            ...
            self.powerModule.dut.sendAndVerifyCommand("write " + HDPowerModule.V12_VOLT_MULTIPLIER_ADDR + " " + self.multiplier.hexString(4))
            self.powerModule.dut.sendAndVerifyCommand("write " + HDPowerModule.V12_VOLT_OFFSET_ADDR + " " + self.offset.hexString(4))
    ...
    class HD12VLowCurrentCalibration (HDCalibration):
        ...
        def setCoefficients(self):
            ...
            self.powerModule.dut.sendAndVerifyCommand("write " + HDPowerModule.V12_LOW_MULTIPLIER_ADDR + " " + self.multiplier.hexString(4))
            self.powerModule.dut.sendAndVerifyCommand("write " + HDPowerModule.V12_LOW_OFFSET_ADDR + " " + self.offset.hexString(4))
    ...
    class HD12VHighCurrentCalibration (HDCalibration):
        ...
        def setCoefficients(self):
            ...
            self.powerModule.dut.sendAndVerifyCommand("write " + HDPowerModule.V12_HIGH_MULTIPLIER_ADDR + " " + self.multiplier.hexString(4))
            self.powerModule.dut.sendAndVerifyCommand("write " + HDPowerModule.V12_HIGH_OFFSET_ADDR + " " + self.offset.hexString(4))
    ...
    class HD12VLeakageCalibration (HDCalibration):
        ...
        def setCoefficients(self):
            ...
            self.powerModule.dut.sendAndVerifyCommand("write " + HDPowerModule.V12_LEAKAGE_MULTIPLIER_ADDR + " " + self.multiplier.hexString(4))
    ...
    class HD5VOffsetCalibration (HDCalibration):
        ...
        def setCoefficients(self):
            ...
            #self.powerModule.dut.sendAndVerifyCommand("write 0xf010 " + self.offset.hexString(4))    # negative offsets don't read back in 1.5 and below
    ...
    class HD5VVoltageCalibration (HDCalibration):
        ...
        def setCoefficients(self):
            ...
            self.powerModule.dut.sendAndVerifyCommand("write " + HDPowerModule.V5_VOLT_MULTIPLIER_ADDR + " " + self.multiplier.hexString(4))
            self.powerModule.dut.sendAndVerifyCommand("write " + HDPowerModule.V5_VOLT_OFFSET_ADDR + " " + self.offset.hexString(4))
    ...
    class HD5VLowCurrentCalibration (HDCalibration):
        ...
        def setCoefficients(self):
            ...
            self.powerModule.dut.sendAndVerifyCommand("write " + HDPowerModule.V5_LOW_MULTIPLIER_ADDR + " " + self.multiplier.hexString(4))
            self.powerModule.dut.sendAndVerifyCommand("write " + HDPowerModule.V5_LOW_OFFSET_ADDR + " " + self.offset.hexString(4))
    ...
    class HD5VHighCurrentCalibration (HDCalibration):
        ...
        def setCoefficients(self):
            ...
            self.powerModule.dut.sendAndVerifyCommand("write " + HDPowerModule.V5_HIGH_MULTIPLIER_ADDR + " " + self.multiplier.hexString(4))
            self.powerModule.dut.sendAndVerifyCommand("write " + HDPowerModule.V5_HIGH_OFFSET_ADDR + " " + self.offset.hexString(4))
    ...
    class HD5VLeakageCalibration (HDCalibration):
        ...
        def setCoefficients(self):
            ...
            self.powerModule.dut.sendAndVerifyCommand("write " + HDPowerModule.V5_LEAKAGE_MULTIPLIER_ADDR + " " + self.multiplier.hexString(4))
