...
from src.decorators import Log, login_required
from src.config import *
from src.descriptors import *
from src.meta import *
from src.server_database import *
import src.logs.config.server_config_log
...
db_engine = create_engine('sqlite:///lib/src/db.sqlite3')
...
class ServerManager(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.ui = uic.loadUi('lib/src/server_gui.ui', self)
        self.initUI()
        self.show()
...
if __name__ == "__main__":
    ...
    server_stream_handler.setFormatter(
        src.logs.config.server_config_log.log_format)
