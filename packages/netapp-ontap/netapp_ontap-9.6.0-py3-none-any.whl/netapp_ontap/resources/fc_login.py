...
class FcLoginSchema(ResourceSchema):
 ...
 """
    igroups = fields.List(fields.Nested("IgroupSchema", unknown=EXCLUDE))
    r""" The initiator groups in which the initiator is a member.
 """
    initiator = fields.Nested("FcLoginInitiatorSchema", unknown=EXCLUDE)
    r""" The initiator field of the fc_login.
 """
    interface = fields.Nested("FcInterfaceSchema", unknown=EXCLUDE)
    r""" The interface field of the fc_login.
 """
    protocol = fields.Str(validate=enum_validation(['fc_nvme', 'fcp']))
...
class FcLogin(Resource):
 ...
 """
    ...
    get_collection.__func__.__doc__ = r"""Retrieves FC logins.
...
"""
    ...
    find.__func__.__doc__ = r"""Retrieves FC logins.
### Related ONTAP commands
* `vserver fcp initiator show`
### Learn more
* SAN: [`DOC /network/fc/logins`](#docs-SAN-network_fc_logins)
...
"""
    ...
    get.__doc__ = r"""Retrieves an FC login.
### Related ONTAP commands
* `vserver fcp initiator show`
### Learn more
* SAN: [`DOC /network/fc/logins`](#docs-SAN-network_fc_logins)
