...
Example: on-access-test """
    scope = fields.Nested("VscanOnAccessScopeSchema", unknown=EXCLUDE)
...
class VscanOnAccess(Resource):
 ...
 """
    ...
    get_collection.__func__.__doc__ = r"""Retrieves the Vscan On-Access policy.
...
"""
    ...
    patch_collection.__func__.__doc__ = r"""Updates the Vscan On-Access policy configuration and/or enables/disables the Vscan On-Access policy of an SVM. Configurations for an On-Access policy associated with an administrative SVM cannot be modified, although the policy associated with an administrative SVM can be enabled or disabled.
### Related ONTAP commands
...
"""
    ...
    delete_collection.__func__.__doc__ = r"""Deletes the anti-virus On-Access policy configuration.
### Related ONTAP commands
...
"""
    ...
    find.__func__.__doc__ = r"""Retrieves the Vscan On-Access policy.
### Related ONTAP commands
* `vserver vscan on-access-policy show`
* `vserver vscan on-access-policy file-ext-to-include show`
* `vserver vscan on-access-policy file-ext-to-exclude show`
...
"""
    ...
    get.__doc__ = r"""Retrieves the Vscan On-Access policy configuration of an SVM.
### Related ONTAP commands
* `vserver vscan on-access-policy show`
* `vserver vscan on-access-policy file-ext-to-include show`
* `vserver vscan on-access-policy file-ext-to-exclude show`
...
"""
    ...
    post.__doc__ = r"""Creates a Vscan On-Access policy. Created only on a data SVM.
</b>Important notes:
...
"""
    ...
    patch.__doc__ = r"""Updates the Vscan On-Access policy configuration and/or enables/disables the Vscan On-Access policy of an SVM. Configurations for an On-Access policy associated with an administrative SVM cannot be modified, although the policy associated with an administrative SVM can be enabled or disabled.
### Related ONTAP commands
* `vserver vscan on-access-policy modify`
* `vserver vscan on-access-policy enable`
* `vserver vscan on-access-policy disable`
...
"""
    ...
    delete.__doc__ = r"""Deletes the anti-virus On-Access policy configuration.
### Related ONTAP commands
* `vserver vscan on-access-policy delete`
### Learn more
* [`DOC /protocols/vscan/{svm.uuid}/on-access-policies`](#docs-NAS-protocols_vscan_{svm.uuid}_on-access-policies)
