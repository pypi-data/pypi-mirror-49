...
def work(conp, **arg):
    est_meta(conp, data=data, diqu="辽宁省省会", **arg)
...
if __name__ == '__main__':
    ...
    #
    work(conp=["postgres", "since2015", "192.168.3.171", "zlest", "zfcg_liaoning_shenghui"])
