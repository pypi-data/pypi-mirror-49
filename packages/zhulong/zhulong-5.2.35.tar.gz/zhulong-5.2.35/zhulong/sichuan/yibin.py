...
if __name__=='__main__':
    ...
    #         print(d)
    # driver = webdriver.Chrome()
    # df = f3(driver, 'http://elyg.yibin.gov.cn:88/elyg-xunjia-web/xunjiaxinxi/otherGongGao_view.html?otherGongGaoType=1&gongGaoGuid=0972a5f1-bbe0-42f5-9830-e290fdba60eb')
    # print(df)