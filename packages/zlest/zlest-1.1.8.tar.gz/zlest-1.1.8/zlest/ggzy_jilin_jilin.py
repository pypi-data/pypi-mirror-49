...
#
    ["zfcg_liubiao_jz_gg",
     ...
     ["name", "ggstart_time", "href", "info"], add_info(f1, {'zbfs': '集中采购'}), f2],
#
    ["zfcg_zhaobiao_dyly_jz_gg",
     "http://www.ggzyzx.jl.gov.cn/jyxx/005002/005002006/moreinfo.html",
     ["name", "ggstart_time", "href", "info"], add_info(f1, {'zbfs': '集中采购', 'fs':'单一来源'}), f2],
#
...
if __name__ == '__main__':
    work(conp=["postgres", "since2015", "192.168.3.171", "zlest", "ggzy_jilin_jilin"])
