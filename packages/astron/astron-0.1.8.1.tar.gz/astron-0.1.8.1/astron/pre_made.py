...
orbit = Orbit(a=screen_x*500/1920, b=screen_y*500/1080, center_x=screen_x, center_y=screen_y/2, CW=True, angular_step = 2*np.pi/(200.0), progress = np.pi/4)
...
orbit = Orbit(a=screen_x*800/1920, b=screen_y*300/1080, center_x=screen_x*0.75, center_y=screen_x*0.25, CW=True, angular_step = 2*np.pi/(200.0), progress = np.pi/3)
...
sc = Spacecraft('Test', mass = 100, thrust_force = 4000, gas_level = 225)
...
planet = Planet('Test', mass = 4e16/1.4, orbit = orbit, color = (48, 227, 240))
...
planet2 = Planet('Test', mass = 5e16/1.4, orbit = orbit2, color=(240, 217, 43))
