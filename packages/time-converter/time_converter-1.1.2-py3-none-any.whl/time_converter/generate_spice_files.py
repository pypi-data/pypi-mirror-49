...
if __name__ == '__main__':
    index = pd.date_range(freq='30min', start=dt.datetime(2019, 1, 1), end=dt.datetime(2022, 1, 1))
    ...
    lunar_days = 1 + pd.Series([new_lunar_day[:val].sum() for val in index], index=index)
