...
# url="http://www.rzggzy.com/gjsgc/index_2.jhtml"
...
def f3(driver,url):
    ...
    locator=(By.XPATH,"//div[@class='Padding10 BorderCCCDot F14 Contnet']")
    ...
    div=soup.find('div',class_='Padding10 BorderCCCDot F14 Contnet')
