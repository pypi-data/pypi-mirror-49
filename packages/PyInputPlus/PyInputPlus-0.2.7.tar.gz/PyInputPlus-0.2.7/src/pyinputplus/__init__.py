...
class ValidationException(PyInputPlusException):
    """This exception is raised when a validate*() function is called and the
    input fails validation. For example, validateInt('four') will raise this.
    This exception class is for all the PySimpleValidate wrapper functions
    that PyInputPlus provides so that pyinputplus.ValidationException is
    raised instead of pysimplevalidate.ValidationException."""
    pass
...
def inputUSState(prompt='', default=None, blank=False, timeout=None, limit=None,
    ...
    * returnStateName (bool): If True, the full state name is returned, i.e. 'California'. Otherwise, the abbreviation, i.e. 'CA'. Defaults to False.
    ...
    'California'
    """
    validationFunc = lambda value: pysv.validateUSState(value, blank=blank, strip=strip, allowRegexes=allowRegexes, blockRegexes=blockRegexes, returnStateName=returnStateName)
...
def validateStr(value, *args, **kwargs):
    try:
        return pysv.validateStr(value, *args, **kwargs)
    except pysv.ValidationException as e:
        raise ValidationException(str(e))

def validateNum(value, *args, **kwargs):
    try:
        return pysv.validateNum(value, *args, **kwargs)
    except pysv.ValidationException as e:
        raise ValidationException(str(e))

def validateInt(value, *args, **kwargs):
    try:
        return pysv.validateInt(value, *args, **kwargs)
    except pysv.ValidationException as e:
        raise ValidationException(str(e))

def validateFloat(value, *args, **kwargs):
    try:
        return pysv.validateFloat(value, *args, **kwargs)
    except pysv.ValidationException as e:
        raise ValidationException(str(e))

def validateChoice(value, choices):
    try:
        return pysv.validateChoice(value, choices)
    except pysv.ValidationException as e:
        raise ValidationException(str(e))

def validateTime(value, *args, **kwargs):
    try:
        return pysv.validateTime(value, *args, **kwargs)
    except pysv.ValidationException as e:
        raise ValidationException(str(e))

def validateDate(value, *args, **kwargs):
    try:
        return pysv.validateDate(value, *args, **kwargs)
    except pysv.ValidationException as e:
        raise ValidationException(str(e))

def validateDatetime(value, *args, **kwargs):
    try:
        return pysv.validateDatetime(value, *args, **kwargs)
    except pysv.ValidationException as e:
        raise ValidationException(str(e))

def validateFilename(value, *args, **kwargs):
    try:
        return pysv.validateFilename(value, *args, **kwargs)
    except pysv.ValidationException as e:
        raise ValidationException(str(e))

def validateFilepath(value, *args, **kwargs):
    try:
        return pysv.validateFilepath(value, *args, **kwargs)
    except pysv.ValidationException as e:
        raise ValidationException(str(e))

def validateIP(value, *args, **kwargs):
    try:
        return pysv.validateIP(value, *args, **kwargs)
    except pysv.ValidationException as e:
        raise ValidationException(str(e))

def validateIPv4(value, *args, **kwargs):
    try:
        return pysv.validateIPv4(value, *args, **kwargs)
    except pysv.ValidationException as e:
        raise ValidationException(str(e))

def validateIPv6(value, *args, **kwargs):
    try:
        return pysv.validateIPv6(value, *args, **kwargs)
    except pysv.ValidationException as e:
        raise ValidationException(str(e))

def validateRegex(value, *args, **kwargs):
    try:
        return pysv.validateRegex(value, *args, **kwargs)
    except pysv.ValidationException as e:
        raise ValidationException(str(e))

def validateRegexStr(value, *args, **kwargs):
    try:
        return pysv.validateRegexStr(value, *args, **kwargs)
    except pysv.ValidationException as e:
        raise ValidationException(str(e))

def validateURL(value, *args, **kwargs):
    try:
        return pysv.validateURL(value, *args, **kwargs)
    except pysv.ValidationException as e:
        raise ValidationException(str(e))

def validateEmail(value, *args, **kwargs):
    try:
        return pysv.validateEmail(value, *args, **kwargs)
    except pysv.ValidationException as e:
        raise ValidationException(str(e))

def validateYesNo(value, *args, **kwargs):
    try:
        return pysv.validateYesNo(value, *args, **kwargs)
    except pysv.ValidationException as e:
        raise ValidationException(str(e))

def validateBool(value, *args, **kwargs):
    try:
        return pysv.validateBool(value, *args, **kwargs)
    except pysv.ValidationException as e:
        raise ValidationException(str(e))

def validateUSState(value, *args, **kwargs):
    try:
        return pysv.validateUSState(value, *args, **kwargs)
    except pysv.ValidationException as e:
        raise ValidationException(str(e))

def validateName(value, *args, **kwargs):
    try:
        return pysv.validateName(value, *args, **kwargs)
    except pysv.ValidationException as e:
        raise ValidationException(str(e))

def validateAddress(value, *args, **kwargs):
    try:
        return pysv.validateAddress(value, *args, **kwargs)
    except pysv.ValidationException as e:
        raise ValidationException(str(e))

def validatePhone(value, *args, **kwargs):
    try:
        return pysv.validatePhone(value, *args, **kwargs)
    except pysv.ValidationException as e:
        raise ValidationException(str(e))

def validateMonth(value, *args, **kwargs):
    try:
        return pysv.validateMonth(value, *args, **kwargs)
    except pysv.ValidationException as e:
        raise ValidationException(str(e))

def validateDayOfWeek(value, *args, **kwargs):
    try:
        return pysv.validateDayOfWeek(value, *args, **kwargs)
    except pysv.ValidationException as e:
        raise ValidationException(str(e))

def validateDayOfMonth(value, *args, **kwargs):
    try:
        return pysv.validateDayOfMonth(value, *args, **kwargs)
    except pysv.ValidationException as e:
        raise ValidationException(str(e))
