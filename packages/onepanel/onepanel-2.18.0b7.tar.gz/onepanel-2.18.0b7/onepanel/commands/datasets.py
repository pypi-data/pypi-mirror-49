...
@click.option(
    '-d', '--dataset',
    type=str,
    help='Specifies a dataset to push to: account_uid/datasets/dataset_uid.'
)
@click.option(
    '-p', '--path',
    type=str,
...
@click.pass_context
@login_required
def datasets_push(ctx, dataset, path, message, name, update_version, quiet, background, watch, in_background, delete):
    _datasets_push(ctx, dataset, path, message, name, update_version, quiet, background, watch, in_background, delete)


def _datasets_push(ctx, dataset, path, message, name, update_version, quiet, background, watch, in_background, delete):
    ...
    if dataset is None:
        ...
        identifier = DatasetIdentifier(dataset)
