...
class TektronixSpectrogram(BaseImporter):
    ...
    def read(self):
        ...
        for key in required_keys:
            if key not in data.keys():
                raise utils.UnknownFileType(f"{self.NAME} Matlab file, but don't yet know how to handle it.")
