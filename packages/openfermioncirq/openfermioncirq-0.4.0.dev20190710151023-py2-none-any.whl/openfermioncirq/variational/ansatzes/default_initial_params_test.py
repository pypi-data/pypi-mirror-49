...
bond_length = 0.7414
geometry = [(u'H', (0., 0., 0.)), (u'H', (0., 0., bond_length))]
...
@pytest.mark.parametrize(
        u'ansatz, trotter_algorithm, order, hamiltonian, atol', [
...
def test_trotter_ansatzes_default_initial_params_iterations_1(
    ...
    u"""Check that a Trotter ansatz with one iteration and default parameters
    ...
    if isinstance(ansatz, SwapNetworkTrotterHubbardAnsatz):
        occupied_orbitals = (xrange(len(qubits)//4), xrange(len(qubits)//4))
    else:
