...
def make_pipeline(pipeline_include_shear=True,
    pipeline_align_bulge_disk_centre=False,
    pipeline_align_bulge_disk_axis_ratio=False,
    pipeline_align_bulge_disk_phi=False,
    pipeline_hyper_galaxies=True,
    pipeline_hyper_background_sky=True,
    ...
    pipeline_name = pipeline_tagging.pipeline_name_from_name_and_settings(
        pipeline_name=pipeline_name, include_shear=pipeline_include_shear,,
        align_bulge_disk_centre=pipeline_align_bulge_disk_centre,
        align_bulge_disk_axis_ratio=pipeline_align_bulge_disk_axis_ratio,
        align_bulge_disk_phi=pipeline_align_bulge_disk_phi,
    )
