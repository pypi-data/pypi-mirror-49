...
class CouldNotComputeException(api_tester_upload_test.exceptions.api_exception.APIException):
    def __init__(self, reason, context):
        """Constructor for the CouldNotComputeException class
        ...
        """
        super(CouldNotComputeException, self).__init__(reason, context)
