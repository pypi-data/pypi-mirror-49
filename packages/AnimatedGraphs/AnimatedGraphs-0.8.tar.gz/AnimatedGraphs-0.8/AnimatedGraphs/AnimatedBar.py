...
def CreateGraphBar(DS, AGGREGATION_TYPE, AGGREGATION_COLUMN, BAR_ATTRIBUTE_NAME, LOOP_ATTRIBUTE_NAME, SERIES_ATTRIBUTE_NAME, GRAPH_TITLE, 
...
#            max_value = max_values[i]
    ...
    for loopItem in LOOP_ITEMS:
        ...
        if(AGGREGATION_TYPE == "SUM"):
            SUMMARIZED_DS = SUMMARIZED_DS.pivot_table(AGGREGATION_COLUMN, BAR_ATTRIBUTE_NAME, SERIES_ATTRIBUTE_NAME, aggfunc="sum")
        elif (AGGREGATION_TYPE == "COUNT"):
