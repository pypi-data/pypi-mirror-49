import abc
import six
from akeyless_auth_api import SystemUserCredentialsReplyObj, SetUAMAccessCredsParams, CredentialsReplyObj
...
class AkeylessApiI(object):
    ...
    def authenticate_uam_api_key_access(self, access_id, timestamp, nonce, signature, **kwargs):
        ...
        System's user that meet an API key access will be able to get a combination of three
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.authenticate_uam_api_key_access(access_id, timestamp, nonce, signature, async=True)
        >>> result = thread.get()
    ...
    def set_uam_access_creds(self, akeyless_auth_creds, body, **kwargs):
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.set_uam_access_creds(akeyless_auth_creds, body, async=True)
        >>> result = thread.get()
    ...
    def create_user(self, akeyless_uam_user_creds, akeyless_set_user_access_creds, user_name, **kwargs):
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.create_user(akeyless_uam_user_creds, akeyless_set_user_access_creds, user_name, async=True)
        >>> result = thread.get()
    ...
    @abc.abstractmethod
    def update_user(self, akeyless_uam_user_creds, akeyless_set_user_access_creds, new_user_name, user_name, **kwargs):
