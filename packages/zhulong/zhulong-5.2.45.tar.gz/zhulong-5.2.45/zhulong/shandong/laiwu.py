...
def f3(driver,url):
    driver.get(url)
    locator=(By.XPATH,"//td[@class='infodetail'][string-length()>100]")
...
if __name__=='__main__':
    ...
    # df = f3(driver, 'http://ggzy.laiwu.gov.cn/lwwznew/InfoDetail/Default.aspx?InfoID=90c45d1e-aaa6-4046-a8c7-c65d39b7124a&CategoryNum=044002003001')
    # print(df)