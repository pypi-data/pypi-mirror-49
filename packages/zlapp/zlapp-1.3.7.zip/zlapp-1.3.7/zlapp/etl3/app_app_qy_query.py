...
def est():
    ...
    sql1="""    drop table if exists public.app_gg_zhongbiao;"""
    db_command(sql1,dbtype="postgresql",conp=conp_pg)
    
    sql="""
    with a as (SELECT ent_key,jgmc as entname,fddbr,clrq,zczj,xzqh FROM "public"."qy_base" )
    ...
    ,c as (SELECT ent_key, array_agg(zzmc) as qy_zz_info
