...
class VolumeSnaplockSchema(ResourceSchema):
    ...
    append_mode_enabled = fields.Boolean()
...
Example: P30M """
    compliance_clock_time = fields.DateTime()
...
* permanently_disabled """
    retention = fields.Nested("VolumeSnaplockRetentionSchema", unknown=EXCLUDE)
