...
id = "ae94da5d2850ba6bc5eef840c9a6dfe539ade98a"
date = "2019-07-11 22:05:04 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "ae94da5d2850ba6bc5eef840c9a6dfe539ade98a":
        return
    msg = "Program id (ae94da5d2850ba6bc5eef840c9a6dfe539ade98a) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
