...
class FinalStep(QWidget):
    def __init__(self, images, crop, phaseDiagram, phi, GP, bins, greyLimitsCrop, binning, name):
        ...
        self.gaussianParameters = numpy.zeros_like(GP, dtype="<f4")
    ...
    def starCorrelation(self):
        ...
        gaussianParameters = self.gaussianParameters.astype('<f4')
        ...
        while (iterationNumber <= maxIterations and deltaPhiNorm > minDeltaPhi) or iterationNumber <= 1:
            ...
            imFdefGradZ, imFdefGradY, imFdefGradX = [
                g.astype('<f4') for g in numpy.gradient(imFdef)]
            DICToolkit.computeDICoperatorsGM(imFdef[margin],
                                             imG[margin],
                                             imFdefGradZ[margin],
                                             imFdefGradY[margin],
                                             imFdefGradX[margin],
            ...
            DICToolkit.computeGMresidualAndPhase(imFdef[margin], imG[margin], phaseDiagram, gaussianParameters, residualField, phaseField)
