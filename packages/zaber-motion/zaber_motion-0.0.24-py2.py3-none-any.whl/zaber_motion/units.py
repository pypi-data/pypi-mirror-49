...
class Units(Enum):
    ...
    AngularVelocity_degrees_per_second = 'Angular Velocity:degrees per second'
    AngularVelocity_radians_per_second = 'Angular Velocity:radians per second'

    AngularAcceleration_degrees_per_second_squared = 'Angular Acceleration:degrees per second squared'
    AngularAcceleration_radians_per_second_squared = 'Angular Acceleration:radians per second squared'

    ACElectricCurrent_amperes_peak = 'AC Electric Current:amperes peak'
    ACElectricCurrent_amperes_rms = 'AC Electric Current:amperes RMS'

    Percent_percent = 'Percent:percent'

    DCElectricCurrent_amperes = 'DC Electric Current:amperes'
    ...
    RotationalInertia_gram_square_metre = 'Rotational Inertia:gram-square metre'
    RotationalInertia_kilogram_square_metre = 'Rotational Inertia:kilogram-square metre'
    RotationalInertia_pound_square_feet = 'Rotational Inertia:pound-square-feet'

    ForceConstant_newtons_per_amp = 'Force Constant:newtons per amp'
    ForceConstant_millinewtons_per_amp = 'Force Constant:millinewtons per amp'
    ForceConstant_kilonewtons_per_amp = 'Force Constant:kilonewtons per amp'
    ForceConstant_pounds_force_per_amp = 'Force Constant:pounds-force per amp'

    TorqueConstant_newton_metres_per_amp = 'Torque Constant:newton metres per amp'
    TorqueConstant_millinewton_metres_per_amp = 'Torque Constant:millinewton metres per amp'
    TorqueConstant_kilonewton_metres_per_amp = 'Torque Constant:kilonewton metres per amp'
    TorqueConstant_pound_force_feet_per_amp = 'Torque Constant:pound-force-feet per amp'
