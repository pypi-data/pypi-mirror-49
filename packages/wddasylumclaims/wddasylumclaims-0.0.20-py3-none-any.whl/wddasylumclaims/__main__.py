...
def test_main(args):
    ...
    if (update_keywords):
        ...
        if ("https://docs.google.com" in keyword_filepath): #filepath is assumed to be a google sheet
            ...
            offline_keywords_csv_path = os.path.dirname(sample_dir+'\\keywords.csv'
    ...
    if (keyword_filepath == False):
        ...
        keyword_filepath = os.path.dirname(sample_dir+'\\keywords.csv'
    ...
    if (links_filepath == False):
        ...
        feather_urls_path = os.path.dirname(sample_dir+'\\py_case_links.feather'
        feather.write_dataframe(feather_urls, feather_urls_path)
        # Save urls as csv file
        csv_urls_path = os.path.dirname(sample_dir+'\\py_case_links.csv'
    ...
    if (dataset_filepath == False):
        ...
        feather_dataset_path = os.path.dirname(sample_dir+'\\py_case_text.feather'
        feather.write_dataframe(feather_dataset, feather_dataset_path)
        # Save dataset as csv file
        csv_dataset_path = os.path.dirname(sample_dir+'\\py_case_text.csv'
    ...
    if (outcomes_filepath == False):
        ...
        feather_outcomes_path = os.path.dirname(sample_dir+'\\py_case_outcomes.feather'
        feather.write_dataframe(feather_outcomes, feather_outcomes_path)
        # Save outcomes to csv file
        csv_outcomes_path = os.path.dirname(sample_dir+'\\py_case_outcomes.csv'
