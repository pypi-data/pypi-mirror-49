...
from src.client_gui_settings import Ui_Form, AddContactDialog, DelContactDialog
from src.client_database import *
import src.logs.config.client_config_log
...
logger = src.decorators.Log(log)

# Инициализация подключения к БД
db_engine = create_engine('sqlite:///lib/src/client_db.sqlite3')
...
class c_window(QtWidgets.QWidget):
    ...
    def connectPressed(self):
        ...
        main_window.setWindowTitle(f'Python Chat v0.2 - {self.account}')
        main_window.create_user_list()
...
class m_window(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.ui = uic.loadUi('lib/src/main_window.ui', self)
