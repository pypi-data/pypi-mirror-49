...
class FpolicySchema(ResourceSchema):
 ...
 """
    engines = fields.List(fields.Nested("FpolicyEngineSchema", unknown=EXCLUDE))
 ...
 """
    policies = fields.List(fields.Nested("FpolicyPolicySchema", unknown=EXCLUDE))
...
class Fpolicy(Resource):
 ...
 """
    ...
    get_collection.__func__.__doc__ = r"""Retrieves an FPolicy configuration.
...
"""
    ...
    delete_collection.__func__.__doc__ = r"""Deletes the FPolicy configuration for the specified SVM. Before deleting the FPolicy configuration, ensure that all policies belonging to the SVM are disabled.
### Related ONTAP commands
* `fpolicy delete`
...
"""
    ...
    find.__func__.__doc__ = r"""Retrieves an FPolicy configuration.
### Related ONTAP commands
* `fpolicy show`
* `fpolicy policy show`
* `fpolicy policy scope show`
...
"""
    ...
    get.__doc__ = r"""Retrieves an FPolicy configuration of an SVM.
### Related ONTAP commands
* `fpolicy show`
* `fpolicy policy show`
* `fpolicy policy scope show`
...
"""
    ...
    post.__doc__ = r"""Creates an FPolicy configuration.
### Required properties
...
"""
    ...
    delete.__doc__ = r"""Deletes the FPolicy configuration for the specified SVM. Before deleting the FPolicy configuration, ensure that all policies belonging to the SVM are disabled.
### Related ONTAP commands
* `fpolicy delete`
* `fpolicy policy scope delete`
* `fpolicy policy delete`
