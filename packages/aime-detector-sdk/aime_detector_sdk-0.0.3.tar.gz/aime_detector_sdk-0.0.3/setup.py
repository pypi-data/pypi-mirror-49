...
setuptools.setup(name="aime_detector_sdk", version="0.0.3", author="TrinhQuan", author_email="quantv@aimesoft.com",
                 ...
                 download_url='https://github.com/jarklee/aime_detector_sdk/releases/download/0.0.3/aime_detector_sdk-0.0.3.tar.gz',
