...
{'': ['*'],
 ...
 'doorstop.core.tests': ['docs/*',
                         ...
                         'files/subfolder/*',
                         'files_beta/*',
                         'files_beta/reqs_child/*',
                         'files_beta/reqs_parent/*']}
