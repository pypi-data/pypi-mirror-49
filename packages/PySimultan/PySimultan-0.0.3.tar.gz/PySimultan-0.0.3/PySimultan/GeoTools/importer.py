...
# from face import *
# from Configurator.geo_tools import Face as FACE
# from Configurator.geo_tools import Building as Bld
# from Configurator.geo_tools import EdgeLoop as EL
...
def parse_content(content):
    ...
    # Model
    model = {}
    model['Name'] = data[1][0:int(data[0])]
    model['IsVisible'] = bool(data[1][int(data[0])])
    # remove model entry:
    data = data[2:]
    ...
    my_building = Bld(is_visible=model['IsVisible'],
                      vertices=vertices,
                      faces=faces,
                      zones=volumes,
                      name=model['Name'],
