...
import meraki_sdk.models.tag2_model
import meraki_sdk.models.network2_model
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('tags') != None:
            ...
            for structure in dictionary.get('tags'):
                tags.append(meraki_sdk.models.tag2_model.Tag2Model.from_dictionary(structure))
        networks = None
        if dictionary.get('networks') != None:
            networks = list()
            for structure in dictionary.get('networks'):
                networks.append(meraki_sdk.models.network2_model.Network2Model.from_dictionary(structure))
