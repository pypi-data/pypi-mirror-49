...
def connect_one_to_one(*,
                       ...
                       source: mosaik_api.Simulator,
                       sink: mosaik_api.Simulator,
                       attribute_pairs,
    ...
    :param source: The entity to connect the attribute from.
    :param sink: The entity to connect the attribute to.
