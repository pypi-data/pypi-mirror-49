...
-  `shell and python
   scripts <https://github.com/simonsdave/dev-env/tree/release-0.5.22/bin>`__
...
-  `here's <https://github.com/simonsdave/dev-env/tree/release-0.5.22/docs/using.md>`__
...
-  if you'd like to help contribute to ``dev-env`` see
   `this <https://github.com/simonsdave/dev-env/tree/release-0.5.22/docs/contributing.md>`__
