...
#!defFunction(anvil.email,anvil.email..SendReport instance,[to=],[cc=],[bcc=],[from_address="no-reply"],[from_name=],[subject=],[text=],[html=],[attachments=])!2: "Send an email" ["send"]
def send(**kw):
    return anvil.server.call("anvil.private.email.send", **kw)
