...
Example: callhome.spares.low """
    severity = fields.Str(validate=enum_validation(['emergency', 'alert', 'error', 'notice', 'informational', 'debug']))
    r""" Severity
...
* informational
* debug """
    snmp_trap_type = fields.Str(validate=enum_validation(['standard', 'built_in', 'severity_based']))
    r""" SNMP trap type
...
class EmsMessage(Resource):
    ...
    get_collection.__func__.__doc__ = r"""Retrieves the event catalog definitions.
...
* [`DOC /support/ems/messages`](#docs-support-support_ems_messages)"""
    ...
    find.__func__.__doc__ = r"""Retrieves the event catalog definitions.
### Related ONTAP commands
* `event catalog show`
