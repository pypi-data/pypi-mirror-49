...
Specify the owner UUID and the user account name in the URI path. The owner UUID corresponds to the UUID of the SVM for which the user account has been created and can be obtained from the response body of GET call performed on one of the following APIs:
...
class AccountSchema(ResourceSchema):
 ...
 """
    applications = fields.List(fields.Nested("AccountApplicationSchema", unknown=EXCLUDE))
 ...
 """
    name = fields.Str(validate=len_validation(minimum=3, maximum=64))
    r""" User or group account name

Example: joe.smith """
    owner = fields.Nested("SvmSchema", unknown=EXCLUDE)
    r""" The owner field of the account.
 """
    password = fields.Str(validate=len_validation(minimum=8, maximum=128))
 ...
 """
    role = fields.Nested("RoleSchema", unknown=EXCLUDE)
    r""" The role field of the account.
 """
    scope = fields.Str(validate=enum_validation(['cluster', 'svm']))
...
class Account(Resource):
    ...
    get_collection.__func__.__doc__ = r"""Retrieves a list of user accounts in the cluster.
...
"""
    ...
    patch_collection.__func__.__doc__ = r"""Updates a user account. Locks or unlocks a user account and/or updates the role, applications, and/or password for the user account.
### Required parameters
...
"""
    ...
    delete_collection.__func__.__doc__ = r"""Deletes a user account.
### Required parameters
...
"""
    ...
    find.__func__.__doc__ = r"""Retrieves a list of user accounts in the cluster.
### Related ONTAP commands
* `security login show`
### Learn more
* [`DOC /security/accounts`](#docs-security-security_accounts)
"""
    ...
    get.__doc__ = r"""Retrieves a specific user account.
### Related ONTAP commands
* `security login show`
### Learn more
* [`DOC /security/accounts/{owner.uuid}/{name}`](#docs-security-security_accounts_{owner.uuid}_{name})
...
"""
    ...
    post.__doc__ = r"""Creates a new user account.
### Required parameters
...
"""
    ...
    patch.__doc__ = r"""Updates a user account. Locks or unlocks a user account and/or updates the role, applications, and/or password for the user account.
### Required parameters
* `name` - Account name to be updated.
* `owner.uuid`  - UUID of the SVM housing the user account to be updated.
### Optional parameters
...
"""
    ...
    delete.__doc__ = r"""Deletes a user account.
### Required parameters
* `name` - Account name to be deleted.
* `owner.uuid`  - UUID of the SVM housing the user account to be deleted.
### Related ONTAP commands
