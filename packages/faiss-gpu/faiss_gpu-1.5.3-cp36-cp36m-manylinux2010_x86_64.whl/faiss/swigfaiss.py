...
allocMemorySpaceV = _swigfaiss.allocMemorySpaceV

def freeMemorySpace(space, p):
    return _swigfaiss.freeMemorySpace(space, p)
freeMemorySpace = _swigfaiss.freeMemorySpace
...
class GpuIndexFlatConfig(GpuIndexConfig):
    ...
    __swig_setmethods__["useFloat16Accumulator"] = _swigfaiss.GpuIndexFlatConfig_useFloat16Accumulator_set
    __swig_getmethods__["useFloat16Accumulator"] = _swigfaiss.GpuIndexFlatConfig_useFloat16Accumulator_get
    if _newclass:
        useFloat16Accumulator = _swig_property(_swigfaiss.GpuIndexFlatConfig_useFloat16Accumulator_get, _swigfaiss.GpuIndexFlatConfig_useFloat16Accumulator_set)
...
class GpuIndexIVFFlatConfig(GpuIndexIVFConfig):
    ...
    def __init__(self):
        ...
        try:
            ...
            self.this = this
    __swig_setmethods__["useFloat16IVFStorage"] = _swigfaiss.GpuIndexIVFFlatConfig_useFloat16IVFStorage_set
    __swig_getmethods__["useFloat16IVFStorage"] = _swigfaiss.GpuIndexIVFFlatConfig_useFloat16IVFStorage_get
    if _newclass:
        useFloat16IVFStorage = _swig_property(_swigfaiss.GpuIndexIVFFlatConfig_useFloat16IVFStorage_get, _swigfaiss.GpuIndexIVFFlatConfig_useFloat16IVFStorage_set)
