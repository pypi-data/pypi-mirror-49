...
class Event(object):
    ...
    def __init__(self, type=None, category=None, label=None, message=None, location_city=None, location_country=None, company=None, value=None, value_type=None, source=None, sales_channel=None, user=None, id=None, items=None, tax=None, shipping=None, tags=None, brand=None, item_sku=None, campaign_name=None, campaign_source=None, campaign_medium=None):  # noqa: E501
