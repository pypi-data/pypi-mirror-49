...
class SubscriptionOffering:
    ...
    def usage_applicability_rules(self) -> RuleSet:
        ...
        if self.applicability_type == "ZONE_WIDE":
            ...
            origin_clusters = {app.origin_cluster_id for app in self.applicability_rules}
            destination_clusters = {app.destination_cluster_id for app in self.applicability_rules}
