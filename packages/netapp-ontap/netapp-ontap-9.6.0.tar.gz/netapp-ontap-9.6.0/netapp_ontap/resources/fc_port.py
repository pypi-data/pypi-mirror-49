...
Example: Fibre Channel Target Adapter 0a (ACME Fibre Channel Adapter, rev. 1.0.0, 8G) """
 ...
 """
    fabric = fields.Nested("FcPortFabricSchema", unknown=EXCLUDE)
...
Example: 0a """
 ...
 """
    physical_protocol = fields.Str(validate=enum_validation(['fibre_channel', 'ethernet']))
...
* fibre_channel
* ethernet """
    speed = fields.Nested("FcPortSpeedSchema", unknown=EXCLUDE)
    r""" The speed field of the fc_port.
 """
    state = fields.Str(validate=enum_validation(['startup', 'link_not_connected', 'online', 'link_disconnected', 'offlined_by_user', 'offlined_by_system', 'node_offline', 'unknown']))
...
* node_offline
* unknown """
    supported_protocols = fields.List(fields.Str)
    r""" The network protocols supported by the FC port.
 """
    transceiver = fields.Nested("FcPortTransceiverSchema", unknown=EXCLUDE)
...
class FcPort(Resource):
 ...
 """
    ...
    get_collection.__func__.__doc__ = r"""Retrieves FC ports.<br/>
...
"""
    ...
    patch_collection.__func__.__doc__ = r"""Updates an FC port.
### Related ONTAP commands
...
"""
    ...
    find.__func__.__doc__ = r"""Retrieves FC ports.<br/>
### Expensive properties
There is an added cost to retrieving values for these properties. They are not included by default in GET results and must be explicitly requested using the `fields` query parameter. See [`DOC Requesting specific fields`](#docs-docs-Requesting-specific-fields) to learn more.
* `fabric.name`
### Related ONTAP commands
...
"""
    ...
    get.__doc__ = r"""Retrieves an FC port.
### Expensive properties
There is an added cost to retrieving values for these properties. They are not included by default in GET results and must be explicitly requested using the `fields` query parameter. See [`DOC Requesting specific fields`](#docs-docs-Requesting-specific-fields) to learn more.
* `fabric.name`
### Related ONTAP commands
...
"""
    ...
    patch.__doc__ = r"""Updates an FC port.
### Related ONTAP commands
* `network fcp adapter modify`
### Learn more
* [`DOC /network/fc/ports`](#docs-networking-network_fc_ports)
